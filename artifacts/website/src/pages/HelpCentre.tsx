...
const FAQ: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How do I view or edit tenure details for an individual field?", a: "From the Fields & Crops page, open the Land Tenure tab and click Open on any row to go directly to that field's Tenure tab in the field detail drawer. Alternatively, open any field from the Fields tab and select the Tenure tab within the drawer — this shows the full land tenure record for that specific parcel alongside the field boundary, area, and soil data. You can add or edit the tenure record from that same drawer." },
