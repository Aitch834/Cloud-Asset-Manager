...
const FAQ: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What are Work Orders and how do I use them?", a: "Work Orders let you formally schedule a piece of contracting or service work before raising an invoice. Navigate to Farm Services > Invoices and click the Work Orders tab. Each work order gets an auto-generated reference (WO-2025-0001, and so on), and you record the customer from your Customer Directory, the service type, a scheduled date, estimated hours, and a description. Status moves through Draft → Scheduled → In Progress → Completed as the job progresses. Once a work order is marked Completed, click Raise Invoice to be taken to the Invoice tab with the customer and description already pre-filled — no re-typing required. Work Orders give you a clear record of what was promised and agreed before any invoice is raised." },
    ],
  },
  {
