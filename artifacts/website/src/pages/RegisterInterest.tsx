...
const MODULES = [
  ...
  { id: "viticulture", label: "Viticulture (vine register with UK variety & rootstock selects, BBCH phenology records, canopy & pruning operations, harvest records with Brix/pH/TA, disease scouting with Xylella & Phytophthora notifiable flags, CSV export, 4 dedicated mobile screens)" },
