...
const MODULES = [
  ...
  { id: "staff-training", label: "Staff & Training (certificates, right-to-work, PPE Stock / Issue / Risk Assessments registers, PPE Compliance Pack & Staff Record reports, labour & timesheet management, rota & shift planning, holiday & absence tracking, WTR compliance monitoring)" },
