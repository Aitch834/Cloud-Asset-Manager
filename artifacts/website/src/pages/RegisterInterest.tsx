...
const MODULES = [
  ...
  { id: "organic-arable", label: "Organic Arable (certification tab with certifying body/parallel production flag, field conversion tracker with visual progress bar, seed sourcing register with derogation approval flow, Annex II 33-item input log with Permitted/Restricted/Derogation Required status and certifier notified flag, harvest declarations with separate buyer declaration dialog; view-before-edit on all 5 tabs; RecordAttachments in every view dialog; FilterPills + Print Register + Export CSV per tab; 4 mobile screens — overview hub, offline-first input/seed/harvest recording with derogation and restricted-input flows)" },
