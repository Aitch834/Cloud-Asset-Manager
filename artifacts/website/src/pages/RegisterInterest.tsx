...
const MODULES = [
  ...
  { id: "sheep-production", label: "Sheep Production (flocks via Livestock register, tupping, scanning, weigh-in & DLWG, shearing, health plans, Red Tractor Sheep Assurance, year filter on all tabs, document attachment on every record row)" },
  { id: "goat-production", label: "Goat Production (herds via Livestock register, mating records, pregnancy scanning, weigh-in & DLWG with BCS, cull & market records, vaccination programmes, disease monitoring (CAE, CLA, Johne's, FEC), analytics tab, mobile capture, year filter on all tabs, document attachment on every record row)" },
