...
const MODULES = [
  ...
  { id: "livestock-management", label: "Livestock & Feed Management (BCMS & LIS submissions, individual animal linking, Bluetooth RFID scanning, lambing records with perinatal ABP disposal, season analytics, date-validated forms, staff/assessor name auto-populates, Dairy Management with DCT — POM-V enforcement, VMD medicine database, Vet Ledger finance trail)" },
  ...
  { id: "viticulture", label: "Viticulture (vine register with UK variety & rootstock selects, GI classification (PDO/PGI/Table Wine), BBCH phenology records, canopy & pruning operations, harvest records with Brix/pH/TA, disease & pest scouting with intelligent notification alerts (critical SMS for Xylella, Phytophthora, Vine Weevil & high disease pressure), CSV export, 4 dedicated mobile screens — bundled with Sprays & Inputs, COSHH, Staff & Training, Equipment Management, and Trade Contacts & Stock)" },
  ...
  { id: "poultry-production", label: "Poultry Production (flocks via Livestock register, placements & depletions, mortality logs, feed & water, egg production, medicines, biosecurity, house cleanout, Red Tractor Poultry)" },
