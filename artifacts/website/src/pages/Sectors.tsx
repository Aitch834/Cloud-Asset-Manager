...
const SECTORS = [
  ...
  },
  {
    ...
    hero: "Vine records, disease scouting, organic compliance, and harvest traceability — built for UK vineyards.",
    intro: "UK viticulture is one of the fastest-growing sectors in British agriculture — and one of the most under-served when it comes to purpose-built digital record-keeping. From vine register and phenology through organic derogations and SO₂ compliance, BDE Farm Trac provides a complete digital platform for vineyard and winery operations.",
    pain: [
      ...
      { heading: "Harvest traceability is a food safety requirement", body: "From picking date and yield per block through pressing, fermentation, and SO₂ additions, every step of the winemaking process creates a compliance record. BDE Farm Trac captures this chain in a single platform — with SO₂ compliance automatically checked against UK-retained EU Reg 203/2012 limits." },
    ],
    modules: [
