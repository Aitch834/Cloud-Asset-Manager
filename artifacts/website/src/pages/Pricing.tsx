...
const MODULES = [
  ...
  { id: "sprays-inputs", name: "Sprays & Inputs", price: 15, note: "Spray application records with GRN-linked batch traceability, operator PA certificate auto-fill, withholding period alerts, equipment lookup, Raise Task from spray, and photo/document evidence capture; IPM Plan — structured written Integrated Pest Management plan (version-controlled, five-section, printable A4 compliance document; spray records link to the plan via Spray Rationale field for a complete monitoring-to-application audit trail); LERAP Assessments — pre-application risk assessments for Category A/B products near watercourses with CRD star rating, NSTS sprayer status, buffer zone decision, and direct linkage to the spray record so assessed buffer distance appears on the printed spray certificate" },
  ...
  { id: "pig-production", name: "Pig Production", price: 25, note: "Herds linked from Livestock → Herds & Animals; farrowing & weaning records, feed consumption & FCR, health & medicine records with withdrawal tracking, movements, mortality records, vet health plan integration, Red Tractor Pigs scheme readiness checklist, and Pig Salmonella Monitoring — NSMP quarterly blood serology records (number of samples, APHA / approved laboratory, Category 1 / 2 / 3 result, seroprevalence %, submission reference, and corrective actions; Category 3 results trigger a compliance alert and action plan prompt)" },
  { id: "poultry-production", name: "Poultry Production", price: 25, note: "Flocks registered in Livestock → Herds & Animals (single herd register); placement & depletion records with hatchery traceability, daily mortality log with year-by-year trend, breed / strain and hatchery / supplier mortality breakdowns, cause analysis, feed & water consumption, egg production, medicine & vaccine records, biosecurity checklist, house cleanout records (farm staff or contractor, DEFRA-approved disinfectant, dilution rate, stock consumption, cost and invoice tracking, photo evidence), Red Tractor Poultry scheme records, and Campylobacter Monitoring — FSA National Control Programme records per flock (test type, slaughter house, FSA / NCP submission reference, result, and biosecurity interventions applied following a positive finding)" },
