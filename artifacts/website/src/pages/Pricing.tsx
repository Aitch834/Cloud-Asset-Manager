...
const MODULES = [
  ...
  { id: "staff-training", name: "Staff & Training", price: 10, note: "Training records, certificates (50+ types), right-to-work checks, PPE Issue Register, competency tracking, and multi-farm staff access management" },
