...
const MODULES = [
  ...
  { id: "staff-training", name: "Staff & Training", price: 10, note: "Training records, certificates (50+ types), right-to-work checks, PPE Stock Register (supplier & invoice traceability, live stock levels), PPE Issue Register (per-staff issue history, condition checks), competency tracking, and multi-farm staff access management" },
