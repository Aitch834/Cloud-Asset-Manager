    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "PPE Register — full PPE management living in the Staff page, split across two linked registers: PPE Stock Register tracks every incoming PPE delivery with supplier (linkable to your Supplier register), invoice reference, delivery note reference, batch number, unit cost, and real-time quantity-in-stock (automatically decremented on issue, colour-coded green / amber / red); PPE Issue Register records every item issued to a named staff member under the PPE at Work Regulations 2022; issue directly from a stock batch to auto-fill type, description, size, and supplier; captures condition at issue, condition checks, replacement date and reason; each staff member's full PPE history is visible on their profile card; mobile app allows field staff to log PPE issues instantly for sync to the dashboard",
        ],
      },
      {
