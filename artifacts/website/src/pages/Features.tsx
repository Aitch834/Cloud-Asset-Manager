    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "IPM Plan — structured written Integrated Pest Management plan required by Red Tractor Combinable Crops and Horticulture standards; five-section plan covering threshold monitoring approach, action thresholds, non-chemical controls, spray intervention rationale, and review schedule; version-controlled with author, last review date, and next review due date; printable A4 compliance document; individual spray application records link to the IPM Plan via a Spray Rationale field for a complete monitoring-to-application audit trail",
          "LERAP Assessments — Local Environmental Risk Assessments for Pesticides recorded before each qualifying application adjacent to a watercourse; captures field, product and CRD category (A or B), watercourse type, label buffer zone distance, LERAP star rating, NSTS sprayer status, and buffer zone decision (full or reduced with distance in metres); assessment linked directly to the corresponding spray application record — assessed buffer distance appears on the printed spray certificate for a complete evidence chain satisfying Red Tractor and HSE requirements",
        ],
      },
      {
        title: "Crop Trials",
    ...
    modules: [
      {
        ...
        features: [
          ...
          "Johne's Disease Monitoring Register — structured paratuberculosis monitoring records required by Red Tractor Dairy standards; test method (blood ELISA, milk ELISA, or faecal PCR — individual or pooled), laboratory, animals tested, result category (Negative / Low Positive / High Positive), updated herd risk level (Low / Medium / High per CHECS / AHDB guidance), action taken, and lab report reference; herd risk trend tracked across successive monitoring rounds",
          ...
          "Mobile capture — medicine records, livestock movement records, TB test records (including pre-movement tests with an inline reminder to complete the movement linkage on the dashboard once synced), welfare outcome assessments, lambing and calving records, livestock mortality records, daily livestock checks, livestock purchase records, deadweight kill sheet records, casualty/emergency slaughter records, and mart / auction sale records all available in the mobile app; forms save offline when there is no signal and sync automatically to the dashboard when connectivity is restored",
        ],
      },
    ],
  },
    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "Feed Derogations tab (UK Organic Regulations 2020, Art. 22) — dedicated case register for non-organic ingredient derogations; one case per ingredient tracks the full lifecycle from application through approval to expiry; status summary chips (Pending / Approved / Rejected / Expired / Withdrawn) give an at-a-glance compliance position; each case records ingredient name, feed product, species, certifier, applied / decision / expiry dates, regulatory derogation category, availability search confirmation, justification, and approval conditions; days-remaining badge turns amber below 60 days and red below 14",
      ...
      },
      {
        ...
        features: [
          ...
          "Input Derogation Register (UK Organic Regulations 2020 — Schedule 1 / Annex II) — certain inputs require prior written approval from your certification body before use: conventional seed where no certified organic equivalent is available, restricted crop protection substances, and other Schedule 1 / Annex II substances; the Input Derogations tab provides a dedicated case register with one case per input substance tracking the full lifecycle from application through to approval, expiry, or rejection; each case records input name, input type (Seed / Pesticide / Fertiliser / Cleaning Product), crop year, certifier, certifier reference, availability search date and OFAS/UKOAS reference, application and decision dates, expiry date, regulatory basis, justification for use (why no organic alternative was available), and any conditions attached to the approval; status summary chips at the top (Pending / Approved / Rejected / Expired / Withdrawn) give an at-a-glance compliance position; expiry badges turn amber at 60 days and red at 14 days",
      ...
      },
      {
        ...
        features: [
          ...
          "Mobile app — 4 dedicated organic arable screens: Overview (hub screen with API stats and quick-action buttons to the three field screens), Input Recording (offline-first permitted/restricted status chips, FieldPicker, substance input, certifier approval flow for restricted inputs), Seed Sourcing (offline-first derogation alert flow, crop chip picker, derogation approval reference capture), Harvest Recording (offline-first, organic certified status chips, FieldPicker, yield and grade capture); all three field screens save locally when offline and sync to the dashboard automatically on reconnection",
        ],
      },
      {
    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "Input Derogations — full case register for UK Organic Regs 2020 Sch. 1 / Annex II derogation applications with a split New Case / Record Decision workflow: the New Case form captures application details only (input name, type, regulatory basis, certifying body, availability search date and reference, application date, vintage year, and justification), leaving the case at Pending status; once a certifier decision is received, click Record Decision → on the case card to record decision date, status (Approved / Refused / Withdrawn / Expired), expiry date, and approval conditions — keeping application evidence and certifier decisions cleanly separated in the audit trail; expiry urgency badges at 90 / 30 days",
