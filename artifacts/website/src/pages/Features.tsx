...
const sections: Section[] = [
    ...
    modules: [
      {
        ...
        features: [
          ...
          "Sire Register — maintain a centralised directory of bulls, rams, boars, and bucks (owned, hired, or AI stud); each entry stores species, breed, ear tag or registration number, date of birth, source, and health status notes; once recorded, a sire is selectable from a dropdown in every AI and reproduction form so the donor name and breed auto-fill consistently across all records",
          "AI & Reproduction records — service date, sire/bull ID, breed, method (AI, synchronised AI, natural service, ET), and confirmation of pregnancy; sire picker shows all active Sire Register entries with auto-fill of breed; expected calving and lambing dates surface automatically in the Farm Planner",
          "Straw Inventory — log every AI semen delivery with supplier (Cogent, Genus ABS, Alta Genetics, etc.), batch number, straws received, storage location (nitrogen vessel, goblet, tank number), delivery date, and cost per straw; remaining stock calculated automatically from linked AI records with green / amber / red stock badges; straw picker in the AI form shows only in-stock batches and auto-fills batch reference, sire name, and breed — eliminating transcription errors from straw label to record; full chain of traceability from supplier batch through to every served female",
    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "PAT testing log — record annual Portable Appliance Tests for all electrical equipment on the holding; captures tester details, certificate number, pass / fail / advisory result, and next-due-date alerts; certificate copy upload per record; satisfies Electricity at Work Regulations 1989 duty",
  ...
  },
  {
    ...
    modules: [
      ...
      {
        title: "Financial Records & Sales Trading",
        icon: LineChart,
        color: "bg-emerald-50 text-emerald-600 border-emerald-100",
        badge: "module",
        features: [
          "Grain trading — record spot, forward contract, pool scheme and ex-store sales with buyer, tonnage, £/tonne, moisture, protein, grade achieved, crop year, weighbridge ticket and invoice reference; covers winter wheat, spring barley, malting barley, OSR, beans, peas, oats and more",
          "Livestock deadweight sales — kill sheet capture per species (cattle, sheep, pigs, deer) with head count, total and average deadweight, pence/kg, grade classification (e.g. R4L, U3), gross value, deductions (transport, AHDB levy), net payment, kill sheet reference and ear tag list",
          "Livestock mart / auction sales — lot number, auction mart, price per head, gross proceeds and auctioneer reference; vendor declaration reference linked for full traceability",
          "Milk statements — monthly statement entry per milk buyer (Arla, First Milk, Müller, Dairy Crest, Lactalis and more) with litres supplied, pence per litre, butterfat %, protein %, SCC, quality bonus/penalty, transport deduction and net payment; statement reference stored for audit",
          "Poultry batch settlements — batch reference, placed and collected head count, average placement and collection weights, FCR, kill-out %, settlement price per kg, bonuses, deductions and net payment per flock",
          "Egg sales — packing station statement entry with total dozens by size grade (small / medium / large / XL), rejection rate, price per dozen, gross value, packing deduction and net payment",
          "Pig kill records — kill sheet capture with processor, total and average deadweight, lean meat %, grade, P2 measurement, kill-out %, value per pig, bonuses and net settlement",
          "Direct & farm gate sales — log farm shop, box scheme, farmers market, wholesale, online or restaurant sales; product name, quantity, unit, unit price, auto-calculated gross value, payment method (cash, card, bank transfer, invoice) and payment status (paid, pending, overdue)",
          ...
          "CSV export of all sales and cost records; Xero-compatible export for seamless handoff to your accountant",
          "Mobile capture — grain sales, livestock sales, milk statements and direct farm gate sales can all be recorded offline in the field app and sync to the cloud automatically when connectivity is restored",
        ],
      },
      {
