    ...
    modules: [
      {
        ...
        features: [
          ...
          "Vet Ledger — Follow-up tracking: visits requiring a follow-up appear in the summary card count and surface as reminders in the Farm Planner; mark follow-up completed directly from the visit record",
    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "Food hygiene ratings, inspection visits log, and public liability insurance document storage",
