    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "Raise Invoice from Work Order — when creating a service invoice, toggling the Schedule a Work Order panel on automatically links the resulting work order to that invoice for full billing traceability; the invoice reference is stored against the work order record so managers can track from job completion to payment in one view",
