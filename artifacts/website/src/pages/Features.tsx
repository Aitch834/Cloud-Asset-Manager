    ...
    modules: [
      {
        ...
        features: [
          ...
          "Task Assignment — assign tasks to named staff members from multiple sources: the Week Ahead planner, Equipment defect reports, Risk assessments, Medicine withdrawal records, Vet follow-up visits, Spray applications, and Feed bin reorders; the staff member receives an SMS notification instantly with the task title, due date, and any note you add; assignments are tracked with a pending / in progress / completed / cancelled status workflow",
    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "Work Orders — raise formal work orders from the Invoices tab with auto-generated WO-YYYY-0001 reference numbers; each order captures customer, service description, scheduled date, estimated hours, and status (Draft → Scheduled → In Progress → Completed); work orders are linked to the customer directory for billing traceability",
          "Raise Invoice from Work Order — on any completed work order, a single click switches to the Invoices tab with the customer and description pre-filled; no re-typing required for accurate and consistent billing",
