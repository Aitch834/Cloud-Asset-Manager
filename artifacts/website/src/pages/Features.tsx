    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          "Full standard Viticulture module access within Organic Viticulture — the Organic Viticulture page includes all six standard Viticulture tabs alongside the organic compliance tabs: Overview (vineyard block overview and summary), Vine Register (variety, rootstock, and planting records), Phenology (BBCH growth stage log), Pruning & Canopy (all canopy operations from winter pruning through to green harvest), Harvest (yield and must chemistry records), and Disease Scouting (pest and disease pressure walkabout log with APHA notifiable organism alerts); organic producers have their complete vineyard operational and compliance records in one place without navigating between modules",
        ],
      },
      {
