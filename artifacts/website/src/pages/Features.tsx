    ...
    modules: [
      {
        ...
        features: [
          ...
          "LIS LIP One-Click Submission (cattle) — integration built and ready; temporarily paused from 21 July 2026 while LIS transitions cattle traceability services to a new Defra-operated platform; BCMS (CTS Web Services) remains the active cattle submission route in the meantime; LIP will resume once the new service is available (guidance expected September/October 2026)",
