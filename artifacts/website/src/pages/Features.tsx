    ...
    modules: [
      {
        ...
        features: [
          ...
          "Seed Store — batch inventory register tracking TGW, bag weight, and remaining stock for every seed delivery, with low-stock and used-up badges; batches link directly to crop assignments so stock is deducted automatically as seed is drilled",
      ...
      },
      {
        ...
        features: [
          ...
          "Beekeeper & Neighbour Notification Log — record every pre-spray notification made before applying insecticides or other products near apiaries or neighbouring land; captures notification date, recipient type (beekeeper or neighbour), name, contact details, method (phone, email, letter, or in-person), and confirmation-received flag; notification log is printable for Red Tractor inspection; mobile quick-entry available in the field; satisfies the Red Tractor Combinable Crops, Fresh Produce, and Horticulture requirement to document pre-application communication with affected parties",
        ],
      },
      {
        title: "Crop Trials",
    ...
    modules: [
      {
        ...
        features: [
          ...
          "LIS LIP One-Click Submission (cattle) — connect each farm's LIS account via a delegated OAuth sign-in flow in Farm Settings; a single click from each cattle movement row submits directly to the Livestock Information Platform API; covers on-farm and off-farm cattle movements, births, and deaths; LIP Submissions tab shows the full submission history with reference numbers, status, and payload log; sandbox mode available for testing before live submission",
