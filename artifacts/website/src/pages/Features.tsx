    ...
    modules: [
      {
        ...
        features: [
          ...
          "Seed cost capture on drilling records — record the seed cost per kilogram (£/kg) on every seed drilling entry; combined with seed rate and area to compute total seed input cost in the Season Production Report",
