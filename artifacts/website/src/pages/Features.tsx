    ...
    modules: [
      {
        ...
        features: [
          ...
          "Mobile capture — medicine records, livestock movement records, TB test records (including pre-movement tests with an inline reminder to complete the movement linkage on the dashboard once synced), welfare outcome assessments, lambing and calving records, livestock mortality records, daily livestock checks, livestock purchase records, deadweight kill sheet records, and mart / auction sale records all available in the mobile app; forms save offline when there is no signal and sync automatically to the dashboard when connectivity is restored",
        ],
      },
    ],
  },
