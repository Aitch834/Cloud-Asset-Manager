/**
 * Unit tests for SprayPhotoLightbox gesture and counter logic.
 *
 * All assertions target pure helpers in lib/vineSprayDiaryLightboxHelpers.ts
 * so there is no React Native dependency and the tests run in the plain
 * Node/Jest environment.
 *
 * vine-spray-diary-history.tsx imports the threshold constants and direction
 * values from this same module, so changing a constant there simultaneously
 * updates the component's runtime behaviour and these test expectations —
 * no silent drift.
 *
 * Covered behaviours (mirroring the component constants in vine-spray-diary-history.tsx):
 *
 *   SWIPE_DOWN_THRESHOLD  = 120 px
 *   SWIPE_HORIZ_THRESHOLD =  60 px
 *   Direction-lock movement threshold =  8 px
...
// ===========================================================================
// 5. Pinch-to-zoom clamping (MIN_SCALE=1, MAX_SCALE=5)
// ===========================================================================
