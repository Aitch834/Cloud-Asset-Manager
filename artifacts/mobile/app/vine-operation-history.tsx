...
function OperationRow({
  ...
  const handleDelete = () => {
    ...
    Alert.alert(
      ...
      `Delete the ${item.operationType ?? "operation"} record from ${formatDate(item.operationDate)}? This cannot be undone.`,
      [
...
export default function VineOperationHistoryScreen() {
  ...
  const { dismissed: bannerDismissed, dismiss: dismissBanner } = useIdentifierBannerDismiss("vine-operation-history", currentFarm?.id, user?.id);
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.searchRow}>
        ...
        <TextInput
          ...
          placeholder="Search by block, operator or type…"
