...
const FEED_TYPES = ["Grazed Pasture", "Conserved Forage", "Concentrate", "Mineral / Supplement", "Total Mixed Ration", "Other"];
...
export default function OrganicSheepFeedScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        notes: notes || null,
        syncEndpoint: `/api/farms/${currentFarm?.id}/organic-sheep-dairy/feed`,
        syncMethod: "POST",
  ...
  return (
    ...
    >
      <View style={[styles.header, { paddingTop: insets.top + spacing.sm }]}>
        ...
        <Text style={styles.headerTitle}>Organic Sheep Feed Record</Text>
        <View style={{ width: 36 }} />
      </View>
      ...
      >
        ...
        <View style={styles.row}>
          ...
          <View style={[styles.field, { flex: 1 }]}>
            ...
            <Input value={quantityKg} onChangeText={setQuantityKg} placeholder="e.g. 500" keyboardType="decimal-pad" />
          </View>
        </View>

        <View style={styles.field}>
          <Text style={styles.label}>Feed Product Name *</Text>
          <Input value={feedProductName} onChangeText={setFeedProductName} placeholder="e.g. Organic Ewe Nuts 18% CP" />
        </View>

        <View style={styles.field}>
          <Text style={styles.label}>Flock / Group</Text>
          <Input value={flockGroup} onChangeText={setFlockGroup} placeholder="e.g. Ewes — milkers" />
        </View>
