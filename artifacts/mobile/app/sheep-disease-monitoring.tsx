...
const MONITORING_TYPES = ["Scrapie (NSP)", "MV / Maedi Visna", "Johne's Disease", "Foot Rot / CODD", "Toxoplasmosis", "Enzootic Abortion (EAE)", "Orf", "Faecal Egg Count (FEC)", "Other"];
const STATUSES = ["Negative / Clear", "Positive — Action Required", "Pending Results", "In Progress", "Inconclusive"];
const TESTING_BODIES = ["APHA", "SAC Consulting", "Biobest", "Farm Vet", "Farm Lab", "Other"];
...
export default function SheepDiseaseMonitoringScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        notes: notes || null,
        syncEndpoint: `/api/farms/${currentFarm?.id}/sheep-disease-monitoring`,
        syncMethod: "POST",
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.row}>
          <View style={[styles.field, { flex: 1, marginRight: spacing.sm }]}>
            ...
            <Input value={schemeReference} onChangeText={setSchemeReference} placeholder="e.g. NSP scheme ref" />
          </View>
          <View style={[styles.field, { flex: 1 }]}>
