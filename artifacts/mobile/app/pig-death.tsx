      ...
      {missingIdentifiers && !bannerDismissed && (
        ...
        >
          ...
          <Text style={styles.identifierBannerText}>
            {!cphNumber && !sbiNumber
              ? "CPH and SBI are missing from your farm profile — pig death records cannot be submitted without them."
              : !cphNumber
              ? "CPH number is missing from your farm profile — required for pig death notifications."
              : "SBI number is missing from your farm profile — required for pig death notifications."}
