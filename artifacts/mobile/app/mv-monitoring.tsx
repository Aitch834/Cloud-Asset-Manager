...
const TEST_METHODS = ["ELISA", "AGID (Agar Gel Immunodiffusion)", "PCR", "Other"];
const STATUSES = ["Accredited — MV Free", "Accredited — Monitoring", "In Progress", "Not Accredited", "Pending Results"];
const SCHEMES = ["MV Accreditation Scheme (MVA)", "Scrapie Monitored Flock Scheme", "Other", "None"];
      ...
      >
        ...
        <View style={styles.row}>
          <View style={[styles.field, { flex: 1, marginRight: spacing.sm }]}>
            ...
            <Input value={numberTested} onChangeText={setNumberTested} placeholder="e.g. 45" keyboardType="number-pad" />
          </View>
          <View style={[styles.field, { flex: 1 }]}>
