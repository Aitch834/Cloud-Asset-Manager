...
const AGE_CLASSES = ["Lambs", "Hoggets", "Shearlings", "Ewes", "Rams", "Mixed"];
...
export default function SheepWeighRecordScreen() {
  ...
  const [ageClass, setAgeClass] = useState("Lambs");
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        notes: notes || null,
        syncEndpoint: `/api/farms/${currentFarm?.id}/sheep-weigh-records`,
        syncMethod: "POST",
