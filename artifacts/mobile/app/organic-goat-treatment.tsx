...
export default function OrganicGoatTreatmentScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        treatmentNumber: 1,
        notes: notes || null,
        syncEndpoint: `/api/farms/${currentFarm?.id}/organic-goat-dairy/treatments`,
        syncMethod: "POST",
  ...
  return (
    ...
    >
      <View style={[styles.header, { paddingTop: insets.top + spacing.sm }]}>
        ...
        <Text style={styles.headerTitle}>Organic Goat Treatment</Text>
        <View style={{ width: 36 }} />
      </View>
      ...
      >
        ...
        <View style={styles.row}>
          ...
          <View style={[styles.field, { flex: 1 }]}>
            ...
            <Input value={numberOfAnimals} onChangeText={setNumberOfAnimals} placeholder="e.g. 2" keyboardType="number-pad" />
          </View>
        </View>

        <View style={styles.field}>
          <Text style={styles.label}>Animal LIS Tags</Text>
          <Input value={animalLisTags} onChangeText={setAnimalLisTags} placeholder="e.g. UK123 456789" multiline />
        </View>
        ...
        <View style={styles.field}>
          ...
          <Input value={productName} onChangeText={setProductName} placeholder="e.g. Penicillin G" />
        </View>

        <View style={styles.field}>
          <Text style={styles.label}>Active Ingredient</Text>
          <Input value={activeIngredient} onChangeText={setActiveIngredient} placeholder="e.g. Benzylpenicillin" />
        </View>
