...
export default function OrganicFeedDerogationsScreen() {
  const insets = useSafeAreaInsets();
  const { currentFarm } = useFarm();
  const farmId = currentFarm?.id;

  const [cases, setCases] = useState<DerogationCase[]>([]);
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`${apiBase}/api/farms/${farmId}/organic-livestock/feed-derogations`, { headers });
      if (res.ok) {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Feed Derogations</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      >
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            UK Organic Regulations 2020, Art. 22 — prior written certifier approval is required before feeding any non-organic ingredient. Manage cases, correspondence, and documents in the dashboard.
          </Text>
        </View>
        ...
        {loading ? (
          ...
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptySubtext}>Open the dashboard to add and manage feed derogation cases, certifier correspondence, and approval documents.</Text>
          </View>
        ) : (
          <>
              ...
              return (
                ...
                >
                  <View style={styles.caseHeader}>
                    <View style={{ flex: 1 }}>
                      <Text style={styles.caseName}>{c.ingredientName}</Text>
                      <Text style={styles.caseSub}>{c.species}{c.feedProductName ? ` · ${c.feedProductName}` : ""}</Text>
                    </View>
                  ...
                  {isExpanded && (
                    <View style={styles.caseBody}>
                      ...
                      {c.regulatoryCategory ? (
                        <View style={styles.detailRow}>
                          <Text style={styles.detailLabel}>Regulatory Category</Text>
                          <Text style={styles.detailValue}>{c.regulatoryCategory}</Text>
                        </View>
                      ) : null}
                      ...
                      {c.appliedDate ? (
                        <View style={styles.detailRow}>
                          ...
                          <Text style={styles.detailValue}>{fmtDate(c.appliedDate)}</Text>
                        </View>
                      ) : null}
                      ...
                      {c.availabilitySearchDone ? (
                        <View style={styles.detailRow}>
                          ...
                          <View style={styles.tickBadge}>
                            ...
                            <Text style={styles.tickText}>Done</Text>
                          </View>
                        </View>
                      ) : null}
                      ...
                      <View style={styles.dashboardNote}>
                        ...
                        <Text style={styles.dashboardNoteText}>
                          Add correspondence, upload approval letters, and edit case details in the dashboard → Organic Livestock → Feed Derogations.
                        </Text>
                      </View>
                    </View>
                  )}
