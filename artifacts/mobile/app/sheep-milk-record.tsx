  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        notes: notes || null,
        syncEndpoint: `/api/farms/${currentFarm?.id}/sheep-dairy/milk-records`,
        syncMethod: "POST",
      ...
      >
        ...
        <View style={styles.row}>
          ...
          <View style={[styles.field, { flex: 1 }]}>
            ...
            <Input value={lactationNumber} onChangeText={setLactationNumber} placeholder="e.g. 3" keyboardType="number-pad" />
          </View>
        </View>
        ...
        {!!sccWarning && (
          <View style={styles.warning}>
            ...
            <Text style={styles.warningText}>SCC exceeds the 1,500k/mL regulatory limit for sheep milk</Text>
          </View>
        )}
        ...
        <View style={styles.row}>
          <View style={[styles.field, { flex: 1, marginRight: spacing.sm }]}>
            ...
            <Input value={buyerFat} onChangeText={setBuyerFat} placeholder="e.g. 6.5" keyboardType="decimal-pad" />
          </View>
          <View style={[styles.field, { flex: 1 }]}>
            <Text style={styles.label}>Buyer Protein %</Text>
            <Input value={buyerProtein} onChangeText={setBuyerProtein} placeholder="e.g. 5.5" keyboardType="decimal-pad" />
          </View>
        </View>
