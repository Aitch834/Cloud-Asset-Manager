...
const recordOptions: RecordOption[] = [
  ...
  {
    id: "sheep-tupping",
    title: "Sheep Tupping Record",
    description: "Record ram-to-ewe service — ram ID, breeding group, date put to, date removed, and expected scanning date; links to flock performance analytics",
    icon: "sun",
    color: "#15803d",
    bgColor: "#dcfce7",
    route: "/sheep-tupping",
  ...
  },
  {
    ...
    description: "Log pregnancy scanning results per ewe or group — scanner name, date, singles/twins/triplets/empties count and expected lambing date",
    icon: "search",
    color: "#15803d",
    bgColor: "#dcfce7",
    route: "/sheep-scanning",
    moduleKeys: ["sheep-production"],
    requiresSectors: ["livestock"],
  },
  {
    id: "sheep-weigh",
    title: "Sheep Weigh-in & DLWG",
    description: "Record group or individual weigh-in — date, average weight, DLWG calculation vs target; feeds Red Tractor Sheep Assurance performance records",
    icon: "bar-chart-2",
    color: "#15803d",
    bgColor: "#dcfce7",
    route: "/sheep-weigh",
  ...
  {
    id: "sheep-shearing",
    title: "Sheep Shearing Record",
    description: "Log shearing event — date, contractor details, fleece weights per group, and wool merchant for BWMB traceability",
    icon: "scissors",
    color: "#15803d",
    bgColor: "#dcfce7",
    route: "/sheep-shearing",
    moduleKeys: ["sheep-production"],
    requiresSectors: ["livestock"],
  },
  {
  ...
  {
    id: "beef-weigh",
    title: "Beef Weigh-in & DLWG",
    description: "Record group or individual beef weigh-in — entry weight, current weight, DLWG calculation and target comparison for Red Tractor Beef & Lamb performance records",
    icon: "bar-chart-2",
    color: "#b45309",
    bgColor: "#fef3c7",
    route: "/beef-weigh",
    moduleKeys: ["beef-production"],
    requiresSectors: ["livestock"],
  },
  {
    id: "beef-bcs",
    title: "Beef Body Condition Score",
    description: "Record BCS assessments on the 1–5 scale for beef cattle — group or individual scoring at key production stages with colour-coded action thresholds",
    icon: "trending-up",
    color: "#b45309",
    bgColor: "#fef3c7",
    route: "/beef-bcs",
  ...
  {
    id: "beef-finishing",
    title: "Beef Finishing Record",
    description: "Log beef finishing group entry — shed/pen, target finish weight, target date, current DLWG and ration; close-out captures exit weight, kill-out and deadweight settlement reference",
    icon: "clipboard",
    color: "#b45309",
    bgColor: "#fef3c7",
    route: "/beef-finishing",
    moduleKeys: ["beef-production"],
    requiresSectors: ["livestock"],
  },
  {
  ...
  {
    id: "medicated-feed-record",
    title: "Medicated Feed Record",
    description: "Log medicated compound feed delivery — active ingredient, withdrawal period end date, affected group and licensed indication; clearance tracking prevents feeding to unaffected animals",
    icon: "package",
    color: "#c2410c",
    bgColor: "#ffedd5",
    route: "/medicated-feed-record",
    moduleKeys: ["livestock-management"],
    requiresSectors: ["livestock"],
  },
  {
  ...
  },
  {
    ...
    description: "Quick-log labour hours in the field — date, staff member, operation type, hours worked, and field or activity reference; feeds the Timesheet dashboard for cost allocation",
    icon: "clock",
    color: "#7c3aed",
    bgColor: "#ede9fe",
  ...
  },
  {
    ...
    description: "Record a grain or livestock settlement document — contract reference, date, tonnage or head, price per unit, and net settlement value linked to movement or haulage records",
    icon: "file-text",
    color: "#0891b2",
    bgColor: "#e0f2fe",
    route: "/settlement-note",
    moduleKeys: ["finance-business"],
  },
  {
    id: "visitor",
    title: "Visitor Log",
