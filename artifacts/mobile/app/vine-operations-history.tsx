        ...
        <View style={editStyles.container}>
          ...
          <ScrollView style={editStyles.scroll} contentContainerStyle={editStyles.scrollContent} keyboardShouldPersistTaps="handled">
            {record?.operationType ? (
              <View style={editStyles.typeBadge}>
                <Feather name="scissors" size={15} color={colors.primary} />
                <Text style={editStyles.typeBadgeLabel}>{record.operationType}</Text>
              </View>
            ) : null}
...
const editStyles = StyleSheet.create({
  ...
  typeBadgeLabel: { fontFamily: fonts.semiBold, fontSize: fontSize.md, color: colors.primary },
  card: {
    backgroundColor: colors.surface,
