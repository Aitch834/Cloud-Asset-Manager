...
export const LOOKUP_DEFINITIONS: Record<string, LookupDefinition> = {
  ...
  carbon_certification_bodies: {
    label: "Carbon Certification Bodies",
    description: "Organisations that verify, certify or endorse farm carbon footprints against recognised standards (PAS 2060, LSCA, etc.)",
    authority: "BSI / DEFRA / Carbon Trust",
    authorityUrl: "https://www.bsigroup.com/en-GB/industries-and-sectors/energy-and-utilities/pas-2060/",
    reviewFrequency: "Annual",
    items: [
      "Carbon Trust",
      "BSI (PAS 2060)",
