...
const MODULES = [
  ...
  { key: "horticulture", name: "Horticulture", description: "Growing block register, crop records, irrigation water quality testing and harvest records for outdoor and protected horticulture growers", monthlyPricePence: 2000 },
  { key: "fresh-produce", name: "Fresh Produce", description: "Packhouse & despatch records, allergen management reviews, traceability codes, food safety checks and cold chain compliance for produce destined for retail or wholesale", monthlyPricePence: 1500 },
