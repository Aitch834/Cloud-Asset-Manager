...
const MODULES = [
  ...
  { key: "livestock-management", name: "Livestock Management", description: "Herd/flock register, BCMS cattle movements, medicines, TB test register, welfare outcome assessments (WOA), sheep dipping records, ATA transporter tracking, feed, water quality, mortality, vet health plans and AI reproduction records", monthlyPricePence: 3000 },
  ...
  { key: "staff-training", name: "Staff & Training", description: "Training records, certificates, right-to-work checks, PPE issue register, and competency tracking — meeting Red Tractor and H&S at Work Act requirements", monthlyPricePence: 1000 },
  { key: "risk-waste", name: "Health, Safety & Risk Management", description: "Risk assessments, COSHH records, PAT testing, fire extinguisher register, accident book, contractor H&S file (PLI & RAMS), waste disposal, fly-tipping and encampment records", monthlyPricePence: 1000 },
  ...
  { key: "fresh-produce", name: "Fresh Produce", description: "End-to-end fresh produce compliance — growing block register, crop records, irrigation water quality testing, harvest records, pre-cooling and intake, packhouse & despatch, allergen management and cold chain records for produce destined for retail or wholesale", monthlyPricePence: 2500 },
  ...
  { key: "organic-viticulture", name: "Organic Viticulture", description: "Vineyard block conversion register (3-year period tracking), organic input log, copper register with 28 kg/ha per 7-year limit tracker, input derogation case management with correspondence log, organic wine production additives and SO₂ compliance (UK-retained EU Reg 203/2012), and certificate register for UK organic vineyard certification", monthlyPricePence: 2000 },
  { key: "organic-arable", name: "Organic Arable", description: "Field/parcel conversion register with status tracking (pre-conversion, in-conversion, certified), organic seed sourcing log with derogation records, permitted input log cross-referenced against Annex II, harvest declarations with buyer organic declarations and premium tracking, and certification body records for Soil Association, OF&G, and Organic Farmers & Growers", monthlyPricePence: 1200 },
  ...
  { key: "goat-production", name: "Goat Production", description: "Herd register, mating & buck records, pregnancy scanning, weigh-in & DLWG, cull/draft/market records, vaccination programmes and disease monitoring (CAE, CLA, foot rot) for meat goat enterprises", monthlyPricePence: 2500 },
  ...
  { key: "viticulture", name: "Viticulture (Vineyard Growing)", description: "FSA Vine Register, vineyard block management, BBCH phenology tracking, pruning & canopy operation records, vintage harvest data, and disease scouting (Downy/Powdery Mildew, Botrytis, Xylella watch) for UK vineyard compliance", monthlyPricePence: 2500 },
  ...
  { key: "organic-sheep-dairy", name: "Organic Sheep Dairy", description: "Organic certification records for dairy sheep — flock conversion register (SA/OF&G/Biodynamic), organic milk collection log with non-organic reason tracking, feed & nutrition log with ≥95% certified organic dry matter monitoring, and vet treatment register with mandatory doubled withdrawal periods under UK Organic Regulations", monthlyPricePence: 2000 },
  ...
  { key: "organic-goat-dairy", name: "Organic Goat Dairy", description: "Organic certification records for dairy goats — flock conversion register (SA/OF&G/Biodynamic), organic milk collection log with non-organic reason tracking, feed & nutrition log with ≥95% certified organic dry matter monitoring, and vet treatment register with mandatory doubled withdrawal periods under UK Organic Regulations", monthlyPricePence: 2000 },
  { key: "venison-production", name: "Venison Production", description: "Stalking and cull records with species, sex and age-class detail, carcass weight and kill-out %, Wild Game Declaration tracking, carcass processing facility and AGHE records, venison sales (game dealer, wholesale, direct), population survey log (driven count, thermal imaging, camera trap), health records (vaccination, bTB SICCT and gamma-IFNG test, post mortem), and a firearms and stalking-certificate register (Section 1 FC, DSC1, DSC2, WGMI food hygiene) for UK deer enterprises", monthlyPricePence: 2500 },
  { key: "organic-venison", name: "Organic Venison", description: "Organic certification records for farmed deer enterprises — certifying body and certificate register (Soil Association / OF&G / Biodynamic), grazing compartment land register with conversion status tracking (pre-conversion through certified organic), organic feed and mineral supplement log with certifier approval recording, and input derogation case management for non-organic treatments under UK Organic Regulations", monthlyPricePence: 2000 },
  { key: "resource-planner", name: "Resource Planner", description: "Visual resource planning for larger operations — build a registry of tractors, implements, vehicles and staff, then drag-and-drop resources onto tasks in the Week Ahead Gantt view. Conflict and pinch-point detection highlights double-bookings and capacity bottlenecks across your operation.", monthlyPricePence: 2000 },
  { key: "equine", name: "Equine Management", description: "Equine register, health records, farrier visits, competition and movement records for horses and ponies kept on the holding", monthlyPricePence: 1500 },
  { key: "beekeeping", name: "Beekeeping", description: "Hive register, colony inspection records, honey harvest log, treatment records (Varroa, brood disease), swarm management and apiary site register", monthlyPricePence: 800 },
  { key: "organic-poultry", name: "Organic Poultry", description: "Organic certification records for poultry enterprises — flock conversion register, organic feed sourcing with ≥95% certified organic dry matter monitoring, outdoor access and range condition records, and vet treatment register with mandatory doubled withdrawal periods under UK Organic Regulations", monthlyPricePence: 2000 },
];
