...
const CSS = (pageSize: string) => `
  ...
  *, *::before, *::after { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
  ...
  .hdr-right { text-align: right; font-size: 7px; color: #6b7280; line-height: 1.6; }
  .rt-badge { display: inline-block; background: #dc2626; color: #fff; font-size: 6.5px; font-weight: 700; padding: 2px 6px; border-radius: 3px; letter-spacing: 0.05em; margin-bottom: 3px; }
...
<div class="hdr">
  <div class="hdr-left">
    ...
    ${opts.extraMeta ? `<p style="color:#6b7280">${opts.extraMeta}</p>` : ""}
  </div>
  <div class="hdr-right">
