...
import { AlertTriangle, Plus, Trash2, Camera, File, Upload, Loader2, MapPin, Phone, Printer, ChevronDown, ChevronUp } from "lucide-react";
    ...
    <div style={{ padding: "10px 14px 12px", background: "#f9fafb", borderTop: "1px solid #f3f4f6" }}>
      ...
      <label style={{ display: "inline-flex", alignItems: "center", gap: 6, cursor: "pointer" }}>
        ...
        <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: "0.75rem", padding: "4px 10px", border: "1px solid #d1d5db", borderRadius: 5, color: "#374151", background: "#fff" }}>
          {isUploading ? <><Loader2 size={12} style={{ animation: "spin 1s linear infinite" }} /> Uploading {progress}%</> : <><Camera size={12} /> Add Photo</>}
        </span>
