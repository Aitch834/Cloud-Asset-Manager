        ...
        <Dialog open onOpenChange={() => setViewRec(null)}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              {viewRec.jmmEnrolled && viewRec.njmpPlanDate && <div><p className="text-xs text-muted-foreground uppercase tracking-wide">Plan Last Reviewed</p><p className="font-medium">{johnesFmtDate(viewRec.njmpPlanDate)}</p></div>}
