...
import { Plus, Pencil, Trash2, Loader2, LayoutGrid, Leaf, Droplets, Package, Eye } from "lucide-react";
...
type Tab = "blocks" | "crops" | "water" | "harvest";
...
export default function HorticulturePage() {
  ...
  const [tab, setTab] = useState<Tab>(() => {
    ...
    const valid: Tab[] = ["blocks", "crops", "water", "harvest"];
    return t && valid.includes(t) ? t : "blocks";
  });
  if (!farmId) return <Redirect to="/" />;
  return (
    <AppLayout title="Horticulture">
      <div className="space-y-4">
        <TabBar>
