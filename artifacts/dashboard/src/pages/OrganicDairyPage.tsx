...
// ── JohnesTab inlined here (not imported from DairyPage) so it is defined in
// this module's scope. The imported version fails with "Invalid hook call" when
// rendered via Radix TabsContent — inlining is the proven fix.
const JOHNES_TYPES = [
