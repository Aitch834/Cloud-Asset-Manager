...
export function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }: Props) {
    ...
    <Dialog open={open} onOpenChange={(o) => { if (!o) onClose(); }}>
      <DialogContent className="max-w-3xl p-0 gap-0 overflow-hidden rounded-2xl">
        <DialogHeader className="px-6 pt-5 pb-3">
          <DialogTitle>Draw Block Boundary — {blockName}</DialogTitle>
          <DialogDescription>
            Click on the satellite map to place boundary points. Need at least 3 points to close the polygon. Area is calculated automatically.
          </DialogDescription>
        </DialogHeader>
