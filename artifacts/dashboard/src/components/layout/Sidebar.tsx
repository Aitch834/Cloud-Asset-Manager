...
const coreNav: NavItem[] = [
  ...
  { name: "Storage Locations", href: "/storage-locations", icon: Warehouse, moduleKeys: ["field-crop-management", "fresh-produce"] },
  { name: "Crop Stock", href: "/crop-stock", icon: Layers, moduleKeys: ["field-crop-management", "fresh-produce"] },
