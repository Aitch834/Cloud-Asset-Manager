...
// Radix UI v2.1+ also throws when SelectItem receives value="". Skip
// rendering entirely for empty-string values — they are meaningless as
// selectable options and are only produced by patterns like `value={x || ""}`.
