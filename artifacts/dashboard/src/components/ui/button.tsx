...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl font-semibold transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-border bg-transparent hover:bg-black/5 hover:border-black/10 text-foreground",
        secondary: "bg-black/5 text-foreground hover:bg-black/10",
        ghost: "hover:bg-black/5 text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
      },
      size: {
        default: "h-11 px-8 py-2 min-w-[5rem]",
        sm: "h-9 px-6 text-sm rounded-lg min-w-[4rem]",
