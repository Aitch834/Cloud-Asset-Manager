...
export function NotificationPanel() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div className="absolute right-0 top-12 w-[360px] rounded-2xl shadow-2xl border border-border/50 z-[100] overflow-hidden"
             style={{ background: '#ffffff' }}>
          <div className="flex items-center justify-between px-4 py-3 border-b border-border/50" style={{ background: '#ffffff' }}>
          ...
          <div className="max-h-[420px] overflow-y-auto divide-y divide-border/30">
            {notifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center px-6" style={{ background: '#ffffff' }}>
          ...
          {notifications.length > 0 && (
            <div className="border-t border-border/50 px-4 py-2.5" style={{ background: '#f9fafb' }}>
