import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, l as useQuery, O as useMutation, j as jsxRuntimeExports, c as Button, L as Label, I as Input, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, Q as React } from "./index-D3ay9Ao3.js";
import { A as AppLayout, r as Bug, I as Info } from "./AppLayout-DRFFu3V0.js";
...
import { S as Save } from "./save-CZOAeLig.js";
import { P as Phone } from "./phone-BafxWONj.js";
import { M as Mail } from "./mail-C9loqF6e.js";
import { T as Target } from "./target-Dvll1KcS.js";
...
function CompliancePage() {
  ...
  const [tab, setTab] = reactExports.useState("biosecurity");
  ...
  const addTargetM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/feed-stock-targets`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["feed-stock-targets", farmId] });
  ...
  const updateTargetM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/feed-stock-targets/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["feed-stock-targets", farmId] });
  ...
  const deleteTargetM = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/feed-stock-targets/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["feed-stock-targets", farmId] });
  ...
  const delDiseaseMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/disease-incidents/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      invalidate();
  ...
  const delRecallMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/feed-recalls/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      invalidate();
...
<div class="footer">
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Compliance & Contingency Plans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showDiseaseDialog, onOpenChange: setShowDiseaseDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl max-h-[92vh] overflow-y-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showRecallDialog, onOpenChange: setShowRecallDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl max-h-[92vh] overflow-y-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showTargetDialog, onOpenChange: setShowTargetDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", children: [
