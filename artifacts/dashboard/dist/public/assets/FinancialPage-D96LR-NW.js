import { b as useAppStore, j as jsxRuntimeExports, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, I as Input, d as Button, T as Plus, X, p as Link, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, N as DialogMutationError, J as DialogFooter, e as LoaderCircle, O as React } from "./index-CPTnvEXt.js";
import { u as useLookupStrings } from "./use-lookup-asOz4C6u.js";
import { a as usePersistedFilter } from "./use-persisted-filter-DDU9ECLL.js";
import { u as usePersistedTab } from "./use-persisted-tab-Cq6dmPgy.js";
import { A as AppLayout, l as ShoppingBag, e as ChartColumn, Z as Zap, a as Wheat, T as TrendingUp } from "./AppLayout-BwXO7xhU.js";
import { T as Textarea } from "./textarea-H-TPe2zn.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, e as SelectGroup, f as SelectLabel } from "./select-Bk6lb2xJ.js";
import { B as Badge } from "./badge-iMvLjFu0.js";
import { T as TabBar, a as TabButton } from "./tab-button-CTd8n9HR.js";
import { d as downloadCsvFile, b as buildCsv } from "./csv-Bz7rPmkT.js";
import { F as FileText, P as PoundSterling } from "./shield-alert-B7niEs8n.js";
import { S as Search } from "./search-BnbGSFNU.js";
import { D as Download } from "./download-BOKZWSMN.js";
import { L as Link2 } from "./link-2-1HQY6PlO.js";
import { E as ExternalLink } from "./external-link-CwXKbbSk.js";
import { T as Trash2 } from "./trash-2-0oHXg6f9.js";
...
import { U as Upload } from "./upload-BpJeU2Ix.js";
...
import "./database-DZVhIVGw.js";
import "./triangle-alert-Ut7Klcz_.js";
import "./shield-check-BeIEEaAz.js";
import "./tractor-CJkh6ZfS.js";
import "./index-pBazuacE.js";
import "./index-IVlS125W.js";
import "./chevron-up-HWkGJSHU.js";
...
function TransactionsTab({ farmId }) {
  ...
  const txListRef = reactExports.useRef(null);
  ...
  const agriEnvProjects = agriEnvProjectsQ.data ?? [];
  ...
  const handleEnterpriseRowClick = (enterprise) => {
  ...
  const agriEnvProjectName = (id) => agriEnvProjects.find((p) => p.id === id)?.schemeName ?? `Project #${id}`;
  ...
  const enterpriseBreakdown = Object.entries(enterpriseBreakdownMap).filter(([, v]) => v.income > 0 || v.expense > 0).sort((a, b) => b[1].income + b[1].expense - (a[1].income + a[1].expense));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    showEnterpriseBreakdown && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, marginBottom: "1.25rem", overflow: "hidden" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0.75rem 1.25rem", borderBottom: "1px solid #f3f4f6", display: "flex", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { size: 14, style: { color: "#6b7280" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "0.75rem", fontWeight: 600, color: "#374151", textTransform: "uppercase", letterSpacing: "0.05em", margin: 0 }, children: [
          "Income & Expenses by Enterprise",
          yearFilter !== "all" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontWeight: 400, color: "#9ca3af", marginLeft: 6 }, children: [
            "— ",
            yearFilter
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "0.8125rem" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { background: "#f9fafb" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { padding: "0.5rem 1.25rem", textAlign: "left", fontWeight: 600, color: "#6b7280", fontSize: "0.72rem", textTransform: "uppercase", letterSpacing: "0.04em" }, children: "Enterprise" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { padding: "0.5rem 1.25rem", textAlign: "right", fontWeight: 600, color: "#6b7280", fontSize: "0.72rem", textTransform: "uppercase", letterSpacing: "0.04em" }, children: "Income" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { padding: "0.5rem 1.25rem", textAlign: "right", fontWeight: 600, color: "#6b7280", fontSize: "0.72rem", textTransform: "uppercase", letterSpacing: "0.04em" }, children: "Expenses" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { padding: "0.5rem 1.25rem", textAlign: "right", fontWeight: 600, color: "#6b7280", fontSize: "0.72rem", textTransform: "uppercase", letterSpacing: "0.04em" }, children: "Net" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: enterpriseBreakdown.map(([enterprise, { income, expense }], i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              ...
              style: { borderTop: "1px solid #f3f4f6", cursor: "pointer", background: isActive ? "#f0fdf4" : void 0, transition: "background 0.1s" },
              onMouseEnter: (e) => {
                if (!isActive) e.currentTarget.style.background = "#f9fafb";
              },
              onMouseLeave: (e) => {
                e.currentTarget.style.background = isActive ? "#f0fdf4" : "";
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "0.5rem 1.25rem", fontWeight: 500, color: "#111827" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 5 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { width: 8, height: 8, borderRadius: "50%", background: ["#3b82f6", "#10b981", "#f59e0b", "#8b5cf6", "#ef4444", "#06b6d4", "#f97316"][i % 7], flexShrink: 0 } }),
                  enterprise
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { style: { padding: "0.5rem 1.25rem", textAlign: "right", color: "#166534", fontWeight: 500 }, children: [
                  "£",
                  (income / 100).toFixed(2)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { style: { padding: "0.5rem 1.25rem", textAlign: "right", color: "#374151" }, children: [
                  "£",
                  (expense / 100).toFixed(2)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { style: { padding: "0.5rem 1.25rem", textAlign: "right", fontWeight: 600, color: rowNet >= 0 ? "#166534" : "#991b1b" }, children: [
                  rowNet < 0 ? "−" : "",
                  "£",
                  (Math.abs(rowNet) / 100).toFixed(2)
                ] })
              ]
            },
            enterprise
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: txListRef, style: { display: "flex", gap: 8, marginBottom: "1rem", alignItems: "center", flexWrap: "wrap" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: enterpriseFilter === "" ? "__untagged__" : enterpriseFilter, onValueChange: (value) => setEnterpriseFilter(value === "__untagged__" ? "" : value), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { style: { width: 160 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Enterprises" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "__untagged__", children: "Untagged" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Viticulture", children: "Viticulture" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Arable", children: "Arable" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Livestock", children: "Livestock" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Dairy", children: "Dairy" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Horticulture", children: "Horticulture" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Diversification", children: "Diversification" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filtered.map((r, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: i < filtered.length - 1 ? "1px solid #f3f4f6" : "none", background: r.isAutoGenerated ? "#fafeff" : void 0 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { style: { padding: "0.625rem 0.875rem", fontWeight: 500, maxWidth: 220 }, children: [
            ...
            AGRI_ENV_INCOME_CATS.includes(r.category) && r.transactionType === "income" && (r.agriEnvProjectId ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 4, marginTop: 3, fontSize: "0.68rem", fontWeight: 600, background: "#dcfce7", color: "#166534", border: "1px solid #bbf7d0", borderRadius: 4, padding: "1px 6px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { size: 9 }),
              "via milestone · ",
              agriEnvProjectName(r.agriEnvProjectId),
              ...
              {
                onClick: () => {
                  setLinkingTx({ id: r.id, description: r.description });
                  setSelectedProjectId("");
                },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "0.625rem 0.875rem", color: "#6b7280", whiteSpace: "nowrap" }, children: r.enterprise || "—" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addOpen, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.category, onValueChange: (v) => setForm((f) => ({ ...f, category: v })), children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: form.transactionType === "income" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectGroup, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectLabel, { children: "Viticulture" }),
                  ["Grape Sales", "Wine Sales — Sparkling", "Wine Sales — Still", "Wine Sales — Rosé", "Winery Contract Processing Income", "Vineyard Agri-Environment Scheme", "Other Viticulture Income"].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c, children: c }, c))
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectGroup, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectGroup, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectLabel, { children: "Viticulture" }),
                  ["Vine Management", "Winery Processing Costs", "Vineyard Establishment Costs", "Vine Purchases & Replacements"].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c, children: c }, c))
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectGroup, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Enterprise Tag" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.enterprise ?? "", onValueChange: (v) => setForm((f) => ({ ...f, enterprise: v })), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "None (general)" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "", children: "None (general)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Viticulture", children: "Viticulture" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Arable", children: "Arable" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Livestock", children: "Livestock" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Dairy", children: "Dairy" }),
    ...
    linkingTx && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,0.35)", zIndex: 50, display: "flex", alignItems: "center", justifyContent: "center" }, onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "0.8rem", color: "#6b7280", marginBottom: 16 }, children: [
        ...
        ' the milestone payment — it will be shown as "via milestone record" and excluded from any double-count warning in the P&L.'
      ] }),
      ...
      agriEnvProjects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.8rem", color: "#6b7280", marginBottom: 14 }, children: "No agri-env projects found for this farm. Add a project in the Agri-Environment tab first." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              ...
              agriEnvProjects.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: String(p.id), children: p.schemeName }, p.id))
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          setLinkingTx(null);
          setSelectedProjectId("");
        }, style: { padding: "0.45rem 1rem", border: "1px solid #d1d5db", borderRadius: 6, background: "#fff", fontSize: "0.875rem", cursor: "pointer", color: "#374151" }, children: "Cancel" }),
        agriEnvProjects.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            disabled: !selectedProjectId || linkMut.isPending,
            onClick: () => {
              if (selectedProjectId) linkMut.mutate({ txId: linkingTx.id, projectId: parseInt(selectedProjectId) });
            },
            ...
            children: linkMut.isPending ? "Saving…" : "Link transaction"
          }
        )
      ] }),
      linkMut.isError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.78rem", color: "#dc2626", marginTop: 8 }, children: "Failed to link — please try again." })
    ] }) }),
...
function FinancialAnalyticsTab({ farmId }) {
  const [yearFilter, setYearFilter] = usePersistedFilter({ page: "financial-analytics", filter: "year", farmId, defaultValue: String((/* @__PURE__ */ new Date()).getFullYear()), isValid: (v) => v === "all" || /^\d{4}$/.test(v) });
  const [enterpriseFilter, setEnterpriseFilter] = usePersistedFilter({ page: "financial-transactions", filter: "enterprise", farmId, defaultValue: "all" });
  const txQ = useQuery({
    queryKey: ["financial-transactions", farmId],
    queryFn: () => fetch(`/api/farms/${farmId}/financial-transactions`).then((r) => r.json()),
  ...
  const filteredTx = enterpriseFilter === "all" ? yearTx : yearTx.filter((r) => (r.enterprise ?? "") === enterpriseFilter);
  ...
  const totalIncome = filteredTx.filter((r) => r.transactionType === "income").reduce((s, r) => s + (r.amountPence ?? 0), 0) / 100;
  const totalExpense = filteredTx.filter((r) => r.transactionType === "expense").reduce((s, r) => s + (r.amountPence ?? 0), 0) / 100;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700 shrink-0 ml-2", children: "Enterprise" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: enterpriseFilter, onValueChange: setEnterpriseFilter, children: [
      ...
      enterpriseFilter !== "all" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium px-2 py-0.5 rounded-full", style: { background: "#dcfce7", color: "#166534" }, children: [
        enterpriseFilter,
        " only"
      ] })
    ] }),
...
function AccountantPackTab({ farmId }) {
  ...
  const enterprises = Array.from(new Set(allTx.map((r) => r.enterprise).filter(Boolean))).sort();
  ...
  const linkedProjectsByCategory = {};
  const linkedPaymentsByCategory = {};
  ...
  const enterpriseMap = /* @__PURE__ */ new Map();
  filteredTx.forEach((r) => {
  ...
  function getPlCsvRows() {
    const toGbp = (pence) => (pence / 100).toFixed(2);
    return [
  ...
  function handlePrint() {
    ...
    const incomeRows = incomeByCategory.map((r) => {
      ...
      const badges = projects.map(
        (name) => `<span class="agri-env-badge" style="display:inline-block;margin-top:3px;margin-right:4px;font-size:7.5pt;font-weight:600;color:#166534;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:3px;padding:1px 5px;">via milestone · ${esc(name)}</span>`
      ).join("");
    ...
    const expenseRows = expenseByCategory.map((r) => `<tr><td>${esc(r.cat)}</td><td class="num">${f(r.total)}</td></tr>`).join("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        enterpriseLabel && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "inline-block", marginTop: 4, fontSize: "0.75rem", fontWeight: 600, background: "#f0fdf4", color: "#166534", border: "1px solid #bbf7d0", borderRadius: 4, padding: "2px 8px" }, children: [
          enterpriseLabel,
          " only — livestock purchases excluded"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }, children: [
        ...
        enterprises.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: enterpriseFilter, onValueChange: setEnterpriseFilter, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { style: { width: 170 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Enterprises" }),
            enterprises.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: e, children: e }, e))
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: handleDownloadPlCsv, disabled: isLoading, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { size: 14, className: "mr-2" }),
          "Download Full P&L CSV"
        ] }),
        enterpriseSummaries.length > 0 && enterpriseFilter === "all" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: handleDownloadCsv, disabled: isLoading, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { size: 14, className: "mr-2" }),
          "Download CSV"
        ] }),
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "3rem", color: "#9ca3af" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          incomeByCategory.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", color: "#9ca3af", padding: "1.5rem", border: "1px dashed #e5e7eb", borderRadius: 8, fontSize: "0.825rem" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: incomeByCategory.map((r, i, arr) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: i < arr.length - 1 ? "1px solid #f3f4f6" : "none" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { style: { padding: "7px 10px", color: "#374151" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: r.cat }),
                (linkedProjectsByCategory[r.cat] ?? []).map((name) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 3, marginTop: 3, fontSize: "0.7rem", color: "#166534", background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 4, padding: "1px 6px", width: "fit-content" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { size: 9 }),
                  "via milestone · ",
                  name
                ] }, name)),
                (linkedPaymentsByCategory[r.cat] ?? []).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 7, padding: "6px 8px", background: "#f9fafb", borderLeft: "3px solid #86efac", borderRadius: 3 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: 4, fontSize: "0.7rem", fontWeight: 700, color: "#166534" }, children: "Linked milestone payments" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "minmax(80px, 0.8fr) minmax(78px, 0.7fr) minmax(120px, 1.5fr)", gap: "3px 8px", fontSize: "0.72rem", color: "#4b5563" }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: "#6b7280" }, children: "Date" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: "#6b7280", textAlign: "right" }, children: "Amount" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: "#6b7280" }, children: "Milestone project" }),
                    (linkedPaymentsByCategory[r.cat] ?? []).map((payment) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: fmt(payment.transactionDate) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "right", fontWeight: 600, color: "#166534" }, children: fmtAmt(payment.amountPence) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: payment.projectName })
                    ] }, payment.id))
                  ] })
                ] })
              ] }),
      ...
      enterpriseSummaries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 24 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { fontSize: "0.875rem", fontWeight: 700, color: "#374151", marginBottom: 12, borderBottom: "1px solid #e5e7eb", paddingBottom: 6 }, children: "By Enterprise" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 16 }, children: enterpriseSummaries.map((ent) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, overflow: "hidden" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "#f9fafb", borderBottom: "1px solid #e5e7eb", padding: "8px 12px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, fontSize: "0.85rem", color: "#111827" }, children: ent.name }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "0.8125rem" }, children: [
            ...
            ].map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: "1px solid #f3f4f6" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "6px 12px", color: "#6b7280" }, children: row.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "6px 12px", textAlign: "right", fontWeight: 500, color: row.color }, children: row.value === 0 ? "—" : fmtAmt(Math.abs(row.value)) })
            ] }, row.label)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tfoot", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderTop: `2px solid ${ent.grossMargin >= 0 ? "#d1fae5" : "#fecaca"}`, background: ent.grossMargin >= 0 ? "#f0fdf4" : "#fff1f2" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "8px 12px", fontWeight: 700, color: "#111827" }, children: "Gross Margin" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { style: { padding: "8px 12px", textAlign: "right", fontWeight: 700, color: ent.grossMargin >= 0 ? "#166534" : "#dc2626", fontSize: "0.95rem" }, children: [
                ent.grossMargin < 0 ? "(" : "",
                fmtAmt(Math.abs(ent.grossMargin)),
                ent.grossMargin < 0 ? ")" : ""
              ] })
            ] }) })
          ] })
