import { q as createLucideIcon, r as reactExports, e as useControllableState, j as jsxRuntimeExports, P as Primitive, ax as useId, f as composeEventHandlers, g as Presence, h as createContextScope, i as useComposedRefs, an as useLayoutEffect2, Q as React, ap as createCollection, k as cn, b as useAppStore, a as useToast, t as useQueryClient, l as useQuery, O as useMutation, c as Button, S as Plus, m as Card, aZ as CardHeader, a_ as CardTitle, a$ as CardDescription, n as CardContent, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, I as Input, ay as Check } from "./index-C3jhrBt5.js";
import { B as Badge } from "./badge-gr-I6GBe.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-BwpE32y3.js";
import { u as useDirection } from "./index-CtEyi6Ql.js";
...
import { D as Database, a as Clock, C as CircleAlert } from "./database-D-yt_-ll.js";
...
function DataApiPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-5xl mx-auto space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "powerQuery", children: [
        ...
        ["powerQuery", "googleSheets", "python"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: tab, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CopyButton, { text: QUICK_START[tab](exampleKey) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "bg-muted rounded-lg p-4 text-xs overflow-x-auto whitespace-pre-wrap leading-relaxed font-mono pr-10", children: QUICK_START[tab](exampleKey) })
          ] }),
          tab === "googleSheets" && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-2 flex items-start gap-1.5", children: [
