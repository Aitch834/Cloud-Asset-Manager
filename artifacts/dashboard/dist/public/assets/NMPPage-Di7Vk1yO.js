import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, l as useQuery, O as useMutation, j as jsxRuntimeExports, c as Button, S as Plus, A as ArrowRight, o as Link, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, J as DialogFooter } from "./index-fxZRGm6t.js";
import { p as printProReport } from "./print-report-B_FwCCVJ.js";
import { A as AppLayout, I as Info } from "./AppLayout-DGOTUjsH.js";
...
import { L as Leaf } from "./triangle-alert-DUre524v.js";
...
function NMPPage() {
  ...
  const deletePlanMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/nmp-plans/${id}`, { method: "DELETE" }),
    onSuccess: (_data, id) => {
  ...
  const deleteEntryMut = useMutation({
    mutationFn: ({ entryId }) => fetch(`/api/farms/${farmId}/nmp-plans/${expandedPlanId}/field-entries/${entryId}`, { method: "DELETE" }),
    onSuccess: () => {
