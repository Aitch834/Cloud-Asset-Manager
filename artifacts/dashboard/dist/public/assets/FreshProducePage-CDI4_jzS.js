const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-BHqfaBVQ.js","assets/index-LXPEs_eP.js","assets/index-CBkBuZTA.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b3 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-LXPEs_eP.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-M7FqeS6B.js";
import { L as LabSelector } from "./LabSelector-BgTUtcjX.js";
...
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-skIbspia.js";
import { C as ChevronUp } from "./chevron-up-DIkiMB7h.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-C9k4yS84.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-D8w7b3b6.js";
import { T as Textarea } from "./textarea-GiBrF2NL.js";
import { C as ConfirmDialog } from "./confirm-dialog-C3nrrvJy.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-BFdOvATK.js";
import { T as TabBar, a as TabButton } from "./tab-button-vSxEG-SI.js";
import { u as usePersistedTab } from "./use-persisted-tab-DgyK-iWB.js";
import { u as useFarmMembers } from "./use-farm-members-7GVYrqQ8.js";
import { u as useFarmName } from "./use-farm-name-DxDC1i7D.js";
import { S as StaffSelect } from "./staff-select-Bxrlodk1.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { S as ShieldAlert, D as Droplets } from "./shield-alert-CArGQDWe.js";
import { L as LayoutGrid } from "./layout-grid-0ohqL8Ly.js";
import { P as Package } from "./use-safe-clerk-D9pj8SIE.js";
import { T as Thermometer } from "./thermometer-BLyitGAA.js";
import { E as Eye } from "./eye-CyThchYT.js";
import { P as Pencil } from "./pencil-CpMaG9K6.js";
import { A as Archive } from "./archive-DM69K0LP.js";
import "./database-Cvp24-rR.js";
import "./shield-check-DorjTB4x.js";
import "./tractor-CzRvfg4v.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-BHqfaBVQ.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
