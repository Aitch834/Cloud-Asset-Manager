import { b as useAppStore, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, I as Input, U as FlaskConical, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, C as Checkbox, X, N as DialogMutationError, J as DialogFooter, O as React } from "./index-JAHxfA8W.js";
import { u as usePersistedTab } from "./use-persisted-tab-C6h3PSXD.js";
import { u as usePersistedNumberFilter } from "./use-persisted-filter-Ysn7eDOg.js";
...
import { A as AppLayout, k as Stethoscope, c as ClipboardList } from "./AppLayout-21EIJ3FE.js";
import { R as RecordAttachments } from "./RecordAttachments-Bukk1-SG.js";
import { P as Printer } from "./printer-D_J0o4Hx.js";
import { a as Clock, C as CircleAlert } from "./database-B3r8_6jj.js";
...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, C as Cell } from "./generateCategoricalChart-BXhMmDOQ.js";
...
import { E as ExternalLink } from "./external-link-vLn6b6vo.js";
...
function VetLedgerPage() {
  ...
  const [tab, setTab] = usePersistedTab({ page: "vet-ledger", farmId, validIds: ["visits", "invoices", "amrm", "analytics"], defaultTab: "visits" });
  const [amrmYear, setAmrmYear] = usePersistedNumberFilter({ page: "vet-ledger", filter: "amrm-year", farmId, defaultValue: (/* @__PURE__ */ new Date()).getFullYear() });
...
<p class="footer">Vet invoice records should be retained and reconciled against payment records. Printed: ${(/* @__PURE__ */ new Date()).toLocaleDateString("en-GB")}</p>
  ...
  const [pendingDeleteVisit, setPendingDeleteVisit] = reactExports.useState(null);
  const [pendingDeleteInvoice, setPendingDeleteInvoice] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Vet Ledger", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
      ...
      filteredVisits.map((v) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gray-200 rounded-xl p-4 hover:border-gray-300 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0 flex-wrap justify-end", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", title: "Delete", onClick: () => setPendingDeleteVisit(Number(v.id)), className: "h-7 px-2 text-red-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3 h-3" }) })
          ] })
        ] }) }, String(v.id));
      })
    ] }),
      ...
      filteredInvoices.map((inv) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gray-200 rounded-xl p-4 hover:border-gray-300 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", title: "Delete", onClick: () => setPendingDeleteInvoice(Number(inv.id)), className: "h-7 px-2 text-red-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3 h-3" }) })
          ] })
        ] }) }, String(inv.id));
      })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showVisitDialog, onOpenChange: (o) => {
      setShowVisitDialog(o);
      if (!o) visitMut.reset();
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: visitMut, message: "Failed to save — your entries are still here." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showInvoiceDialog, onOpenChange: (o) => {
      setShowInvoiceDialog(o);
      if (!o) invoiceMut.reset();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-3xl max-h-[92vh] overflow-y-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        ...
        onConfirm: () => {
          if (pendingDeleteVisit !== null) delVisitMut.mutate(pendingDeleteVisit, { onSuccess: () => setPendingDeleteVisit(null) });
        },
        onCancel: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        ...
        onConfirm: () => {
          if (pendingDeleteInvoice !== null) delInvoiceMut.mutate(pendingDeleteInvoice, { onSuccess: () => setPendingDeleteInvoice(null) });
        },
        onCancel: () => {
