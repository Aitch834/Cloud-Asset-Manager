const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-D9P4KVWG.js","assets/index-DjcWYp9D.js","assets/index-CNUbH-zj.css"])))=>i.map(i=>d[i]);
import { q as createLucideIcon, b as useAppStore, r as reactExports, _ as __vitePreload, j as jsxRuntimeExports, t as useQueryClient, a as useToast, l as useQuery, O as useMutation, T as FlaskConical, c as Button, S as Plus, K as Map, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, J as DialogFooter, M as MapPin, d as LoaderCircle } from "./index-DjcWYp9D.js";
...
import { A as AppLayout, h as List, S as Sprout, a as Wheat, i as TestTube, e as ChartColumn, N as Navigation } from "./AppLayout-Bs6sYzMT.js";
...
import { A as ArrowUpRight } from "./arrow-up-right-B9i4gnot.js";
...
function TrialMapView({ trials, cropYear }) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-D9P4KVWG.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
