import { s as createLucideIcon, b as useAppStore, a as useToast, c as useQueryClient, m as useQuery, S as useMutation, r as reactExports, j as jsxRuntimeExports, R as Redirect, n as Card, o as CardContent, L as Label, I as Input, M as MapPin, d as Button, e as LoaderCircle, C as Checkbox, X, a5 as ToastAction, B as Building2, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, N as DialogMutationError, J as DialogFooter } from "./index-e6_1Esh9.js";
import { u as useUpload } from "./use-upload-oJdAMnjt.js";
import { A as AppLayout, o as LogOut, j as Truck } from "./AppLayout-RczTWQZu.js";
...
import { C as CreditCard } from "./credit-card-HdAp2tVY.js";
...
function FarmSettings() {
  ...
  const { mutate: updateFarm, isPending: isSaving } = useMutation({
    ...
    onSuccess: (_data, savedFarm) => {
      ...
      const newContactPhone = toUkMobileIntl(String(savedFarm.phone ?? ""));
      const previousContactPhone = toUkMobileIntl(contactPhoneBeforeSaveRef.current);
      const savedSmsPhone = toUkMobileIntl(smsProfile?.phoneNumber);
      if (newContactPhone && newContactPhone !== previousContactPhone && newContactPhone !== savedSmsPhone && smsProfileLoaded) {
        toast({
