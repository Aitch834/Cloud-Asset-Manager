const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-RbbFPbYY.js","assets/index-BnjpV_Ud.js","assets/index-mNSg12Lr.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b5 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-BnjpV_Ud.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-CrtDiJgk.js";
import { L as LabSelector } from "./LabSelector-D_ttKoIZ.js";
import { a as useRawFarmName, b as useFarmName } from "./use-farm-name-DVMJS49x.js";
import { a as printElementReport } from "./print-report-ClU8-1P0.js";
import { P as Printer } from "./printer-CAKjwYHm.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-D1_ei46L.js";
import { B as BarChart } from "./BarChart-B4aiSZdm.js";
import { C as CartesianGrid } from "./CartesianGrid-Cdr7KyZJ.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-CJY4hRK_.js";
import { C as ChevronUp } from "./chevron-up-CFes5sp-.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-Ae4Ay1fe.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-Fa2ZjcyU.js";
...
import { S as ShieldAlert, D as Droplets } from "./shield-alert-DtDMLgAz.js";
import { L as LayoutGrid } from "./layout-grid-B6eexi0b.js";
...
import { A as Archive } from "./archive-DM_MeykT.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-RbbFPbYY.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
