import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, R as Redirect, c as useQueryClient, a as useToast, m as useQuery, S as useMutation, e as LoaderCircle, l as cn, d as Button, T as Plus, n as Card, o as CardContent, b1 as CardHeader, b2 as CardTitle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, N as DialogMutationError, J as DialogFooter, X, p as Link } from "./index-DaWtA8cs.js";
import { u as useUpload } from "./use-upload-D6jOCzkt.js";
import { Q as QRCodeSVG } from "./index-BTTQQ2ub.js";
import { R as RaiseTaskDialog } from "./RaiseTaskDialog-DGsDqQIQ.js";
import { A as AppLayout, U as Users, O as Settings, c as ClipboardList, I as Info, d as Wrench } from "./AppLayout-Dl_MNypY.js";
import { T as Textarea } from "./textarea-Clf58F2j.js";
import { C as ConfirmDialog } from "./confirm-dialog-DhuoscLA.js";
...
import { O as OtherSelect } from "./other-select-BnsIYo3U.js";
...
import { S as StaffSelect } from "./staff-select-DzDnikUu.js";
import { u as useFarmMembers, m as memberFullName } from "./use-farm-members-DnKKB6CK.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { P as Package } from "./use-safe-clerk-BZ3dURNB.js";
import { P as Pencil } from "./pencil-CcmMJwOQ.js";
import { T as Trash2, C as ChevronDown } from "./trash-2-l5xiZtrG.js";
import { R as Receipt } from "./receipt-DPuNbcoH.js";
import { P as Printer } from "./printer-yXEP2Qhh.js";
import { a as Clock } from "./database-8QliO_KP.js";
import { A as ArrowUpFromLine, a as ArrowDownToLine } from "./arrow-up-from-line-P-3VtrvK.js";
import { T as TriangleAlert } from "./triangle-alert-ClQ-IHyq.js";
import { C as CircleCheck } from "./circle-check-Drf6TRG8.js";
import { H as History } from "./history-BlzYnRxe.js";
import { Q as QrCode } from "./qr-code-VT3vh_v9.js";
import { S as Search } from "./search-OqjKdu7Z.js";
import { C as ChevronRight } from "./tractor-CFYM5rpU.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, a as LabelList, C as Cell, L as Legend } from "./generateCategoricalChart-Du3IzP5N.js";
...
import { C as ComposedChart } from "./ComposedChart-CgdBnL3T.js";
import { L as Line } from "./Line-Do2J7XBT.js";
import { E as EyeOff } from "./eye-off-DpjRNnpB.js";
import { E as Eye } from "./eye-CemP8cqC.js";
import { F as FileText } from "./shield-alert-CETkZOyO.js";
...
function JobDocumentsSection({ farmId, jobId }) {
  ...
  const { data: docs = [], isLoading: docsLoading } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${jobId}/documents`), { credentials: "include" }).then((r) => r.json())
  });
  const deleteDoc = useMutation({
    mutationFn: (docId) => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${jobId}/documents/${docId}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
  ...
  const saveDocMeta = useMutation({
    mutationFn: (body) => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${jobId}/documents`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function JobCardsTab({ farmId, openId, initialStatus }) {
  ...
  const { data: equipData } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/equipment`), { credentials: "include" }).then((r) => r.json())
  });
  const { data, isLoading } = useQuery({
    queryKey: ["workshop-jobs", farmId],
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/jobs`), { credentials: "include" }).then((r) => r.json())
  });
  reactExports.useEffect(() => {
  ...
  const { data: workshopParts = [] } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/parts`), { credentials: "include" }).then((r) => r.json()),
    enabled: open && !!editing
  });
  const { data: issuedParts = [] } = useQuery({
    queryKey: ["job-issued-parts", editing?.id],
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${editing.id}/parts`), { credentials: "include" }).then((r) => r.json()),
    enabled: open && !!editing?.id
  });
  const { data: customersData } = useQuery({
    queryKey: ["farm-customers", farmId],
    queryFn: () => fetch(apiUrl(`farms/${farmId}/farm-customers`), { credentials: "include" }).then((r) => r.json())
  });
  ...
  const { data: workshopSettings } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/settings`), { credentials: "include" }).then((r) => r.json())
  });
  ...
  const { data: labourEntries = [] } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${editing.id}/labour`), { credentials: "include" }).then((r) => r.json()),
    enabled: open && !!editing?.id
  });
  const raiseInvoice = useMutation({
    mutationFn: (jobId) => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${jobId}/raise-invoice`), {
      method: "POST",
      credentials: "include"
    }).then(async (r) => {
      if (!r.ok) {
  ...
  const issuePartsToJob = useMutation({
    mutationFn: () => fetch(apiUrl(`farms/${farmId}/workshop/parts/use`), {
      method: "POST",
      credentials: "include",
  ...
  const addLabourEntry = useMutation({
    mutationFn: (entry) => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${editing.id}/labour`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(entry) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteLabourEntry = useMutation({
    mutationFn: (entryId) => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${editing.id}/labour/${entryId}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const saveWorkshopSettings = useMutation({
    mutationFn: (s) => fetch(apiUrl(`farms/${farmId}/workshop/settings`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(s) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const save = useMutation({
    mutationFn: async (body) => {
      ...
      if (editing) {
        await fetch(apiUrl(`farms/${farmId}/workshop/jobs/${editing.id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(cleanBody) }).then(async (r) => {
          if (!r.ok) {
            const t = await r.text().catch(() => "");
            throw new Error(t || `Request failed (${r.status})`);
          }
        ...
        for (const e of pendingLabourEntries) {
          await fetch(apiUrl(`farms/${farmId}/workshop/jobs/${editing.id}/labour`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ entryDate: e.date, description: e.description, chargeUnits: e.chargeUnits, ratePence: e.ratePence }) }).then(async (r) => {
            if (!r.ok) {
              const t = await r.text().catch(() => "");
              throw new Error(t || `Request failed (${r.status})`);
            }
        ...
        const res = await fetch(apiUrl(`farms/${farmId}/workshop/jobs`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(cleanBody) }).then(async (r) => {
          if (!r.ok) {
            const t = await r.text().catch(() => "");
            throw new Error(t || `Request failed (${r.status})`);
          }
        ...
        if (newJob?.id && pendingLabourEntries.length > 0) {
          for (const e of pendingLabourEntries) {
            await fetch(apiUrl(`farms/${farmId}/workshop/jobs/${newJob.id}/labour`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ entryDate: e.date, description: e.description, chargeUnits: e.chargeUnits, ratePence: e.ratePence }) }).then(async (r) => {
              if (!r.ok) {
                const t = await r.text().catch(() => "");
                throw new Error(t || `Request failed (${r.status})`);
              }
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/workshop/jobs/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: settingsOpen, onOpenChange: (o) => {
      setSettingsOpen(o);
      if (!o) saveWorkshopSettings.reset();
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: saveWorkshopSettings, message: "Failed to save — your entries are still here." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o) => {
      setOpen(o);
      if (!o) save.reset();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "68rem" }, className: "flex flex-col p-0 gap-0 max-h-[92vh]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pt-3 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: save, message: "Failed to save — your entries are still here." }) }),
...
function ServiceScheduleTab({ farmId }) {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/schedule`), { credentials: "include" }).then((r) => r.json())
  });
  ...
  const logMut = useMutation({
    mutationFn: ({ equipmentId, body }) => fetch(apiUrl(`farms/${farmId}/equipment/${equipmentId}/maintenance`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!logEntry, onOpenChange: (o) => {
      if (!o) {
        setLogEntry(null);
        logMut.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: logMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
...
function GoodsReturnsView({ farmId, parts, staffNames, membersLoading }) {
  ...
  const { data: returns = [], isLoading } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/returns`), { credentials: "include" }).then((r) => r.json())
  });
  const { data: suppliers = [] } = useQuery({
    queryKey: ["suppliers-list", farmId],
    queryFn: () => fetch(apiUrl(`farms/${farmId}/suppliers`), { credentials: "include" }).then((r) => r.json().then((d) => d.records ?? []))
  });
  const createReturn = useMutation({
    mutationFn: (body) => fetch(apiUrl(`farms/${farmId}/workshop/returns`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateReturn = useMutation({
    mutationFn: ({ id, body }) => fetch(apiUrl(`farms/${farmId}/workshop/returns/${id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteReturn = useMutation({
    mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/workshop/returns/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: newOpen, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: createReturn, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!editReturn, onOpenChange: (open) => {
      ...
      editReturn && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: updateReturn, message: "Failed to save — your entries are still here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
...
function LocationManager({ farmId, onClose }) {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/rows`), { credentials: "include" }).then((r) => r.json())
  });
  const lmRows = data?.rows ?? [];
  const unassignedBays = data?.unassignedBays ?? [];
  const createRow = useMutation({ mutationFn: (b) => fetch(apiUrl(`farms/${farmId}/workshop/rows`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const updateRow = useMutation({ mutationFn: ({ id, ...b }) => fetch(apiUrl(`farms/${farmId}/workshop/rows/${id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const deleteRow = useMutation({ mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/workshop/rows/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
    return r;
  }).then((r) => r.json()), onSuccess: inv, onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
  const createBay = useMutation({ mutationFn: (b) => fetch(apiUrl(`farms/${farmId}/workshop/bays`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
    return r;
  }).then((r) => r.json()), onSuccess: (_d, vars) => {
    inv();
    const k = vars.rowId ? `r-${vars.rowId}` : "unassigned";
    setBayFormByRow((f) => ({ ...f, [k]: { name: "", description: "" } }));
  }, onError: () => toast({ title: "Save failed", variant: "destructive" }) });
  const updateBay = useMutation({ mutationFn: ({ id, ...b }) => fetch(apiUrl(`farms/${farmId}/workshop/bays/${id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const deleteBay = useMutation({ mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/workshop/bays/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const createShelf = useMutation({ mutationFn: ({ bayId, name, capacity }) => fetch(apiUrl(`farms/${farmId}/workshop/bays/${bayId}/shelves`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, capacity: capacity || null }) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const updateShelf = useMutation({ mutationFn: ({ id, ...b }) => fetch(apiUrl(`farms/${farmId}/workshop/shelves/${id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const deleteShelf = useMutation({ mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/workshop/shelves/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
...
function PartPanel({ farmId, part, onClose, onEdit }) {
  ...
  const { data: docs = [], isLoading: docsLoading } = useQuery({
    ...
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/parts/${part.id}/documents`), { credentials: "include" }).then((r) => r.json())
  });
  const deleteDoc = useMutation({
    mutationFn: (docId) => fetch(apiUrl(`farms/${farmId}/workshop/parts/${part.id}/documents/${docId}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const saveDocMeta = useMutation({
    mutationFn: (body) => fetch(apiUrl(`farms/${farmId}/workshop/parts/${part.id}/documents`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function PartsStoreTab({ farmId }) {
  ...
  const { data: parts = [], isLoading } = useQuery({ queryKey: ["workshop-parts", farmId], queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/parts`), { credentials: "include" }).then((r) => r.json()) });
  const { data: bays = [] } = useQuery({ queryKey: ["workshop-bays", farmId], queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/bays`), { credentials: "include" }).then((r) => r.json()) });
  const { data: rowsData } = useQuery({ queryKey: ["workshop-rows", farmId], queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/rows`), { credentials: "include" }).then((r) => r.json()) });
  const rows = rowsData?.rows ?? [];
  const hasUnassignedBays = (rowsData?.unassignedBays ?? []).length > 0;
  const { data: movements = [] } = useQuery({ queryKey: ["workshop-parts-movements", farmId], queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/parts/movements`), { credentials: "include" }).then((r) => r.json()), enabled: view === "history" });
  const { data: jobsData } = useQuery({ queryKey: ["workshop-jobs", farmId], queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/jobs`), { credentials: "include" }).then((r) => r.json()) });
  const { data: suppliersData } = useQuery({ queryKey: ["suppliers-list", farmId], queryFn: () => fetch(apiUrl(`farms/${farmId}/suppliers`), { credentials: "include" }).then((r) => {
    if (!r.ok) return [];
  ...
  const savePart = useMutation({
    mutationFn: async (body) => {
      ...
      const url = editing ? apiUrl(`farms/${farmId}/workshop/parts/${editing.id}`) : apiUrl(`farms/${farmId}/workshop/parts`);
  ...
  const deletePart = useMutation({
    mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/workshop/parts/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const useParts = useMutation({
    mutationFn: (body) => fetch(apiUrl(`farms/${farmId}/workshop/parts/use`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ stockItemId: usePart?.id, quantity: body.qty, jobId: body.jobId || null, performedBy: body.performedBy, notes: body.notes }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function CustomersTab({ farmId, onViewJobs }) {
  ...
  const saveMut = useMutation({
    mutationFn: (body) => {
      if (editRecord) {
        return fetch(apiUrl(`farms/${farmId}/farm-customers/${editRecord.id}`), { method: "PUT", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
          if (!r.ok) {
            const t = await r.text().catch(() => "");
            throw new Error(t || `Request failed (${r.status})`);
          }
      ...
      return fetch(apiUrl(`farms/${farmId}/farm-customers`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
        if (!r.ok) {
          const t = await r.text().catch(() => "");
          throw new Error(t || `Request failed (${r.status})`);
        }
  ...
  const deactivateMut = useMutation({
    mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/farm-customers/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const reactivateMut = useMutation({
    mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/farm-customers/${id}`), { method: "PUT", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ isActive: true }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
const WORKSHOP_TAB_IDS = ["jobs", "schedule", "overview", "parts", "analytics", "customers"];
function WorkshopPage() {
  const { farmId } = useAppStore();
  const [tab, setTab] = usePersistedTab({ page: "workshop", farmId, validIds: WORKSHOP_TAB_IDS, defaultTab: "jobs", urlOverride: new URLSearchParams(window.location.search).get("tab") });
  const openId = (() => {
...
function WorkshopStocktakeView({ farmId }) {
  ...
  const [confirmState, setConfirmState] = reactExports.useState({ open: false, title: "", message: "", run: () => {
  } });
  const closeConfirm = () => {
    confirmState.mutation?.reset();
    setConfirmState((s) => ({ ...s, open: false }));
  };
  const showConfirm = (title, message, run, opts) => setConfirmState({ open: true, title, message, run, ...opts });
  const { data: sessions = [], isLoading: sessionsLoading } = useQuery({
    queryKey: ["workshop-stocktakes", farmId],
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/stocktakes`), { credentials: "include" }).then((r) => r.json())
  });
  const { data: activeSession } = useQuery({
    queryKey: ["workshop-stocktake-detail", farmId, activeId],
    queryFn: () => fetch(apiUrl(`farms/${farmId}/workshop/stocktakes/${activeId}`), { credentials: "include" }).then((r) => r.json()),
    enabled: activeId !== null
  });
  const createMut = useMutation({
    mutationFn: (body) => fetch(apiUrl(`farms/${farmId}/workshop/stocktakes`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateItemMut = useMutation({
    mutationFn: ({ sessionId, itemId, countedQty }) => fetch(apiUrl(`farms/${farmId}/workshop/stocktakes/${sessionId}/items/${itemId}`), { method: "PATCH", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ countedQty }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const completeMut = useMutation({
    mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/workshop/stocktakes/${id}/complete`), { method: "POST", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(apiUrl(`farms/${farmId}/workshop/stocktakes/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
            ...
            activeSession.status === "draft" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  onClick: () => showConfirm("Complete Stocktake", "Workshop part stock levels will be updated to match your physical counts. This cannot be undone.", (onSuccess) => completeMut.mutate(activeSession.id, { onSuccess }), { mutation: completeMut, confirmLabel: "Complete Stocktake" }),
                  children: [
