import { b as useAppStore, K as Map, A as ArrowRight, U as FlaskConical, r as reactExports, m as useQuery, j as jsxRuntimeExports, e as LoaderCircle, n as Card, c as useQueryClient, a as useToast, S as useMutation, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, N as DialogMutationError, J as DialogFooter, H as DialogDescription } from "./index-Dnqxw-hJ.js";
import { a as usePersistedFilter } from "./use-persisted-filter-UKx7CUdy.js";
import { e as ChartColumn, c as ClipboardList, S as Sprout, Y as Scissors, $ as Grape, r as Bug, G as Gauge, d as Wrench, B as BookOpen, T as TrendingUp, A as AppLayout } from "./AppLayout-BVlSEslh.js";
...
import { W as Wine, B as Beaker, D as Droplet, a as WINERY_VIEW_ADDITIONS_EVENT, b as BatchTrailQuickSearch, g as WineProductionTab, h as WineryStockTab, i as HarvestReceptionTab, j as PressingRecordsTab, k as FermentationRecordsTab, l as VesselRegisterTab, C as CellarOpsTab, m as BottlingRecordsTab, n as So2TestingTab, o as EquipmentRegisterTab, O as OverviewTab, V as VineRegisterTab, c as BlocksTab, d as VineyardBlockMapTab, P as PhenologyTab, e as WinegbSurveysTab, f as OperationsTab, H as HarvestTab, S as ScoutingTab, G as GiComplianceTab, L as LicensingTab, E as ExciseDutyTab, T as TastingsToursTab, A as AgeVerificationTab, p as SprayDiaryTab, q as SoilAnalysisTab, r as ViticulturalAnalyticsTab, s as VintageSeasonReportTab, t as ViticulturalEnterpriseReport } from "./WinegbSurveysTab-0A5obg4B.js";
...
import { L as Leaf } from "./triangle-alert-DjRooww3.js";
import { G as Globe } from "./globe-XBXz2cMB.js";
import { R as Receipt } from "./receipt-C3BIwkJk.js";
import { C as CalendarCheck } from "./tooltip-B93GWBic.js";
...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar } from "./generateCategoricalChart-DcVfSyy7.js";
...
import "./eye-Bn13R6Dr.js";
import "./circle-x-BUT-FirH.js";
import "./circle-check-Dw47ojQU.js";
import "./use-farm-name-CGEtSnQ6.js";
import "./badge-h1abHgPF.js";
import "./popover-DLu4Lsbl.js";
import "./index-cMuIvfhy.js";
import "./link-XfhvS3n7.js";
import "./printer-DeEIYxKW.js";
import "./mail-rpgNXJ9g.js";
import "./camera-DWJFyYbK.js";
import "./arrow-left-right-EKYQ0FeO.js";
import "./external-link-pdYB5P6Y.js";
import "./core.esm-DD9dvGvb.js";
import "./star-BqFEdhn2.js";
import "./useQueries-DuyvHrf4.js";
import "./chevron-left-CWV4q5Ts.js";
import "./dropdown-menu-CMqjcOOs.js";
import "./index-NROoFvOE.js";
import "./index-CPawrMGG.js";
import "./circle-BJFOpz52.js";
import "./ComposedChart-DnauE57q.js";
import "./Area-Dqf0Wyak.js";
import "./Line-CobHSJWt.js";
import "./arrow-up-down-D9MJPFrn.js";
import "./arrow-up-CdIA9Fji.js";
import "./print-labels-CwYLfq2l.js";
import "./browser-BBCpX_QU.js";
import "./print-report-ClU8-1P0.js";
import "./use-farm-members-lo5NHpGa.js";
import "./user-check-CDwS0rMs.js";
import "./YearCompareSelector-Cc0FjRYY.js";
import "./AnalyticsChartCard-DKNKqgLx.js";
import "./LineChart-C2NTTZl1.js";
import "./search-jGMJ9VPt.js";
import "./bottling-csv-BeHtHDhe.js";
import "./pen-line-CKsAGO92.js";
import "./tabs-CivRWfhO.js";
import "./git-branch-BAI4wRHO.js";
import "./typeof-WJl3ipnu.js";
import "./history-Bu2ArzJe.js";
function fmt(val) {
  if (!val) return "—";
  return val;
}
...
function BlockConversionTab({ farmId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!deleting, onOpenChange: () => {
      setDeleting(null);
...
function InputLogTab({ farmId, blocks }) {
  ...
  const [deleting, setDeleting] = reactExports.useState(null);
  const [form, setForm] = reactExports.useState({});
  const [yearFilter, setYearFilter] = usePersistedFilter({ page: "organic-vit-input-log", filter: "year", farmId, defaultValue: String((/* @__PURE__ */ new Date()).getFullYear()) });
...
function InputDerogationsTab({ farmId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!deletingCorr, onOpenChange: () => {
      setDeletingCorr(null);
      deleteCorr.reset();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteCorr, message: "Failed to delete — please try again." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
...
function OrganicViticulturePage() {
  ...
  if (!hasOrganicVit) return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-64 gap-3 text-center px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Grape, { className: "h-10 w-10 text-purple-200" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-gray-800", children: "Organic Viticulture module not active" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-sm", children: "This farm doesn't have the Organic Viticulture module enabled. Contact your account manager to add it to your subscription." })
  ] }) });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6", children: [
      ...
      tab === "vit-overview" && /* @__PURE__ */ jsxRuntimeExports.jsx(OverviewTab, { farmId, onNavigate: (toTab) => setTab(toTab) }),
      ...
      tab === "phenology" && /* @__PURE__ */ jsxRuntimeExports.jsx(PhenologyTab, { farmId, blocks: vineyardBlocks, onNavigate: (toTab) => setTab(toTab) }),
      tab === "winegb-surveys" && /* @__PURE__ */ jsxRuntimeExports.jsx(WinegbSurveysTab, { farmId, blocks: vineyardBlocks }),
