import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, R as Redirect, t as useQueryClient, a as useToast, l as useQuery, O as useMutation, d as LoaderCircle, k as cn, c as Button, S as Plus, m as Card, n as CardContent, aZ as CardHeader, a_ as CardTitle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, J as DialogFooter, $ as X, o as Link } from "./index-DZ3-mP8N.js";
...
import { A as AppLayout, U as Users, M as Settings, c as ClipboardList, I as Info, d as Wrench } from "./AppLayout-D1dNxWO5.js";
import { T as Textarea } from "./textarea-D_ESgzHv.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, e as SelectGroup, f as SelectLabel } from "./select-BB2KJgpK.js";
import { O as OtherSelect } from "./other-select-DEu3qqyP.js";
...
import { A as ArrowUpFromLine, a as ArrowDownToLine } from "./arrow-up-from-line-Da1QswOJ.js";
...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, a as LabelList, C as Cell, L as Legend } from "./generateCategoricalChart-24XzhbV8.js";
...
function LocationManager({ farmId, onClose }) {
  ...
  const deleteRow = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/rows/${id}`), { method: "DELETE", credentials: "include" }).then((r) => r.json()), onSuccess: inv });
  ...
  const deleteBay = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/bays/${id}`), { method: "DELETE", credentials: "include" }).then((r) => r.json()), onSuccess: inv });
  ...
  const deleteShelf = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/shelves/${id}`), { method: "DELETE", credentials: "include" }).then((r) => r.json()), onSuccess: inv });
