import { s as createLucideIcon, b as useAppStore, j as jsxRuntimeExports, R as Redirect, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, l as cn, aO as toast, X, T as Plus, n as Card, u as useLocation } from "./index-CTNdWNpd.js";
import { A as AppLayout, d as Wrench, j as Truck, C as CalendarDays, c as ClipboardList, R as RotateCcw } from "./AppLayout-UnB4Z3KW.js";
import { u as usePersistedTab } from "./use-persisted-tab-CAaTkOSk.js";
import { u as useSensors, a as useSensor, D as DndContext, b as DragOverlay, G as GripVertical, P as PointerSensor, c as useDroppable, d as useDraggable } from "./core.esm-Bft54MGv.js";
...
function PlanningStatusTab({ farmId }) {
  ...
  const markMilestoneMut = useMutation({
    mutationFn: ({ id, projectId, status }) => fetch(`/api/farms/${farmId}/agri-env-projects/${projectId}/milestones/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: status === "completed" ? JSON.stringify({ status, completionDate: isoDate(/* @__PURE__ */ new Date()) }) : JSON.stringify({ status })
    }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          className: cn(
            ...
            overdueMilestones.length > 0 ? "bg-red-50 border-red-300 text-red-700" : "bg-green-50 border-green-200 text-green-700"
          ),
          children: [
            overdueMilestones.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 flex-shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeCheck, { className: "w-4 h-4 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold leading-none", children: overdueMilestones.length }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs opacity-80 mt-0.5", children: overdueMilestones.length > 0 ? "Overdue milestones" : "No overdue milestones" })
            ] })
          ]
        }
      )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "overflow-hidden", children: pastMilestones.map((m) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex items-center gap-3 px-4 py-3 border-b border-border last:border-0", isOverdue ? "bg-red-50/40" : "opacity-60"), children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 flex items-center gap-1.5", children: [
              ...
              m.status === "completed" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
