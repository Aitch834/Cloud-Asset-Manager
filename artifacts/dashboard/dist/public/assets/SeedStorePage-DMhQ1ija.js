import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, O as useMutation, l as useQuery, j as jsxRuntimeExports, I as Input, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, L as Label, d as LoaderCircle, k as cn, $ as X, o as Link } from "./index-DKBMd7uR.js";
import { A as AppLayout, s as AlertDialog, t as AlertDialogContent, v as AlertDialogHeader, w as AlertDialogTitle, x as AlertDialogDescription, y as AlertDialogFooter, z as AlertDialogCancel, D as AlertDialogAction, c as ClipboardList, T as TrendingUp } from "./AppLayout-BPk5oW6I.js";
import { u as useCrops } from "./use-crops--bTG88iE.js";
...
import { a as Clock, C as CircleAlert } from "./database-Cx2fOA1x.js";
...
import { I as Image } from "./image-C9eIT312.js";
...
function SeedStorePage() {
  ...
  const [tab, setTab] = reactExports.useState(() => {
    ...
    const t = p.get("tab");
    return ["orders", "segregation", "allocation", "stocktakes"].includes(t) ? t : "stock";
  });
  ...
  const [poFilter, setPoFilter] = reactExports.useState("active");
  ...
  const [allocCropFilter, setAllocCropFilter] = reactExports.useState("all");
  const [allocStatusFilter, setAllocStatusFilter] = reactExports.useState("all");
  ...
  const assignMut = useMutation({
    mutationFn: ({ fieldId, varietyId, seedBatchId, bagsAllocated, plantingDate }) => fetch(`/api/farms/${safeFarmId}/field-crops`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ fieldId, varietyId, seedBatchId, bagsAllocated: bagsAllocated || null, plantingDate: plantingDate || null }) }).then((r) => r.json()),
    onSuccess: (data) => {
      if (data.error) {
  ...
  const editAllocMut = useMutation({
    mutationFn: ({ id, bagsAllocated, plantingDate }) => fetch(`/api/farms/${safeFarmId}/field-crops/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ bagsAllocated: bagsAllocated || null, plantingDate: plantingDate || null }) }).then((r) => r.json()),
    onSuccess: (data) => {
      if (data.error) {
        toast({ title: data.error, variant: "destructive" });
        return;
  ...
  const stocktakeMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${safeFarmId}/seed-stocktakes`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (data) => {
      if (data.error) {
        toast({ title: data.error, variant: "destructive" });
        return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Seed Store", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1200, margin: "0 auto" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-shrink-0", children: [
            ...
            !isCancelled && !isReceived && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => {
                  if (confirm("Cancel this seed order?")) cancelPoMut.mutate(Number(po.id));
                },
                children: "Cancel"
              }
            ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteSegTarget, onOpenChange: (v) => !v && setDeleteSegTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showPoDialog, onOpenChange: (v) => !v && setShowPoDialog(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: receivePoId !== null, onOpenChange: (v) => !v && setReceivePoId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deletePoTarget, onOpenChange: (v) => !v && setDeletePoTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
    ...
    tab === "allocation" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!assignBatch, onOpenChange: (v) => !v && setAssignBatch(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!editAlloc, onOpenChange: (v) => !v && setEditAlloc(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
    ...
    tab === "stocktakes" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showStocktakeDialog, onOpenChange: (v) => !v && setShowStocktakeDialog(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
