const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-2JxX_uMq.js","assets/index-CRhl5RZ9.js","assets/index-CAOhs4IG.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, n as Card, o as CardContent, c as useQueryClient, a as useToast, O as useMutation, S as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, X as DialogMutationError, K as Map } from "./index-CRhl5RZ9.js";
import { L as LabSelector } from "./LabSelector-DKy4BCqb.js";
import { P as Printer } from "./printer-DYvRGEAP.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-BlOFl9Ie.js";
import { B as BarChart } from "./BarChart-Bjis8eqT.js";
import { C as CartesianGrid } from "./CartesianGrid-p8pReHsj.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-DiV1AVVt.js";
import { C as ChevronUp } from "./chevron-up-D7a2fqn6.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-epba5DSH.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-D6odzsLF.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-2JxX_uMq.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
