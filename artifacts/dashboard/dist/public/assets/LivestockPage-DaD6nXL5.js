...
import { o as openPrintWindow, p as printProReport } from "./print-report-AgLhkaBL.js";
...
import { e as ChartColumn, A as AppLayout, c as ClipboardList, j as Truck, k as Stethoscope } from "./AppLayout-CHbvi0yr.js";
...
import { C as ClipboardCheck, D as Droplets, F as FileText } from "./shield-alert-Cc1THD4u.js";
...
import "./RaiseTaskDialog-CUS6ja4g.js";
import "./list-checks-Cd-K2AXE.js";
import "./database-Ol9i5YPr.js";
import "./LabSelector-sX8TguA9.js";
import "./index-hABiLU0m.js";
import "./qr-code-JaF3P6wt.js";
import "./syringe--KiMq_Ih.js";
...
function SheepDippingSection({ farmId, farmName }) {
  const qc = useQueryClient();
  const { toast } = useToast();
...
function LivestockPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Herds & Animals", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ErrorBoundary, { children: [
      ...
      tab === "tb-tests" && /* @__PURE__ */ jsxRuntimeExports.jsx(TbTestsSection, { farmId, farmName }),
      tab === "welfare-outcomes" && /* @__PURE__ */ jsxRuntimeExports.jsx(WelfareOutcomeSection, { farmId, farmName }),
      tab === "sheep-dipping" && /* @__PURE__ */ jsxRuntimeExports.jsx(SheepDippingSection, { farmId, farmName }),
