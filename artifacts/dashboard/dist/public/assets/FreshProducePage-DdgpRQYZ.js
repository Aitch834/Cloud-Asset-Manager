const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-BZSIGoll.js","assets/index-DImoRxln.js","assets/index-Dg4iJCjm.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b3 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-DImoRxln.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-uyfhpBFC.js";
import { L as LabSelector } from "./LabSelector-2c7T8J9E.js";
import { P as Printer } from "./printer-piYi4efU.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-DKLEOnP6.js";
import { B as BarChart } from "./BarChart-CSKw7dgr.js";
import { C as CartesianGrid } from "./CartesianGrid-BZT32TCw.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-CSlEeB1L.js";
import { C as ChevronUp } from "./chevron-up-ByowxTBf.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-Br3Vg5k2.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-3zwW38j4.js";
...
import { u as useFarmMembers } from "./use-farm-members-CEgtywSs.js";
import { u as useFarmName } from "./use-farm-name-DWIV8MwY.js";
import { S as StaffSelect } from "./staff-select-BzHV65H1.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { S as ShieldAlert, D as Droplets } from "./shield-alert-jNystpln.js";
import { L as LayoutGrid } from "./layout-grid-CDDqb3ga.js";
import { P as Package } from "./use-safe-clerk-D_3ZxoO7.js";
import { T as Thermometer } from "./thermometer-DNbx15cO.js";
import { E as Eye } from "./eye-CY1z-5lU.js";
import { P as Pencil } from "./pencil-DXl7u_bz.js";
import { A as Archive } from "./archive-CVkhAqjA.js";
import "./database-D57eqhDv.js";
import "./shield-check-zzaCF1Ns.js";
import "./tractor-CEPpvvZh.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-BZSIGoll.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
