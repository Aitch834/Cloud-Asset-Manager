import { r as reactExports, j as jsxRuntimeExports, I as Input, c as Button, b as useAppStore, l as useQuery, R as Redirect, t as useQueryClient, a as useToast, O as useMutation, S as Plus, d as LoaderCircle, m as Card, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, Q as React, $ as X, L as Label, o as Link, T as FlaskConical } from "./index-D3ay9Ao3.js";
...
import { A as AppLayout, U as Users, r as Bug, c as ClipboardList } from "./AppLayout-DRFFu3V0.js";
...
import { H as HardHat } from "./hard-hat-k-RQS8nQ.js";
...
function VisitorTab({ farmId, farmName }) {
  ...
  const createM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/visitors`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/visitors/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["visitors", farmId] });
      qc.invalidateQueries({ queryKey: ["notifications", farmId] });
      setFormOpen(false);
  ...
  const deleteM = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/visitors/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["visitors", farmId] });
      setDeleteId(null);
    },
...
function PestPhotoPanel({ recordId, farmId, photos }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (photoId) => fetch(`/api/farms/${farmId}/pest-control/${recordId}/photos/${photoId}`, { method: "DELETE" }),
...
function PestControlTab({ farmId, farmName }) {
  ...
  const createM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/pest-control`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["pest-control", farmId] });
      setFormOpen(false);
      setEditing(null);
  ...
  const updateM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/pest-control/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["pest-control", farmId] });
      setFormOpen(false);
      setEditing(null);
  ...
  const deleteM = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/pest-control/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["pest-control", farmId] });
      setDeleteId(null);
    },
...
function CleaningTab({ farmId, farmName }) {
  ...
  const createM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/cleaning`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/cleaning/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["cleaning", farmId] });
      resetCleaningDialog();
    },
  ...
  const deleteM = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/cleaning/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["cleaning", farmId] });
      setDeleteId(null);
    },
  ...
  const createScheduleM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/cleaning-schedules`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateScheduleM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/cleaning-schedules/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["cleaning-schedules", farmId] });
      setScheduleOpen(false);
      setEditingSchedule(null);
  ...
  const deleteScheduleM = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/cleaning-schedules/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["cleaning-schedules", farmId] });
...
function CoshhTab({ farmId, farmName }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/coshh`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/coshh/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Deleted" });
      invalidate();
      setDeleteId(null);
...
function BiosecurityPage({ defaultTab = "visitors" }) {
  ...
  const [tab, setTab] = reactExports.useState(() => {
    ...
    const t = p.get("tab");
    const valid = ["visitors", "pest-control", "cleaning", "coshh", "biosecurity-plan"];
    return t && valid.includes(t) ? t : defaultTab;
  });
