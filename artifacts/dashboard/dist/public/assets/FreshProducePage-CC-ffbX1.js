const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-BCspfn4z.js","assets/index-DBJfsKIv.js","assets/index-CNUbH-zj.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, c as Button, l as useQuery, R as Redirect, m as Card, n as CardContent, t as useQueryClient, a as useToast, O as useMutation, S as Plus, d as LoaderCircle, L as Label, I as Input, C as Checkbox, K as Map } from "./index-DBJfsKIv.js";
import { L as LabSelector } from "./LabSelector-JQNzBfsU.js";
...
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-DKqStBQA.js";
...
import { L as LayoutGrid } from "./layout-grid-CHlTM4aA.js";
...
import { A as Archive } from "./archive-HqRrKMMS.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-BCspfn4z.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
