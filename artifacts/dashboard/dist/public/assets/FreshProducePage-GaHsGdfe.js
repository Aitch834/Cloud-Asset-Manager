const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-B20G4lni.js","assets/index-BEkyPlmL.js","assets/index-BmRI0CcT.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b4 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-BEkyPlmL.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-DcqVQ-QG.js";
import { L as LabSelector } from "./LabSelector-C1ZM_XA8.js";
import { a as useRawFarmName, b as useFarmName } from "./use-farm-name-Chkasyfa.js";
import { a as printElementReport } from "./print-report-ClU8-1P0.js";
import { P as Printer } from "./printer-Bb32NinY.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-Di9DKdj-.js";
import { B as BarChart } from "./BarChart-DXMuVMkp.js";
import { C as CartesianGrid } from "./CartesianGrid-ayhjxU9j.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-Dy8DCGTJ.js";
import { C as ChevronUp } from "./chevron-up-30pGGBXl.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-BMT5nMUO.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-Dg7puaaH.js";
import { T as Textarea } from "./textarea-D-f2kdJL.js";
import { C as ConfirmDialog } from "./confirm-dialog-Ba7sbclA.js";
...
import { u as useFarmMembers } from "./use-farm-members-DR4N1gp3.js";
import { S as StaffSelect } from "./staff-select-BHks39BX.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { S as ShieldAlert, D as Droplets } from "./shield-alert-Crl64Cqn.js";
import { L as LayoutGrid } from "./layout-grid-COjiCejV.js";
import { P as Package } from "./use-safe-clerk-DvzsJU13.js";
import { T as Thermometer } from "./thermometer-Btir7xwL.js";
import { E as Eye } from "./eye-CbK_lx6q.js";
import { P as Pencil } from "./pencil-BFndKbvT.js";
import { A as Archive } from "./archive-CmT5Uwbe.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-B20G4lni.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
