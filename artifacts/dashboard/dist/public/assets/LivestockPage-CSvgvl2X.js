...
import { R as RecordAttachments } from "./RecordAttachments-TYWca7Mw.js";
import { o as openPrintWindow, p as printProReport } from "./print-report-B_FwCCVJ.js";
import { F as FileDown } from "./file-down-5q5ZyP64.js";
import { P as Paperclip } from "./paperclip-XJfWVVBe.js";
...
import { e as ChartColumn, A as AppLayout, c as ClipboardList, j as Truck, k as Stethoscope } from "./AppLayout-Cd3p4pui.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, C as Cell } from "./generateCategoricalChart-NdsfRrIZ.js";
...
import { C as ClipboardCheck, D as Droplets, F as FileText } from "./shield-alert-613BeFwq.js";
...
import "./use-lookup-Briy86XG.js";
import "./search-DYvQU_aa.js";
import "./upload-CP4xUUZa.js";
import "./RaiseTaskDialog-BO0SKwiW.js";
import "./database-Bsc-mGJk.js";
import "./circle-x-d2iuwvGY.js";
import "./LabSelector-CzGts0-Z.js";
import "./index-w2PMlJAG.js";
import "./syringe-Cy_6Z2ro.js";
import "./index-BbUxYHyD.js";
import "./index-Bntpiimv.js";
import "./image-Cqw6Y-tT.js";
import "./download-xVPnkeva.js";
...
<p class="footer">Red Tractor Beef &amp; Dairy: BVD monitoring records must be maintained and available at audit. Persistent Infectees (PIs) must be removed promptly. Retain records for a minimum of 3 years. Printed: ${(/* @__PURE__ */ new Date()).toLocaleDateString("en-GB")}</p>
  ...
  async function del(id) {
    ...
    await fetch(`/api/farms/${farmId}/bvd-tests/${id}`, { method: "DELETE" }).then(async (r2) => {
      if (!r2.ok) {
        const t = await r2.text().catch(() => "");
        throw new Error(t || `Request failed (${r2.status})`);
      }
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-8 text-gray-400 text-sm", children: "Loading…" }) : filteredBvdRecords.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 border-2 border-dashed rounded-lg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y", children: filteredBvdRecords.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-gray-50", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "h-7 px-2 text-red-500", onClick: () => del(r2.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3.5 h-3.5" }) })
        ] }) })
      ] }, r2.id)) })
    ] }) }),
...
<p class="footer">Red Tractor requires a record of every on-farm emergency killing. The person carrying out the slaughter must hold a valid WASK/WATOK certificate, or where a barbiturate injection is used, the attending vet must be RCVS registered. Records must be retained for a minimum of 3 years. Printed: ${(/* @__PURE__ */ new Date()).toLocaleDateString("en-GB")}</p>
  ...
  async function del(id) {
    ...
    await fetch(`/api/farms/${farmId}/casualty-slaughter/${id}`, { method: "DELETE" }).then(async (r2) => {
      if (!r2.ok) {
        const t = await r2.text().catch(() => "");
        throw new Error(t || `Request failed (${r2.status})`);
      }
