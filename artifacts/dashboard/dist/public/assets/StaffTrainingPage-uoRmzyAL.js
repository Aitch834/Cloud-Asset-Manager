import { b as useAppStore, l as useQuery, r as reactExports, j as jsxRuntimeExports, o as Link, c as Button, t as useQueryClient, a as useToast, Q as React, O as useMutation, I as Input, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, d as LoaderCircle } from "./index-CG7Bde15.js";
import { A as AppLayout, c as ClipboardList } from "./AppLayout-DW85f8T1.js";
import { T as Textarea } from "./textarea-B_gJAVX3.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, g as SelectSeparator, e as SelectGroup, f as SelectLabel } from "./select-WOrv5jfW.js";
...
import { G as GraduationCap } from "./shield-alert-1PMzBpNJ.js";
...
import { A as Award } from "./award-CQ_jyaay.js";
...
function TrainingTab({ farmId, staffNames, staffLoading, defaultMember }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/training`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/training/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/training/${id}`, { method: "DELETE" }),
    onSuccess: () => {
...
function CertificatesTab({ farmId, staffNames, staffLoading, defaultMember }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/certificates`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/certificates/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/certificates/${id}`, { method: "DELETE" }),
    onSuccess: () => {
...
function RtwDocsPanel({ rtwId, farmId }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (docId) => fetch(`/api/farms/${farmId}/right-to-work/${rtwId}/documents/${docId}`, { method: "DELETE" }),
...
function RightToWorkTab({ farmId, staffNames, staffLoading, defaultMember }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/right-to-work`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/right-to-work/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/right-to-work/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Record deleted" });
      qc.invalidateQueries({ queryKey: ["staff-rtw", farmId] });
      setDeleteId(null);
...
function CoursesTab({ farmId }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/training-courses`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/training-courses/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/training-courses/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
...
function StaffTrainingPage() {
  ...
  const urlTab = params.get("tab") ?? "training";
  const [tab, setTab] = reactExports.useState(urlTab);
  const membersQ = useFarmMembers(farmId);
