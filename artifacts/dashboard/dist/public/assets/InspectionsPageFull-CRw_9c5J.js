import { b as useAppStore, b0 as useSearch, r as reactExports, j as jsxRuntimeExports, c as Button, a as useToast, t as useQueryClient, l as useQuery, O as useMutation, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, d as LoaderCircle, Q as React } from "./index-CG7Bde15.js";
...
import { O as OtherSelect } from "./other-select-B0DMEKD1.js";
...
function InspectionsTab({ farmId, openInspId, onSwitchToIssues }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/inspections`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
  ...
  const updateMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/inspections/${editRecord?.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/inspections/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Deleted" });
      invalidate();
      setDeleteId(null);
  ...
  const addCommMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/inspections/${viewRecord?.id}/communications`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
...
function IssuesRegisterTab({ farmId, openCaId }) {
  ...
  const updateNc = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/nonconformances/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
    onSuccess: () => {
      toast({ title: "Updated" });
      invalidate();
      setNcEdit(null);
  ...
  const deleteNc = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/nonconformances/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Deleted" });
      invalidate();
      setNcDeleteId(null);
  ...
  const createCa = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/corrective-actions`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
    onSuccess: () => {
  ...
  const updateCa = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/corrective-actions/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
    onSuccess: () => {
      toast({ title: "Updated" });
      invalidate();
      setCaEdit(null);
  ...
  const deleteCa = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/corrective-actions/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Deleted" });
      invalidate();
      setCaDeleteId(null);
...
function AssuranceCertsTab({ farmId }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/assurance-certs/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Deleted" });
      invalidate();
      setDeleteId(null);
...
function InspectionsPageFull() {
  ...
  const [tab, setTab] = reactExports.useState(urlTab && ["inspections", "issues-register", "assurance-certs"].includes(urlTab) ? urlTab : "inspections");
