import { r as reactExports, m as useQuery, j as jsxRuntimeExports, b as useAppStore, b6 as formatAlertIssuedAt, e as LoaderCircle, c as useQueryClient, a as useToast, S as useMutation, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, I as Input, C as Checkbox, L as Label, N as DialogMutationError } from "./index-Dnqxw-hJ.js";
...
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-UKx7CUdy.js";
import { a as useRawFarmName } from "./use-farm-name-CGEtSnQ6.js";
import { P as Printer } from "./printer-DeEIYxKW.js";
import { T as TrendingUp, A as AppLayout, Y as Scissors, f as Scale, e as ChartColumn, c as ClipboardList } from "./AppLayout-BVlSEslh.js";
...
import { S as ShieldAlert } from "./shield-alert-B9V96hAV.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: reportRef, className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3 no-print", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => printElementReport(reportRef.current, { title: "Sheep Enterprise Report", subtitle: `${year} enterprise analysis`, farmName }), className: "h-9 px-3 rounded-lg border border-border bg-background text-sm flex items-center gap-1.5 hover:bg-muted/50", children: [
...
function SheepAnalyticsTab({ farmId }) {
  ...
  const filterByYear = (records, yr, ...fields) => records.filter((r) => {
    for (const f of fields) {
      const v = String(r[f] ?? "");
      if (!v || v === "undefined" || v === "null") continue;
      const d = new Date(v);
      if (!isNaN(d.getTime())) return d.getFullYear() === yr;
    }
    return false;
  });
  const scanFiltered = reactExports.useMemo(() => filterByYear(scanning, selectedYear, "scanningDate", "date"), [scanning, selectedYear]);
  const weighFiltered = reactExports.useMemo(() => filterByYear(weigh, selectedYear, "weighDate", "date"), [weigh, selectedYear]);
  const shearFiltered = reactExports.useMemo(() => filterByYear(shearing, selectedYear, "shearingDate", "date"), [shearing, selectedYear]);
  const tuppingFiltered = reactExports.useMemo(() => filterByYear(tupping, selectedYear, "tuppingDate", "startDate", "date"), [tupping, selectedYear]);
  const scanCompare = reactExports.useMemo(() => compareYear !== null ? filterByYear(scanning, compareYear, "scanningDate", "date") : [], [scanning, compareYear]);
  const shearCompare = reactExports.useMemo(() => compareYear !== null ? filterByYear(shearing, compareYear, "shearingDate", "date") : [], [shearing, compareYear]);
  const totalScanned = reactExports.useMemo(() => scanFiltered.reduce((s, r) => s + (Number(r.ewesScanned) || 0), 0), [scanFiltered]);
  const totalInLamb = reactExports.useMemo(() => scanFiltered.reduce((s, r) => s + (Number(r.ewesInLamb) || 0), 0), [scanFiltered]);
  const scanPct = totalScanned > 0 ? (totalInLamb / totalScanned * 100).toFixed(1) : null;
  const compareScanned = reactExports.useMemo(() => scanCompare.reduce((s, r) => s + (Number(r.ewesScanned) || 0), 0), [scanCompare]);
  const compareInLamb = reactExports.useMemo(() => scanCompare.reduce((s, r) => s + (Number(r.ewesInLamb) || 0), 0), [scanCompare]);
  ...
  const dlwgData = reactExports.useMemo(() => weighFiltered.filter((r) => r.dlwgGPerDay).slice(-10).map((r) => ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
      {
        ...
        value: scanFiltered.length,
        compare: compareYear !== null ? scanCompare.length : void 0,
      ...
      {
        label: "Scanning %",
        value: scanPct ? `${scanPct}%` : "—",
        compare: compareYear !== null && compareScanPct ? `${compareScanPct}%` : void 0,
        bg: "bg-amber-50 border-amber-100",
        text: "text-amber-800",
        sub: "text-amber-700"
      },
      {
        label: "Avg DLWG (g/day)",
        value: avgDlwg ?? "—",
      ...
      },
      {
        ...
        value: shearFiltered.length,
        compare: compareYear !== null ? shearCompare.length : void 0,
    ...
    shearByMonth.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-xl p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-sm mb-4", children: [
        "Head Sheared by Month",
        compareYear !== null ? ` — ${selectedYear} vs ${compareYear}` : ` (${selectedYear})`
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: shearByMonth, margin: { left: 0, right: 24, top: 4, bottom: 4 }, children: [
    ...
    shearData.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-xl p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-sm mb-4", children: "Wool Yield & Head Sheared — All Years" }),
    ...
    tuppingFiltered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-xl p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: tuppingFiltered.length }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Tupping Cycles" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: tuppingFiltered.reduce((s, r) => s + (Number(r.ewesExposed) || 0), 0) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Total Ewes Exposed" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: [...new Set(tuppingFiltered.map((r) => r.ramBreed).filter(Boolean))].length }),
...
function SheepProductionPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-6xl mx-auto space-y-6", children: [
    ...
    sheepAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm ${sheepAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : sheepAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "w-4 h-4 mt-0.5 shrink-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: sheepAlert.level === "national" ? "National Sheep Disease Alert" : sheepAlert.level === "regional" ? "Regional Sheep Disease Alert" : "Sheep Disease Notice" }),
        sheepAlert.message && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2", children: sheepAlert.message }),
        (sheepAlert.issuedAt || sheepAlert.date) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 opacity-70 text-xs", children: formatAlertIssuedAt(sheepAlert.issuedAt, sheepAlert.date) })
      ] })
    ] }),
