import { b as useAppStore, m as useQuery, j as jsxRuntimeExports, R as Redirect, U as FlaskConical, a as useToast, c as useQueryClient, r as reactExports, S as useMutation, e as LoaderCircle, d as Button, T as Plus, n as Card, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, L as Label, I as Input, N as DialogMutationError, aA as Check } from "./index-CFhHVfpn.js";
...
import { A as AppLayout, c as ClipboardList, B as BookOpen, I as Info } from "./AppLayout-CJMxwOtu.js";
import { T as TabBar, a as TabButton } from "./tab-button-BkdE31l6.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-C9ri6b-X.js";
import { C as Command, a as CommandInput, b as CommandList, c as CommandEmpty, d as CommandGroup, e as CommandItem } from "./command-CsUkt-VI.js";
...
import { E as ExternalLink } from "./external-link-tYiopj1R.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        records.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => printInputRegister(records, farmName, yearFilter === "all" ? null : Number(yearFilter)), className: "gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "w-4 h-4" }),
            "Print Register"
          ] })
        ] })
