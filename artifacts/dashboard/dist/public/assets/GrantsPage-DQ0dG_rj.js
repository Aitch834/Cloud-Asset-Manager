import { a as useToast, c as useQueryClient, b as useAppStore, u as useLocation, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, e as LoaderCircle, X, A as ArrowRight, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, I as Input, N as DialogMutationError } from "./index-CXBm2_VE.js";
import { a as usePersistedFilter } from "./use-persisted-filter-DXiAgqCe.js";
import { A as AppLayout, I as Info, C as CalendarDays, c as ClipboardList, s as AlertDialog, t as AlertDialogContent, v as AlertDialogHeader, w as AlertDialogTitle, x as AlertDialogDescription, y as AlertDialogFooter, z as AlertDialogCancel, D as AlertDialogAction } from "./AppLayout-_igEi9h7.js";
...
import { P as PoundSterling, F as FileText } from "./shield-alert-Io24gsZL.js";
import { C as CircleCheck } from "./circle-check-IbF17PHi.js";
import { T as TriangleAlert, L as Leaf } from "./triangle-alert-DriJ9yxR.js";
import { E as ExternalLink } from "./external-link-BiZvLnzM.js";
import { A as Archive } from "./archive-DxtxDrwJ.js";
...
const AE_MILESTONE_STATUSES = ["pending", "submitted", "paid", "overdue"];
...
function AgriEnvTab({ farmId }) {
  ...
  const [expandedId, setExpandedId] = reactExports.useState(_initProjectId);
  ...
  const [aeExportScheme, setAeExportScheme] = reactExports.useState("all");
  const [aeExportStatus, setAeExportStatus] = reactExports.useState("all");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ae-screen-only", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 24 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#f5f3ff", border: "1px solid #e9d5ff", borderRadius: 10, padding: "16px 20px" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "0.78rem", color: "#6b7280", marginTop: 2 }, children: [
            "across ",
            projects.filter((p) => p.status !== "withdrawn").length,
            " scheme(s)"
          ] })
        ] }),
      ...
      projects.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "all", children: "All schemes" }),
              uniqueSchemeNames.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: n, children: n }, n))
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: 60, color: "#9ca3af" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 24, className: "animate-spin", style: { display: "inline" } }) }) : projects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "48px 24px", background: "#f9fafb", borderRadius: 10, border: "1px dashed #e5e7eb" }, children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: projects.map((project) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }, children: [
          ...
          isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid #f3f4f6", background: "#fafafa", padding: "12px 16px" }, children: [
            ...
            milestones.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: "20px 12px", color: "#9ca3af", fontSize: "0.82rem" }, children: "No milestones recorded yet — add one to track claim dates and evidence." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: milestones.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "10px 14px", display: "flex", alignItems: "flex-start", gap: 10 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.875rem", fontWeight: 600, color: "#111827" }, children: m.milestoneName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(AeMilestoneBadge, { status: m.status }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 12, flexWrap: "wrap", marginTop: 3, alignItems: "center" }, children: [
                  m.dueDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 4, fontSize: "0.78rem", color: "#6b7280" }, children: [
                    "Due:",
                    " ",
                    m.status === "paid" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.78rem", color: "#6b7280" }, children: new Date(m.dueDate).toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(DeadlineBadge, { dateStr: m.dueDate })
                  ] }),
    ...
    filteredProjects.length > 0 && (() => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "none" }, className: "ae-print-only", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontFamily: "Georgia, serif", color: "#111827", padding: "0 0 24px" }, children: [
...
function GrantsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1200, margin: "0 auto", padding: "24px 16px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16 }, children: [
      ...
      mainTab === "capital" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: openAdd, style: { display: "flex", alignItems: "center", gap: 6 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16 }),
        " Add Grant"
      ] })
    ] }),
    ...
    mainTab === "agrienv" && /* @__PURE__ */ jsxRuntimeExports.jsx(AgriEnvTab, { farmId })
  ] }) });
}
export {
