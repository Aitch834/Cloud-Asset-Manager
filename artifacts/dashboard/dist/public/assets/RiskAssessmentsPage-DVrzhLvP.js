import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, c as Button, T as FlaskConical, a as useToast, t as useQueryClient, l as useQuery, O as useMutation, I as Input, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, J as DialogFooter, d as LoaderCircle, m as Card, n as CardContent, Q as React } from "./index-D3ay9Ao3.js";
import { F as FarmLocationSelect } from "./FarmLocationSelect-OZqiI7CH.js";
import { A as AppLayout, Z as Zap, E as Flame, c as ClipboardList } from "./AppLayout-DRFFu3V0.js";
...
import { S as ShieldAlert } from "./shield-alert-B8JTZTuq.js";
...
function RiskAssessmentTab({ farmId, openId }) {
  ...
  const [quickFilter, setQuickFilter] = reactExports.useState("none");
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/risk-assessments/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["risk-assessments", farmId] });
      setDeleteId(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteId !== null, onOpenChange: () => setDeleteId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "28rem" }, children: [
...
function CoshhTab({ farmId, openId }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/risk-coshh/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Deleted" });
      invalidate();
      setDeleteId(null);
...
function PatTestingTab({ farmId, openId }) {
  ...
  const [deleteId, setDeleteId] = reactExports.useState(null);
  const [hlId, setHlId] = reactExports.useState(openId ?? null);
  const [buildingFilter, setBuildingFilter] = reactExports.useState("__all__");
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/workshop/pat-equipment`, { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...body, buildingId: body.buildingId ? parseInt(body.buildingId) : null }) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/workshop/pat-equipment/${editing.id}`, { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...body, buildingId: body.buildingId ? parseInt(body.buildingId) : null }) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["pat-equipment", farmId] });
      setShowForm(false);
      setEditing(null);
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/workshop/pat-equipment/${id}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["pat-equipment", farmId] });
      setDeleteId(null);
    },
  ...
  const createTestMut = useMutation({
    mutationFn: ({ eqId, body }) => fetch(`/api/farms/${farmId}/workshop/pat-equipment/${eqId}/tests`, { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (_, { eqId }) => {
  ...
  const updateTestMut = useMutation({
    mutationFn: ({ eqId, testId, body }) => fetch(`/api/farms/${farmId}/workshop/pat-equipment/${eqId}/tests/${testId}`, { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (_, { eqId }) => {
      qc.invalidateQueries({ queryKey: ["pat-test-records", farmId, eqId] });
      qc.invalidateQueries({ queryKey: ["pat-equipment", farmId] });
      setShowTest(false);
  ...
  const deleteTestMut = useMutation({
    mutationFn: ({ eqId, testId }) => fetch(`/api/farms/${farmId}/workshop/pat-equipment/${eqId}/tests/${testId}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: (_, { eqId }) => {
      qc.invalidateQueries({ queryKey: ["pat-test-records", farmId, eqId] });
      qc.invalidateQueries({ queryKey: ["pat-equipment", farmId] });
...
function FireSafetyTab({ farmId, openId }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/workshop/fire-extinguishers`, { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...body, buildingId: body.buildingId ? parseInt(body.buildingId) : null }) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/workshop/fire-extinguishers/${editing.id}`, { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...body, buildingId: body.buildingId ? parseInt(body.buildingId) : null }) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["fire-extinguishers", farmId] });
      setShowForm(false);
      setEditing(null);
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/workshop/fire-extinguishers/${id}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["fire-extinguishers", farmId] });
      setDeleteId(null);
    },
  ...
  const createServiceMut = useMutation({
    mutationFn: ({ extId, body }) => fetch(`/api/farms/${farmId}/workshop/fire-extinguishers/${extId}/services`, { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (_, { extId }) => {
  ...
  const updateServiceMut = useMutation({
    mutationFn: ({ extId, svcId, body }) => fetch(`/api/farms/${farmId}/workshop/fire-extinguishers/${extId}/services/${svcId}`, { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (_, { extId }) => {
      qc.invalidateQueries({ queryKey: ["fire-extinguisher-services", farmId, extId] });
      qc.invalidateQueries({ queryKey: ["fire-extinguishers", farmId] });
      setShowService(false);
  ...
  const deleteServiceMut = useMutation({
    mutationFn: ({ extId, svcId }) => fetch(`/api/farms/${farmId}/workshop/fire-extinguishers/${extId}/services/${svcId}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: (_, { extId }) => {
      qc.invalidateQueries({ queryKey: ["fire-extinguisher-services", farmId, extId] });
      qc.invalidateQueries({ queryKey: ["fire-extinguishers", farmId] });
...
function RiskAssessmentsPage() {
  ...
  const [tab, setTab] = reactExports.useState(() => {
    ...
    const t = p.get("tab");
    const valid = ["risk", "coshh", "pat", "fire"];
    return t && valid.includes(t) ? t : "risk";
  });
