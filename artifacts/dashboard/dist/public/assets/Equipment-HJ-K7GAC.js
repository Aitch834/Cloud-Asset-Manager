import { q as createLucideIcon, a0 as useListEquipment, t as useQueryClient, a1 as useCreateEquipment, a2 as getListEquipmentQueryKey, b as useAppStore, r as reactExports, a as useToast, l as useQuery, O as useMutation, j as jsxRuntimeExports, R as Redirect, I as Input, c as Button, z as Dialog, W as DialogTrigger, S as Plus, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, J as DialogFooter, d as LoaderCircle, H as DialogDescription, $ as X } from "./index-fxZRGm6t.js";
import { A as AppLayout, d as Wrench, e as ChartColumn, c as ClipboardList, R as RotateCcw, u as useUserRole } from "./AppLayout-DGOTUjsH.js";
...
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem } from "./dropdown-menu-Bp44HAmx.js";
...
import { E as EyeOff } from "./eye-off-DT4i9HDe.js";
...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, C as Cell } from "./generateCategoricalChart-C9hKMiDl.js";
...
function EquipmentDefectsSection({ farmId }) {
  ...
  const createM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/equipment-defect-reports`, { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const patchM = useMutation({
    mutationFn: ({ id, status }) => fetch(`/api/farms/${farmId}/equipment-defect-reports/${id}/status`, { method: "PATCH", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ status }) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["equipment-defects", farmId] });
      setUpdatingId(null);
...
function EquipmentPage() {
  ...
  const [tab, setTab] = reactExports.useState("equipment");
  const [viewRecord, setViewRecord] = reactExports.useState(null);
  ...
  const [gpsFilter, setGpsFilter] = reactExports.useState("all");
  ...
  const addMaintMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/equipment/${managingItem.id}/maintenance`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const editMaintMut = useMutation({
    mutationFn: ({ logId, body }) => fetch(`/api/farms/${farmId}/equipment/${managingItem.id}/maintenance/${logId}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["equipment-maintenance", farmId, managingItem?.id] });
      queryClient.invalidateQueries({ queryKey: getListEquipmentQueryKey(farmId ?? 0) });
      setServiceFormOpen(false);
  ...
  const deleteMaintMut = useMutation({
    mutationFn: (logId) => fetch(`/api/farms/${farmId}/equipment/${managingItem.id}/maintenance/${logId}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["equipment-maintenance", farmId, managingItem?.id] });
      queryClient.invalidateQueries({ queryKey: getListEquipmentQueryKey(farmId ?? 0) });
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl border border-border/50 overflow-hidden shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/50", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 7, className: "px-6 py-12 text-center text-foreground/50", children: "Loading equipment..." }) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 7, className: "px-6 py-12 text-center text-foreground/50", children: equipment.length === 0 ? showDisposed && disposedCount > 0 ? "All equipment is disposed." : "No equipment registered." : "No equipment matches your search or filter." }) }) : grouped.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
          ...
          group.items.map((item) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `hover:bg-black/5 transition-colors ${isDisposed ? "opacity-60" : ""}`, children: [
