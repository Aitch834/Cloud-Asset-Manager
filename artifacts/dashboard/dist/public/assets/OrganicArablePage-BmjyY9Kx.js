import { b as useAppStore, a as useToast, c as useQueryClient, m as useQuery, r as reactExports, S as useMutation, j as jsxRuntimeExports, b5 as formatAlertIssuedAt, e as LoaderCircle, d as Button, L as Label, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, I as Input, N as DialogMutationError } from "./index-CPTnvEXt.js";
...
import { A as AppLayout, a as Wheat, S as Sprout, B as BookOpen, e as ChartColumn } from "./AppLayout-BwXO7xhU.js";
...
import { S as ShieldAlert, F as FileText } from "./shield-alert-B7niEs8n.js";
...
import { a as ArrowDownToLine, A as ArrowUpFromLine } from "./arrow-up-from-line-jz04eU7R.js";
...
function DeleteConfirmDialog({ open, onClose, onConfirm, saving, mutation }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => {
    ...
    mutation && /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation, message: "Failed to delete — the record is still here." }),
...
function OrganicArablePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-6 space-y-6", children: [
      ...
      farmId && /* @__PURE__ */ jsxRuntimeExports.jsx(ArableFarmSettingsChecklist, { farmId }),
      arableAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 p-3 rounded-lg text-white ${arableAlert.level === "national" ? "bg-red-600" : arableAlert.level === "regional" ? "bg-orange-500" : "bg-amber-500"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold text-sm", children: [
            "Crop Health Alert",
            arableAlert.level ? ` — ${arableAlert.level.charAt(0).toUpperCase() + arableAlert.level.slice(1)}` : ""
          ] }),
          arableAlert.message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5 opacity-90", children: arableAlert.message }),
          (arableAlert.issuedAt || arableAlert.date) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs opacity-75 mt-0.5", children: formatAlertIssuedAt(arableAlert.issuedAt, arableAlert.date) })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: certOpen, onOpenChange: (v) => {
      if (!v) {
        setCertOpen(false);
        certMut.save.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: certMut.save, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: convOpen, onOpenChange: (v) => {
      if (!v) {
        setConvOpen(false);
        convMut.save.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: convMut.save, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: stockOpen, onOpenChange: (v) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: stockMut.save, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: moveOpen, onOpenChange: (v) => {
      if (!v) {
        setMoveOpen(false);
        moveSaveMut.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: moveSaveMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: seedOpen, onOpenChange: (v) => {
      if (!v) {
        setSeedOpen(false);
        seedMut.save.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: seedMut.save, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: inputOpen, onOpenChange: (v) => {
      if (!v) {
        setInputOpen(false);
        inputMut.save.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: inputMut.save, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: harvestOpen, onOpenChange: (v) => {
      if (!v) {
        setHarvestOpen(false);
        harvestMut.save.reset();
      }
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg max-h-[90vh] overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: harvestMut.save, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: buyerOpen, onOpenChange: (v) => {
      if (!v) {
        setBuyerOpen(false);
        harvestMut.save.reset();
      }
