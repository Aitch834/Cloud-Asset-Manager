const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-CydutLSs.js","assets/index-BciYlE5o.js","assets/index-Cl-fLpBm.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-BciYlE5o.js";
import { L as LabSelector } from "./LabSelector-DLFX8vVk.js";
import { P as Printer } from "./printer-CFc32A3u.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-BTnlog1-.js";
import { B as BarChart } from "./BarChart-BEe3BC0g.js";
import { C as CartesianGrid } from "./CartesianGrid-BUmzHtFt.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-BeZm25Hu.js";
import { C as ChevronUp } from "./chevron-up-DAj1uoyV.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-Bb-YdBNe.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-KZBMoq3D.js";
import { T as Textarea } from "./textarea-BAwEaJVW.js";
import { C as ConfirmDialog } from "./confirm-dialog-qIxPXOWt.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-B_dw_sbd.js";
...
import { u as useFarmMembers } from "./use-farm-members-BV48Px3S.js";
import { u as useFarmName } from "./use-farm-name-C5ZtR6xb.js";
import { S as StaffSelect } from "./staff-select-GaSqBtwI.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { L as LayoutGrid } from "./layout-grid-WH59KAUL.js";
import { D as Droplets } from "./shield-alert-B-GMVRsu.js";
import { P as Package } from "./use-safe-clerk-BPQOkIWX.js";
import { T as Thermometer } from "./thermometer-DfYGGtxf.js";
import { E as Eye } from "./eye-BSI-GKH7.js";
import { P as Pencil } from "./pencil-CCn0kZ43.js";
import { A as Archive } from "./archive-AkawGWwT.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-CydutLSs.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
