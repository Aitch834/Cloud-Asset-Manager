import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, R as Redirect, c as useQueryClient, a as useToast, m as useQuery, O as useMutation, e as LoaderCircle, l as cn, d as Button, S as Plus, n as Card, o as CardContent, a$ as CardHeader, b0 as CardTitle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, X as DialogMutationError, J as DialogFooter, a0 as X, p as Link } from "./index-CdTz9koZ.js";
import { u as useUpload } from "./use-upload-BTXwjUVC.js";
import { Q as QrCode, a as QRCodeSVG } from "./index-DOrMeuuH.js";
import { R as RaiseTaskDialog } from "./RaiseTaskDialog-BpDBGbWT.js";
import { A as AppLayout, U as Users, O as Settings, c as ClipboardList, I as Info, d as Wrench } from "./AppLayout-FSCQu3Bg.js";
import { T as Textarea } from "./textarea-CsOKBzuQ.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, e as SelectGroup, f as SelectLabel } from "./select-Ca9tbypB.js";
import { O as OtherSelect } from "./other-select-Cyf5VBp8.js";
...
import { u as useFarmMembers, m as memberFullName } from "./use-farm-members-BIp1Fh2D.js";
...
import { A as ArrowUpFromLine, a as ArrowDownToLine } from "./arrow-up-from-line-pCmH-j9Q.js";
import { T as TriangleAlert } from "./triangle-alert-Jvi8sGth.js";
import { C as CircleCheck } from "./circle-check-ChfSawf-.js";
import { H as History } from "./history-BtjFGo0B.js";
import { S as Search } from "./search-C2UjtaOm.js";
import { C as ChevronRight } from "./tractor-sbify2To.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, a as LabelList, C as Cell, L as Legend } from "./generateCategoricalChart-ChTjMMmR.js";
...
import { C as ComposedChart } from "./ComposedChart-C5BV5lvE.js";
import { L as Line } from "./Line-CD2ZQvlZ.js";
import { E as EyeOff } from "./eye-off-w83yNX9M.js";
import { E as Eye } from "./eye-BHz7I-YV.js";
import { F as FileText } from "./shield-alert-EIGouMgo.js";
import { U as Upload } from "./upload-TDV9syLj.js";
import { D as Download } from "./download-B5PztG48.js";
import "./shield-check-B3QDv7Ce.js";
import "./index-oBwPwulo.js";
import "./index-eUFMt5e3.js";
import "./chevron-up-X8PYk_fo.js";
...
function JobDocumentsSection({ farmId, jobId }) {
  ...
  const deleteDoc = useMutation({
    mutationFn: (docId) => fetch(api(`farms/${farmId}/workshop/jobs/${jobId}/documents/${docId}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
  ...
  const saveDocMeta = useMutation({
    mutationFn: (body) => fetch(api(`farms/${farmId}/workshop/jobs/${jobId}/documents`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function JobCardsTab({ farmId, openId, initialStatus }) {
  ...
  const addLabourEntry = useMutation({
    mutationFn: (entry) => fetch(api(`farms/${farmId}/workshop/jobs/${editing.id}/labour`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(entry) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteLabourEntry = useMutation({
    mutationFn: (entryId) => fetch(api(`farms/${farmId}/workshop/jobs/${editing.id}/labour/${entryId}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const saveWorkshopSettings = useMutation({
    mutationFn: (s) => fetch(api(`farms/${farmId}/workshop/settings`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(s) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const save = useMutation({
    mutationFn: async (body) => {
      ...
      if (editing) {
        await fetch(api(`farms/${farmId}/workshop/jobs/${editing.id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(cleanBody) }).then(async (r) => {
          if (!r.ok) {
            const t = await r.text().catch(() => "");
            throw new Error(t || `Request failed (${r.status})`);
          }
        ...
        for (const e of pendingLabourEntries) {
          await fetch(api(`farms/${farmId}/workshop/jobs/${editing.id}/labour`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ entryDate: e.date, description: e.description, chargeUnits: e.chargeUnits, ratePence: e.ratePence }) }).then(async (r) => {
            if (!r.ok) {
              const t = await r.text().catch(() => "");
              throw new Error(t || `Request failed (${r.status})`);
            }
        ...
        const res = await fetch(api(`farms/${farmId}/workshop/jobs`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(cleanBody) }).then(async (r) => {
          if (!r.ok) {
            const t = await r.text().catch(() => "");
            throw new Error(t || `Request failed (${r.status})`);
          }
        ...
        if (newJob?.id && pendingLabourEntries.length > 0) {
          for (const e of pendingLabourEntries) {
            await fetch(api(`farms/${farmId}/workshop/jobs/${newJob.id}/labour`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ entryDate: e.date, description: e.description, chargeUnits: e.chargeUnits, ratePence: e.ratePence }) }).then(async (r) => {
              if (!r.ok) {
                const t = await r.text().catch(() => "");
                throw new Error(t || `Request failed (${r.status})`);
              }
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/jobs/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function ServiceScheduleTab({ farmId }) {
  ...
  const logMut = useMutation({
    mutationFn: ({ equipmentId, body }) => fetch(api(`farms/${farmId}/equipment/${equipmentId}/maintenance`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function GoodsReturnsView({ farmId, parts, staffNames, membersLoading }) {
  ...
  const createReturn = useMutation({
    mutationFn: (body) => fetch(api(`farms/${farmId}/workshop/returns`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateReturn = useMutation({
    mutationFn: ({ id, body }) => fetch(api(`farms/${farmId}/workshop/returns/${id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteReturn = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/returns/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function LocationManager({ farmId, onClose }) {
  ...
  const createRow = useMutation({ mutationFn: (b) => fetch(api(`farms/${farmId}/workshop/rows`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const updateRow = useMutation({ mutationFn: ({ id, ...b }) => fetch(api(`farms/${farmId}/workshop/rows/${id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const deleteRow = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/rows/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const createBay = useMutation({ mutationFn: (b) => fetch(api(`farms/${farmId}/workshop/bays`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const updateBay = useMutation({ mutationFn: ({ id, ...b }) => fetch(api(`farms/${farmId}/workshop/bays/${id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const deleteBay = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/bays/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const createShelf = useMutation({ mutationFn: ({ bayId, name, capacity }) => fetch(api(`farms/${farmId}/workshop/bays/${bayId}/shelves`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, capacity: capacity || null }) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const updateShelf = useMutation({ mutationFn: ({ id, ...b }) => fetch(api(`farms/${farmId}/workshop/shelves/${id}`), { method: "PUT", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
  ...
  const deleteShelf = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/shelves/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
    if (!r.ok) {
      const t = await r.text().catch(() => "");
      throw new Error(t || `Request failed (${r.status})`);
    }
...
function PartPanel({ farmId, part, onClose, onEdit }) {
  ...
  const deleteDoc = useMutation({
    mutationFn: (docId) => fetch(api(`farms/${farmId}/workshop/parts/${part.id}/documents/${docId}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const saveDocMeta = useMutation({
    mutationFn: (body) => fetch(api(`farms/${farmId}/workshop/parts/${part.id}/documents`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function PartsStoreTab({ farmId }) {
  ...
  const deletePart = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/parts/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const useParts = useMutation({
    mutationFn: (body) => fetch(api(`farms/${farmId}/workshop/parts/use`), { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ stockItemId: usePart?.id, quantity: body.qty, jobId: body.jobId || null, performedBy: body.performedBy, notes: body.notes }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function CustomersTab({ farmId, onViewJobs }) {
  ...
  const saveMut = useMutation({
    mutationFn: (body) => {
      if (editRecord) {
        return fetch(api(`farms/${farmId}/farm-customers/${editRecord.id}`), { method: "PUT", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
          if (!r.ok) {
            const t = await r.text().catch(() => "");
            throw new Error(t || `Request failed (${r.status})`);
          }
      ...
      return fetch(api(`farms/${farmId}/farm-customers`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
        if (!r.ok) {
          const t = await r.text().catch(() => "");
          throw new Error(t || `Request failed (${r.status})`);
        }
  ...
  const reactivateMut = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/farm-customers/${id}`), { method: "PUT", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ isActive: true }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function WorkshopStocktakeView({ farmId }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(api(`farms/${farmId}/workshop/stocktakes`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateItemMut = useMutation({
    mutationFn: ({ sessionId, itemId, countedQty }) => fetch(api(`farms/${farmId}/workshop/stocktakes/${sessionId}/items/${itemId}`), { method: "PATCH", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ countedQty }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const completeMut = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/stocktakes/${id}/complete`), { method: "POST", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/workshop/stocktakes/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
