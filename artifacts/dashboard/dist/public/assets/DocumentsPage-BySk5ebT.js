import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, l as useQuery, O as useMutation, j as jsxRuntimeExports, o as Link, T as FlaskConical, I as Input, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, Q as React, d as LoaderCircle, $ as X, J as DialogFooter } from "./index-CZUDbqE7.js";
import { A as AppLayout, U as Users, I as Info } from "./AppLayout-Bva0DUIN.js";
...
function DocumentsPage() {
  ...
  const [pageTab, setPageTab] = reactExports.useState("hub");
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/documents`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/documents/${id}`, { method: "DELETE" }),
    onSuccess: () => {
...
${rest.notes}` : ""}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Documents", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1240, margin: "0 auto" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addOpen, onOpenChange: closeAdd, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 560 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!deleteId, onOpenChange: (o) => !o && setDeleteId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 380 }, children: [
