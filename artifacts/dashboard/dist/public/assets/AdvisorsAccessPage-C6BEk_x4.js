import { q as createLucideIcon, b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, l as useQuery, O as useMutation, j as jsxRuntimeExports, R as Redirect, m as Card, n as CardContent, aZ as CardHeader, a_ as CardTitle, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, J as DialogFooter, C as Checkbox } from "./index-CNTONoqw.js";
import { A as AppLayout, s as AlertDialog, t as AlertDialogContent, v as AlertDialogHeader, w as AlertDialogTitle, x as AlertDialogDescription, y as AlertDialogFooter, z as AlertDialogCancel, D as AlertDialogAction } from "./AppLayout-BiuXCOHY.js";
...
function AdvisorsAccessPage() {
  ...
  const revokeAdvisor = useMutation({
    mutationFn: async (id) => fetch(`/api/farms/${farmId}/advisors/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["advisors", farmId] });
  ...
  const revokeSession = useMutation({
    mutationFn: async (id) => fetch(`/api/farms/${farmId}/inspection-sessions/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["inspection-sessions", farmId] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Advisors & External Access", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showAdvisorDialog, onOpenChange: setShowAdvisorDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "44rem" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showSessionDialog, onOpenChange: setShowSessionDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "44rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!revokeTarget, onOpenChange: () => setRevokeTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
