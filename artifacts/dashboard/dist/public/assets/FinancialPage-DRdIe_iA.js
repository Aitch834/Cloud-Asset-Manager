import { b as useAppStore, j as jsxRuntimeExports, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, I as Input, d as Button, T as Plus, X, p as Link, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, N as DialogMutationError, J as DialogFooter, e as LoaderCircle } from "./index-CquEFBIW.js";
import { u as useLookupStrings } from "./use-lookup-D_yxOCtr.js";
...
import { A as AppLayout, l as ShoppingBag, e as ChartColumn, Z as Zap, a as Wheat, T as TrendingUp } from "./AppLayout-BFKoAcru.js";
...
import { F as FileText, P as PoundSterling } from "./shield-alert-BSsrod7O.js";
import { S as Search } from "./search-Dtj3lVDV.js";
import { D as Download } from "./download-ByqKF_b3.js";
import { L as Link2 } from "./link-2-DvtZXyEZ.js";
import { E as ExternalLink } from "./external-link-B6ht2JWg.js";
import { T as Trash2 } from "./trash-2-BidJfuKN.js";
...
import { L as LineChart } from "./LineChart-lA4i7K4S.js";
...
import "./use-safe-clerk-BswyzeRf.js";
import "./database-Bi74_v7e.js";
import "./triangle-alert-CT6MDhnW.js";
...
function TransactionsTab({ farmId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: txListRef, style: { display: "flex", gap: 8, marginBottom: "1rem", alignItems: "center", flexWrap: "wrap" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: enterpriseFilter, onValueChange: (value) => setEnterpriseFilter(value === "__untagged__" ? "" : value), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { style: { width: 160 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: enterpriseFilter === "" ? "Untagged" : void 0 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
  ...
  function handlePrint() {
    ...
    const incomeRows = incomeByCategory.map((r) => {
      ...
      const badges = projects.map(
        (name) => `<span style="display:inline-block;margin-top:3px;margin-right:4px;font-size:7.5pt;color:#166534;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:3px;padding:1px 5px;">via milestone · ${esc(name)}</span>`
      ).join("");
