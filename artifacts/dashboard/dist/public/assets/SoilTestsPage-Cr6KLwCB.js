...
import { aK as Subscribable, aL as notifyManager, aM as shallowEqualObjects, aN as replaceEqualDeep, aO as QueryObserver, t as useQueryClient, aP as useIsRestoring, aQ as useQueryErrorResetBoundary, r as reactExports, aR as ensureSuspenseTimers, aS as ensurePreventErrorBoundaryRetry, aT as useClearResetErrorBoundary, aU as noop, aV as shouldSuspend, aW as fetchOptimistic, aX as getHasError, q as createLucideIcon, l as useQuery, O as useMutation, aY as toast, j as jsxRuntimeExports, c as Button, S as Plus, d as LoaderCircle, m as Card, M as MapPin, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, I as Input, _ as __vitePreload, $ as X, b as useAppStore, R as Redirect, K as Map$1, a as useToast, T as FlaskConical, A as ArrowRight, H as DialogDescription, B as Building2, Q as React } from "./index-CxGrFdGB.js";
...
import { U as Upload } from "./upload-C_AfjnPw.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, _ as ReferenceLine } from "./generateCategoricalChart-DESGj4PX.js";
import { L as LineChart } from "./LineChart-DDlt_3Qp.js";
import { C as CartesianGrid } from "./CartesianGrid-DcyjILd2.js";
import { L as Line } from "./Line-D-heXDE0.js";
import { C as Cpu } from "./cpu-CtcWMTHp.js";
import { C as CircleCheckBig } from "./circle-check-big-BxaF9IbA.js";
import { I as Info, A as AppLayout, T as TrendingUp, i as TestTube, U as Users } from "./AppLayout-DR0WNMiE.js";
import { C as CircleAlert, a as Clock } from "./database-v9V6a3L2.js";
import { o as openPrintWindow } from "./print-report-B_FwCCVJ.js";
import { C as CropYearSelector } from "./CropYearSelector-C1o2KZDe.js";
...
import { L as LabSelector } from "./LabSelector-BVzirbo6.js";
...
import { E as Ellipsis } from "./ellipsis-DMbFFEwM.js";
import { A as Archive } from "./archive-CfjI-IZF.js";
import { H as History } from "./history-zUqdFFbN.js";
import { U as UserCheck } from "./user-check-Dv7BtasZ.js";
...
import "./shield-alert-Coj5xait.js";
import "./triangle-alert-DGJ7NzCC.js";
...
function CsvImportDialog({ open, onClose, probe, farmId }) {
    ...
    try {
      ...
      const rows = lines.slice(1).map((line) => {
        ...
        return {
          ...
          depthCm: row["depthcm"] ? parseInt(row["depthcm"], 10) : void 0,
          moisturePercent: row["moisturepercent"] || row["moisture"] || void 0,
          temperatureCelsius: row["temperaturecelsius"] || row["temperature"] || row["temp"] || void 0,
          ecUsPerCm: row["ecuspercm"] || row["ec"] || void 0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
      ...
      preview.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center py-10 gap-2 text-gray-400", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: readings.slice().reverse().map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-gray-100 hover:bg-gray-50", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => setPendingConfirm({ msg: "Delete this soil moisture reading? This cannot be undone.", fn: () => deleteReading.mutate(r.id) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => setPendingConfirm({ msg: `Delete "${probe.name}" and all its readings? This cannot be undone.`, fn: () => deleteProbe.mutate(probe.id) }),
...
function SoilLocationPicker({ lat, lng, locationDescription, onLatLngChange, onDescriptionChange }) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-J4WYjull.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
...
function RegisterTab({ farmId }) {
  ...
  const createTest = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/soil-tests`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (data) => {
  ...
  const updateTest = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/soil-tests/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["soil-tests", farmId] });
      setEditTest(null);
      setTestForm(EMPTY_TEST);
  ...
  const deleteTest = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/soil-tests/${id}`, { method: "DELETE" }),
    onSuccess: (_, id) => {
      qc.invalidateQueries({ queryKey: ["soil-tests", farmId] });
  ...
  const updateStatus = useMutation({
    mutationFn: ({ id, status }) => fetch(`/api/farms/${farmId}/soil-tests/${id}/status`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ status }) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["soil-tests", farmId] });
    },
  ...
  const addResult = useMutation({
    mutationFn: ({ testId, body }) => fetch(`/api/farms/${farmId}/soil-tests/${testId}/results`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (_, vars) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteTestId !== null, onOpenChange: () => setDeleteTestId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteResultInfo !== null, onOpenChange: () => setDeleteResultInfo(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
...
function PrintTab({ farmId }) {
  const [printYear, setPrintYear] = reactExports.useState("all");
  const [printStatus, setPrintStatus] = reactExports.useState("all");
  ...
  const filteredTests = testsWithResults.filter((t) => printYear === "all" || new Date(t.sampleDate).getFullYear() === printYear).filter((t) => printStatus === "all" || t.status === printStatus);
  const handlePrint = () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 items-start sm:items-end mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "h-12 rounded-xl border-2 border-border bg-transparent px-4 py-2 text-base focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10", value: printYear, onChange: (e) => setPrintYear(e.target.value === "all" ? "all" : parseInt(e.target.value)), children: [
...
function SoilTestsPage() {
  ...
  const [tab, setTab] = reactExports.useState("register");
