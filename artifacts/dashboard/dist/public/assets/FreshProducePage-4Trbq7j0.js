const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-5m9q-pam.js","assets/index-1TyBJonr.js","assets/index-B1F8QQQr.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-1TyBJonr.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-DMdqrNel.js";
import { L as LabSelector } from "./LabSelector-CvGbWIqz.js";
import { P as Printer } from "./printer-DnWp0geJ.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-D7AQvTAg.js";
import { B as BarChart } from "./BarChart-ppJFXFQ_.js";
import { C as CartesianGrid } from "./CartesianGrid-BA2HuCIq.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-DsHTnLix.js";
import { C as ChevronUp } from "./chevron-up-Cu3yqhgf.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-CQ3Z3qSp.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-Ct04za5p.js";
...
import { u as useFarmName } from "./use-farm-name-D1ZXU57g.js";
import { S as StaffSelect } from "./staff-select-zgsp-_Wq.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { S as ShieldAlert, D as Droplets } from "./shield-alert-HvE4k3Y1.js";
import { L as LayoutGrid } from "./layout-grid-C2TVnLJ-.js";
...
import { A as Archive } from "./archive-BNvt2F5m.js";
import "./database-DCM9sdwU.js";
import "./shield-check-DLKM_Y6O.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-5m9q-pam.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Fresh Produce", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    hortiAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 p-3 rounded-lg text-white ${hortiAlert.level === "national" ? "bg-red-600" : hortiAlert.level === "regional" ? "bg-orange-500" : "bg-amber-500"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        ...
        hortiAlert.date && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs opacity-75 mt-0.5", children: [
          "Issued: ",
          new Date(hortiAlert.date).toLocaleDateString("en-GB")
        ] })
      ] })
    ] }),
