const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-Dbo5Q_le.js","assets/index-DgyPGl3H.js","assets/index-BmRI0CcT.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b4 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-DgyPGl3H.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-CxyECNc6.js";
import { L as LabSelector } from "./LabSelector-Dv4LplLu.js";
import { a as useRawFarmName, b as useFarmName } from "./use-farm-name-12GioHfw.js";
import { a as printElementReport } from "./print-report-ClU8-1P0.js";
import { P as Printer } from "./printer-DW6BtSRI.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-BU4g0TRN.js";
import { B as BarChart } from "./BarChart-D2dpwqb2.js";
import { C as CartesianGrid } from "./CartesianGrid-DGscaitN.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-DP_zejrj.js";
import { C as ChevronUp } from "./chevron-up-CstrO5LT.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-Bzcw0FjU.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-PhK-zROm.js";
...
import { S as ShieldAlert, D as Droplets } from "./shield-alert-Ep_DJDDA.js";
import { L as LayoutGrid } from "./layout-grid-CR1_cQm-.js";
...
import { A as Archive } from "./archive-Cg_3zU7b.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-Dbo5Q_le.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
