import { r as reactExports, j as jsxRuntimeExports, I as Input, d as Button, b as useAppStore, m as useQuery, R as Redirect, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, n as Card, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, N as DialogMutationError, O as React, X, L as Label, p as Link, U as FlaskConical } from "./index-DImoRxln.js";
import { u as usePersistedTab } from "./use-persisted-tab-CJa8rd1m.js";
import { u as usePersistedNumberFilter } from "./use-persisted-filter-uyfhpBFC.js";
...
import { F as FarmLocationSelect } from "./FarmLocationSelect-DpBQHGXl.js";
import { P as Pen } from "./pen-yOm0dSjH.js";
import { T as Trash2, C as ChevronDown } from "./trash-2-Br3Vg5k2.js";
import { A as AppLayout, U as Users, r as Bug, c as ClipboardList } from "./AppLayout-3zwW38j4.js";
...
import { B as BuyerCombobox } from "./BuyerCombobox-DJ1iuCYG.js";
...
import { C as Calendar } from "./calendar-CbA4m1-c.js";
import { T as TriangleAlert } from "./triangle-alert-CSlEeB1L.js";
import { F as File } from "./file-C6ZyArD3.js";
import { C as Camera } from "./camera-ChmqHYnr.js";
import "./select-CzAt7Wwk.js";
...
import "./command-DXoQSchK.js";
import "./chevrons-up-down-CrnXSZkw.js";
import "./user-plus-CxkCxGmp.js";
...
function VisitorTab({ farmId, farmName }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteId !== null, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteM, message: "Couldn't delete — the record is still here. Try again." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: scheduleOpen, onOpenChange: (o) => {
      if (!o) {
        ...
        setEditingSchedule(null);
        setScheduleForm(EMPTY_SCHEDULE);
        createScheduleM.reset();
        updateScheduleM.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleScheduleSubmit, className: "space-y-4 pt-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: editingSchedule ? updateScheduleM : createScheduleM, message: "Failed to save — your entries are still here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", onClick: () => {
            setScheduleOpen(false);
            setEditingSchedule(null);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteScheduleId !== null, onOpenChange: (o) => {
      if (!o) {
        setDeleteScheduleId(null);
        deleteScheduleM.reset();
      }
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteScheduleM, message: "Couldn't delete — the rule is still here. Try again." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
...
function CoshhTab({ farmId, farmName }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteId !== null, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteMut, message: "Couldn't delete — the record is still here. Try again." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setDeleteId(null), children: "Cancel" }),
