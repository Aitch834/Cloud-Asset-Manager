import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, a as useToast, t as useQueryClient, l as useQuery, O as useMutation, I as Input, c as Button, S as Plus, o as Link, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, J as DialogFooter, $ as X, d as LoaderCircle } from "./index-BKcsQW2l.js";
import { u as useLookupStrings } from "./use-lookup-D04mZguZ.js";
import { A as AppLayout, k as ShoppingBag, e as ChartColumn, Z as Zap, a as Wheat, T as TrendingUp } from "./AppLayout-B8_1RkJL.js";
...
import { F as FileText, P as PoundSterling } from "./shield-alert-CPHe-hz7.js";
...
import { A as ArrowRightLeft } from "./arrow-right-left-CbnQVrRK.js";
...
function LivestockPurchasesTab({ farmId }) {
  ...
  const createMut = useMutation({ mutationFn: (b) => fetch(`/api/farms/${farmId}/livestock-purchases`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()) });
