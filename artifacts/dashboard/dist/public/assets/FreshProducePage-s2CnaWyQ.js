const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-DrORwZwd.js","assets/index-H8kC7A26.js","assets/index-CBkBuZTA.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b3 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-H8kC7A26.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-BO58I1ZD.js";
import { L as LabSelector } from "./LabSelector-BFVGPvsn.js";
import { P as Printer } from "./printer-oGqpguPr.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-ByLPhwAa.js";
import { B as BarChart } from "./BarChart-B0O828CQ.js";
import { C as CartesianGrid } from "./CartesianGrid-B5lCiXSM.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-CbZUNmF2.js";
import { C as ChevronUp } from "./chevron-up-BCyDf8A8.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-COImDIZH.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-BJPAbu-D.js";
...
import { u as useFarmName } from "./use-farm-name-4LJm82mw.js";
import { S as StaffSelect } from "./staff-select-FkxPJnnl.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { S as ShieldAlert, D as Droplets } from "./shield-alert-HMZzOVyr.js";
import { L as LayoutGrid } from "./layout-grid-8hHLzHd3.js";
...
import { A as Archive } from "./archive-DigyItEt.js";
import "./database-D2QJ7Mco.js";
import "./shield-check-CZ3-V2RH.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-DrORwZwd.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
