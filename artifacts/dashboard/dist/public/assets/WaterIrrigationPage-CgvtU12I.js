...
import { U as UK_MONTHLY_ET0_MM_DAY, m as matchCropProfile, D as DEFAULT_FIELD_CAPACITY_MM, g as getFieldCapacity, C as CirclePlus } from "./irrigationData-BDXyAHEB.js";
import { C as CircleAlert } from "./database-CKz6hAal.js";
import { T as TriangleAlert } from "./triangle-alert-CvColeUp.js";
import { T as Thermometer } from "./thermometer-CUZCcPPT.js";
import { C as CloudRain } from "./cloud-rain-J1Wm4Uzy.js";
import { g as generateCategoricalChart, X as XAxis, Y as YAxis, f as formatAxisMap, R as ResponsiveContainer, T as Tooltip, B as Bar, C as Cell, _ as ReferenceLine } from "./generateCategoricalChart-DPBgjJuY.js";
import { B as BarChart } from "./BarChart-BK32piCc.js";
import { C as CartesianGrid } from "./CartesianGrid-BcmimiiM.js";
import { M as Minus } from "./minus-DRMfLdFR.js";
import { T as TrendingDown } from "./trending-down-pPeepEIA.js";
import { A as Area } from "./Area-BtNs0bKP.js";
import { D as Droplets } from "./shield-alert-DOmCjdKc.js";
import { T as Tractor } from "./tractor-DJVTnlj5.js";
import { F as FileCheck } from "./file-check-DDxHYKbi.js";
import { E as Eye } from "./eye-kK6jUKiZ.js";
import { P as Pencil } from "./pencil-D154XHT-.js";
import { T as Trash2 } from "./trash-2-LZF-SgtX.js";
import { P as Play } from "./play-Dif9Rnl5.js";
...
function computeForecastVerdict(opts) {
  ...
  const today = referenceDate ?? (/* @__PURE__ */ new Date()).toISOString().slice(0, 10);
  const referenceKc = hasCropTiming ? getKc(cropProfile, plantingDate, harvestDate ?? void 0, today) : 1;
  ...
  for (const day of forecastDailyMm) {
    ...
    const kc = hasCropTiming ? getKc(cropProfile, plantingDate, harvestDate ?? void 0, day.date) : 1;
...
function SmdHistoryChart({
  chartData,
  todayChartDate,
  criticalThreshold
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: chartData, margin: { top: 4, right: 8, left: 0, bottom: 0 }, children: [
      ...
      data?.forecastDailyMm && data.forecastDailyMm.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        (() => {
          ...
          const vr = computeForecastVerdict({
            ...
            referenceDate: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10)
          });
          if (!vr) return null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: !filteredIrrigRecords.length ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { msg: "No irrigation records yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filteredIrrigRecords.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 pr-3", children: fieldEditHref(r) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: fieldEditHref(r) ?? void 0,
            className: "text-green-700 underline underline-offset-2 hover:text-green-900",
            "aria-label": `Edit field ${fieldLabel(r)}`,
            children: fieldLabel(r)
          }
        ) : fieldLabel(r) }),
