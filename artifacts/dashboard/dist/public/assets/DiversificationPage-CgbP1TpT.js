import { q as createLucideIcon, b as useAppStore, r as reactExports, j as jsxRuntimeExports, R as Redirect, m as Card, n as CardContent, c as Button, S as Plus, d as LoaderCircle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, t as useQueryClient, a as useToast, l as useQuery, O as useMutation, C as Checkbox } from "./index-D3ay9Ao3.js";
import { o as openPrintWindow } from "./print-report-B_FwCCVJ.js";
import { A as AppLayout, k as ShoppingBag, _ as Crosshair, T as TrendingUp } from "./AppLayout-DRFFu3V0.js";
...
import { L as LayoutList } from "./layout-list-Dz95EAbE.js";
import { P as PoundSterling, C as ClipboardCheck } from "./shield-alert-B8JTZTuq.js";
import { P as PawPrint } from "./paw-print-DEvm7Q3o.js";
import { P as Printer } from "./printer-D5Z3uuCG.js";
import { T as TriangleAlert } from "./triangle-alert-Zhn2K0n0.js";
...
import { P as Package } from "./use-safe-clerk-CxEl63sD.js";
import { C as ChevronRight } from "./tractor-CO_kLi01.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, C as Cell } from "./generateCategoricalChart-BwSoQy17.js";
...
function useCrud(farmId, endpoint, key) {
  ...
  const save = useMutation({ mutationFn: (b) => fetch(editing ? api(`farms/${farmId}/${endpoint}/${editing.id}`) : api(`farms/${farmId}/${endpoint}`), { method: editing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(b) }), onSuccess: () => {
    qc.invalidateQueries({ queryKey: [key, farmId] });
    setOpen(false);
    setForm({});
    setEditing(null);
  }, onError: () => toast({ title: "Save failed", variant: "destructive" }) });
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/${endpoint}/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: [key, farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
...
function FarmShopTab({ farmId }) {
  ...
  const saveProd = useMutation({
    mutationFn: (b) => fetch(prodEditing ? api(`farms/${farmId}/farm-shop-products/${prodEditing.id}`) : api(`farms/${farmId}/farm-shop-products`), { method: prodEditing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(b) }),
    onSuccess: () => {
  ...
  const delProd = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/farm-shop-products/${id}`), { method: "DELETE", credentials: "include" }),
  ...
  const adjustStock = useMutation({
    mutationFn: ({ id, adjustment }) => fetch(api(`farms/${farmId}/shop-products/${id}/adjust-stock`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ adjustment }) }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["shop-products", farmId] });
      setStockTarget(null);
      setStockQty("");
  ...
  const delSession = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/shop-sales/${id}`), { method: "DELETE", credentials: "include" }),
  ...
  const saveSupp = useMutation({
    mutationFn: (b) => fetch(suppEditing ? api(`farms/${farmId}/shop-suppliers/${suppEditing.id}`) : api(`farms/${farmId}/shop-suppliers`), { method: suppEditing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(b) }),
    onSuccess: () => {
  ...
  const toggleSuppActive = useMutation({
    mutationFn: ({ id, active }) => fetch(api(`farms/${farmId}/shop-suppliers/${id}/${active ? "reactivate" : "deactivate"}`), { method: "PATCH", credentials: "include" }),
  ...
  const savePurch = useMutation({
    mutationFn: (b) => fetch(purchEditing ? api(`farms/${farmId}/shop-purchases/${purchEditing.id}`) : api(`farms/${farmId}/shop-purchases`), { method: purchEditing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(b) }),
    onSuccess: () => {
  ...
  const delPurch = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/shop-purchases/${id}`), { method: "DELETE", credentials: "include" }),
  ...
  const createStocktakeMut = useMutation({
    mutationFn: (body) => fetch(api(`farms/${farmId}/farm-shop/stocktakes`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (data) => {
  ...
  const updateStocktakeItemMut = useMutation({
    mutationFn: ({ sessionId, itemId, countedQty }) => fetch(api(`farms/${farmId}/farm-shop/stocktakes/${sessionId}/items/${itemId}`), { method: "PATCH", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ countedQty }) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const completeStocktakeMut = useMutation({
    mutationFn: (sessionId) => fetch(api(`farms/${farmId}/farm-shop/stocktakes/${sessionId}/complete`), { method: "POST", credentials: "include" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["shop-stocktakes", farmId] });
      qc.invalidateQueries({ queryKey: ["shop-stocktake-detail", farmId, activeStocktakeId] });
      qc.invalidateQueries({ queryKey: ["shop-products", farmId] });
  ...
  const deleteStocktakeMut = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/farm-shop/stocktakes/${id}`), { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["shop-stocktakes", farmId] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          products.map((p, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-2 text-right space-x-1 whitespace-nowrap", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", onClick: () => showConfirm("Delete Product", "Remove this product from the catalogue? Stock history and purchase records will be retained.", () => delProd.mutate(p.id), { confirmLabel: "Delete", variant: "destructive" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3.5 h-3.5 text-red-500" }) })
              ] })
            ] }, i);
          }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 bg-muted/30 cursor-pointer", onClick: () => setExpandedSessions((prev) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", className: "h-7 w-7", onClick: (e) => {
                e.stopPropagation();
                showConfirm("Delete Sales Session", "This session and all its line items will be removed. Stock levels will be restored to pre-sale quantities.", () => delSession.mutate(sess.id), { confirmLabel: "Delete", variant: "destructive" });
      ...
      purchLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin w-5 h-5" }) : purchases.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { msg: "No purchases recorded. Hit 'Record Purchase' to log your first order." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: purchases.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", className: "h-7 w-7", onClick: () => showConfirm("Delete Purchase", "Remove this purchase record? Note: any stock that was added when this was logged will not be automatically reversed.", () => delPurch.mutate(p.id), { confirmLabel: "Delete", variant: "destructive" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3.5 h-3.5 text-red-400" }) })
          ] }) })
        ] }, i)) })
      ] }) })
    ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: stocktakes.map((s) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0 hover:bg-muted/30 cursor-pointer", onClick: () => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
                ...
                isDraft && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", className: "h-7 w-7", onClick: () => showConfirm("Delete Stocktake", "Delete this draft stocktake? All counts entered so far will be lost.", () => deleteStocktakeMut.mutate(s.id), { confirmLabel: "Delete", variant: "destructive" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3.5 h-3.5 text-red-400" }) })
              ] }) })
            ] }, s.id);
          }) })
        ] }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: prodOpen, onOpenChange: setProdOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "40rem" }, children: [
...
function EquineTab({ farmId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(DataTable, { cols: [{ key: "horseName", label: "Name" }, { key: "breed", label: "Breed" }, { key: "sex", label: "Sex" }, { key: "passportNumber", label: "Passport No." }, { key: "microchipNumber", label: "Microchip" }, { key: "ownerName", label: "Owner" }, { key: "liveryType", label: "Livery Type" }, { key: "box", label: "Box" }], rows: horses, onView: setViewRecord, onEdit: (r) => openEdit(r), onDelete: (r) => del.mutate(r.id) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-3", children: [
      ...
      evL ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(DataTable, { cols: [{ key: "eventDate", label: "Date", fmt: (r) => fmtDate(r.eventDate) }, { key: "eventType", label: "Type" }, { key: "vetOrFarrierName", label: "Vet / Farrier" }, { key: "treatmentGiven", label: "Treatment" }, { key: "productUsed", label: "Product" }, { key: "cost", label: "Cost (£)" }], rows: events, onView: setViewEvent, onDelete: (r) => evDel.mutate(r.id) })
    ] }),
    viewRecord && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => setViewRecord(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "42rem" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: evOpen, onOpenChange: setEvOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "36rem" }, children: [
...
function IncomeTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/diversification-income/${id}`), { method: "DELETE", credentials: "include" }),
...
function DiversificationPage() {
  ...
  const [tab, setTab] = reactExports.useState(() => {
    ...
    const t = p.get("tab");
    const valid = ["activities", "income", "shop", "hygiene", "equine", "shooting", "analytics"];
    return t && valid.includes(t) ? t : "activities";
  });
