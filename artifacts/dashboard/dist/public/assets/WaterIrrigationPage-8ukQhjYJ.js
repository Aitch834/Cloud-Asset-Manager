import { s as createLucideIcon, r as reactExports, m as useQuery, j as jsxRuntimeExports, L as Label, e as LoaderCircle, I as Input, b as useAppStore, R as Redirect, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, C as Checkbox, N as DialogMutationError } from "./index-CWg1uz92.js";
import { R as RaiseTaskDialog } from "./RaiseTaskDialog-D9oV5Sqr.js";
import { S as Sprout, e as ChartColumn, G as Gauge, T as TrendingUp, I as Info, A as AppLayout, c as ClipboardList } from "./AppLayout-CFywKxqu.js";
...
import { a as usePersistedFilter } from "./use-persisted-filter-BNIOyBBv.js";
...
import { C as CircleAlert } from "./database-CCp5Ra3z.js";
import { T as Thermometer } from "./thermometer-BiEF2nCu.js";
import { C as CloudRain } from "./cloud-rain-D_hCJx-7.js";
import { g as generateCategoricalChart, X as XAxis, Y as YAxis, f as formatAxisMap, R as ResponsiveContainer, T as Tooltip, _ as ReferenceLine } from "./generateCategoricalChart-Bzx1Xd_g.js";
import { A as Area } from "./Area-CdWWMaCp.js";
import { C as CartesianGrid } from "./CartesianGrid-CiaB7N73.js";
import { M as Minus } from "./minus-Dw3Ky9qu.js";
import { T as TrendingDown } from "./trending-down-DgaaGgpo.js";
import { D as Droplets } from "./shield-alert-Dw4nlDq_.js";
import { T as Tractor } from "./tractor-Bpekk4J1.js";
import { T as TriangleAlert } from "./triangle-alert-ChBFCAPt.js";
import { F as FileCheck } from "./file-check-DBYrp8zh.js";
...
function computeScenarios(opts) {
  ...
  function simulate(irrigateAtDay) {
    ...
    for (let day = 0; day < HORIZON; day++) {
      ...
      sumEtaEtm += etaEtm;
      smd = clamp(smd + currentDailyEtcMm - dailyRainMm);
    }
    return {
      day14Smd: smd,
...
function collapseReadings(readings) {
  ...
  for (const r of readings) {
    ...
    if (!byDate[date]) byDate[date] = { allTemps: [], rainfalls: [] };
    ...
    const isTemp = cat === "temperature" || cat === "weather" && (param === "air_temperature" || param === "air temperature");
    const isRain = cat === "rainfall" || cat === "precipitation" || cat === "weather" && (param === "rainfall" || param === "precipitation") || cat !== "weather" && (param.includes("rain") || param.includes("precip"));
    if (isTemp) byDate[date].allTemps.push(val);
    if (isRain) byDate[date].rainfalls.push(val);
  }
  return Object.entries(byDate).sort(([a], [b]) => a.localeCompare(b)).map(([date, { allTemps, rainfalls }]) => ({
    date,
    // Hargreaves-Samani needs daily Tmax and Tmin; derive from all intra-day samples
    tmax: allTemps.length ? Math.max(...allTemps) : void 0,
    tmin: allTemps.length ? Math.min(...allTemps) : void 0,
