import { b as useAppStore, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, B as Building2, L as Label, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, I as Input, N as DialogMutationError, J as DialogFooter } from "./index-D5ac2D7t.js";
...
function shouldShowMissingLevyWarning(config, summary, selectedYear, currentYear = (/* @__PURE__ */ new Date()).getFullYear()) {
  return selectedYear === currentYear && summary?.year === selectedYear && (config.type === "levy" || config.type === "statutory") && !Object.prototype.hasOwnProperty.call(summary.totalsPerBody, config.body);
}
      ...
      activeTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4", children: bodies.map((cfg) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-4 space-y-2 bg-card", children: [
            ...
            hasNoRecordsThisYear && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 rounded-md bg-amber-50 px-2.5 py-2 text-xs text-amber-800", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3.5 w-3.5 shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "No records this year — is this correct?" })
            ] }),
