import { s as createLucideIcon, b as useAppStore, j as jsxRuntimeExports, R as Redirect, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, l as cn, aM as toast, X, T as Plus, n as Card, u as useLocation } from "./index-BjPqi5IF.js";
import { A as AppLayout, d as Wrench, j as Truck, C as CalendarDays, c as ClipboardList, R as RotateCcw } from "./AppLayout-Bicu0xBR.js";
import { u as usePersistedTab } from "./use-persisted-tab-YyABCvlm.js";
import { u as useSensors, a as useSensor, D as DndContext, b as DragOverlay, G as GripVertical, P as PointerSensor, c as useDroppable, d as useDraggable } from "./core.esm-BzvA74OD.js";
...
import { S as Sparkles } from "./sparkles-CYw1cL_t.js";
...
function PlanningStatusTab({ farmId }) {
  ...
  const overdueMilestones = reactExports.useMemo(
    () => milestones.filter(
      (m) => m.dueDate && /* @__PURE__ */ new Date(m.dueDate + "T12:00:00") < today && m.status !== "submitted" && m.status !== "paid"
    ),
    [milestones, today]
  );
