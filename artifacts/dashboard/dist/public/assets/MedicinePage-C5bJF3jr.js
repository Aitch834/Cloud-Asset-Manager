import { b as useAppStore, j as jsxRuntimeExports, R as Redirect, t as useQueryClient, a as useToast, r as reactExports, l as useQuery, O as useMutation, c as Button, I as Input, S as Plus, d as LoaderCircle, m as Card, n as CardContent, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, Q as React, $ as X } from "./index-C3jhrBt5.js";
...
import { A as AppLayout, H as HeartPulse, c as ClipboardList, U as Users, I as Info } from "./AppLayout-vONHBQWP.js";
...
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-Bz0MrTCe.js";
...
import { T as Tag } from "./tag-CYK1wPAO.js";
import { U as User } from "./user-mG9jwN3D.js";
import { B as BadgeCheck } from "./badge-check-J-c76vbt.js";
import { S as ShieldAlert } from "./shield-alert-B-nfuXQr.js";
import { R as ResponsiveContainer, C as Cell, T as Tooltip, L as Legend, X as XAxis, Y as YAxis, B as Bar } from "./generateCategoricalChart-BBhaWXxI.js";
...
function MedicineRegisterContent({ farmId }) {
  ...
  const createM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/medicine-records`, { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/medicine-records/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["medicine-records", farmId] });
      closeForm();
  ...
  const deleteM = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/medicine-records/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["medicine-records", farmId] });
      setDeleteId(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!pendingBodyWithUnmatched, onOpenChange: () => setPendingBodyWithUnmatched(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "30rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!deleteId, onOpenChange: () => setDeleteId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "28rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
