const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-C9s166Vh.js","assets/index-Bt49Vuc8.js","assets/index-BqyJtWxe.css","assets/typeof-WJl3ipnu.js","assets/browser-BlOK38Vy.js"])))=>i.map(i=>d[i]);
import { r as reactExports, m as useQuery, j as jsxRuntimeExports, b as useAppStore, R as Redirect, b5 as formatAlertIssuedAt, d as Button, e as LoaderCircle, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, N as DialogMutationError, C as Checkbox, _ as __vitePreload, M as MapPin } from "./index-Bt49Vuc8.js";
...
import { T as TrendingUp, A as AppLayout, Q as LayoutDashboard, V as PiggyBank, j as Truck, k as Stethoscope, f as Scale, c as ClipboardList } from "./AppLayout-Ba5OirH6.js";
...
import { S as ShieldAlert, F as FileText, C as ClipboardCheck } from "./shield-alert-BNeNt00B.js";
import { P as Pill } from "./pill-DrmO-mJk.js";
import { U as UtensilsCrossed } from "./utensils-crossed-DEMYij0c.js";
import { T as TriangleAlert } from "./triangle-alert-BcBj2QVV.js";
import { B as Baby } from "./baby-CwbxKC21.js";
import { S as ShieldCheck } from "./shield-check-OBBp21kx.js";
import { S as Syringe } from "./syringe-DF1ufUiP.js";
import { A as Activity } from "./activity-DsYBPw2g.js";
...
import { a as Clock } from "./database-CtsfUahs.js";
...
function PigEnterpriseReport({ farmId }) {
  ...
  const [year, setYear] = usePersistedNumberFilter({ page: "pig-enterprise-report", filter: "year", farmId, defaultValue: currentYear });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: reportRef, className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3 no-print", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => printElementReport(reportRef.current, { title: "Pig Enterprise Report", subtitle: `${year} enterprise analysis`, farmName }), className: "h-9 px-3 rounded-lg border border-border bg-background text-sm flex items-center gap-1.5 hover:bg-muted/50", children: [
...
function KillRecordsTab({ farmId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ConfirmDialog, { open: confirmDelete !== null, title: "Delete Kill Record", message: "Delete this kill record? This cannot be undone.", confirmLabel: "Delete", confirmVariant: "destructive", mutation: del, onConfirm: () => {
...
async function generatePigAuditPDF(farmId) {
  const [jsPDFModule, autoTableModule] = await Promise.all([__vitePreload(() => import("./jspdf.es.min-C9s166Vh.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0), __vitePreload(() => import("./jspdf.plugin.autotable-rNuKHwSj.js"), true ? [] : void 0)]);
...
function PigAnalyticsTab({ farmId }) {
  ...
  const availableYears = reactExports.useMemo(() => {
    ...
    farrowing.forEach((r) => {
      ...
      if (y > 2e3) years.add(y);
    });
    return [...years].sort((a, b) => b - a);
  }, [farrowing]);
  const [selectedYear, setSelectedYear] = usePersistedNumberFilter({ page: "pig-analytics", filter: "year", farmId, defaultValue: currentYear, isValid: (y) => y > 2e3 && y <= currentYear + 1 });
  const [compareYear, setCompareYear] = reactExports.useState(null);
  reactExports.useEffect(() => {
    setCompareYear((prev) => prev === selectedYear ? null : prev);
  }, [selectedYear]);
  const farrowingFiltered = reactExports.useMemo(
    () => farrowing.filter((r) => String(r.farrowingDate || r.date || "").startsWith(String(selectedYear))),
    [farrowing, selectedYear]
  );
  const farrowingCompare = reactExports.useMemo(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
      farrowingByMonth.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-xl p-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: farrowingByMonth, margin: { left: 0, right: 8, top: 4, bottom: 4 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { yAxisId: "left", dataKey: "bornAlive", name: `${selectedYear} Born Alive`, fill: COMPARE_COLORS[0], radius: [3, 3, 0, 0] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { yAxisId: "left", dataKey: "weaned", name: `${selectedYear} Weaned`, fill: "#a16207", radius: [3, 3, 0, 0] }),
          compareYear && /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { yAxisId: "left", dataKey: "bornAlive_cmp", name: `${compareYear} Born Alive`, fill: COMPARE_COLORS[1], radius: [3, 3, 0, 0] }),
          compareYear && /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { yAxisId: "left", dataKey: "weaned_cmp", name: `${compareYear} Weaned`, fill: "#fb923c", radius: [3, 3, 0, 0] })
        ] }) }) })
      ] }),
...
function PigProductionPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Pig Production", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    pigAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm ${pigAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : pigAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "w-4 h-4 mt-0.5 shrink-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: pigAlert.level === "national" ? "National Pig Disease Alert" : pigAlert.level === "regional" ? "Regional Pig Disease Alert" : "Pig Disease Notice" }),
        pigAlert.message && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2", children: pigAlert.message }),
        (pigAlert.issuedAt || pigAlert.date) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 opacity-70 text-xs", children: formatAlertIssuedAt(pigAlert.issuedAt, pigAlert.date) })
      ] })
    ] }),
