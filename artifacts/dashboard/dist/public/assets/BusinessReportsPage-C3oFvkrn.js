import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, d as Button, m as useQuery } from "./index-CWg1uz92.js";
...
import { A as AppLayout, e as ChartColumn, T as TrendingUp } from "./AppLayout-CFywKxqu.js";
...
import { P as PoundSterling } from "./shield-alert-Dw4nlDq_.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    agriEnvProjects.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          agriEnvProjects.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: i < agriEnvProjects.length - 1 ? "1px solid #f3f4f6" : "none" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "0.6rem 0.875rem", fontWeight: 500 }, children: p.schemeName }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.75rem", color: "#9ca3af", marginTop: 6 }, children: "Showing all agri-environment agreements except withdrawn ones. Grant values are pulled automatically from the Agri-environment tab." })
    ] }),
