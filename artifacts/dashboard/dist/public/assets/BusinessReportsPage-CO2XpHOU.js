import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, d as Button, m as useQuery } from "./index-D6khxeYT.js";
...
import { A as AppLayout, e as ChartColumn, T as TrendingUp } from "./AppLayout-BaRj1j3r.js";
...
import { P as PoundSterling } from "./shield-alert-1XoYdT77.js";
...
import { T as Tractor } from "./tractor-Dqfi2I92.js";
...
function PLTab({ farmId, year, onRegisterExport }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    hasDoubleCountRisk && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fffbeb", border: "1px solid #fcd34d", borderRadius: 8, padding: "0.75rem 1rem", marginBottom: 16, display: "flex", gap: 10, alignItems: "flex-start" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: "#78350f", fontSize: "0.8rem" }, children: [
          ...
          " financial transaction and agri-env project records in ",
          year,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
      ...
      agriEnvYearTotal > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { background: "#f0fdf4" }, children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "tr",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "0.6rem 0.875rem", fontWeight: 500 }, children: p.totalGrantValuePence != null ? fmt(p.totalGrantValuePence) : "—" }),
              ...
              isExpanded && pMilestones.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { background: "#f9fafb" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, style: { padding: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "0.8rem" }, children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: pMilestones.map((ms, mi) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: mi < pMilestones.length - 1 ? "1px solid #f3f4f6" : "none" }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "0.45rem 0.875rem", color: "#6b7280", whiteSpace: "nowrap" }, children: ms.completionDate ? new Date(ms.completionDate).toLocaleDateString("en-GB") : "—" }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { style: { padding: "0.45rem 0.875rem" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.7rem", fontWeight: 600, padding: "2px 7px", borderRadius: 20, textTransform: "capitalize", ...msStatusStyle(ms.status) }, children: ms.status }),
                        ms.status !== "submitted" && ms.status !== "paid" && ms.claimAmountPence != null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: 6, fontSize: "0.7rem", color: "#b45309" }, children: "outstanding" })
                      ] })
                    ] }, ms.id)) })
                  ] }) })
                ] }),
