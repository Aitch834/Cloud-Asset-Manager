const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-B_yFMs3j.js","assets/index-NR-SGw0i.js","assets/index-CAOhs4IG.css","assets/typeof-WJl3ipnu.js"])))=>i.map(i=>d[i]);
import { r as reactExports, m as useQuery, j as jsxRuntimeExports, b as useAppStore, R as Redirect, d as Button, e as LoaderCircle, n as Card, o as CardContent, c as useQueryClient, a as useToast, O as useMutation, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, X as DialogMutationError, C as Checkbox, _ as __vitePreload, M as MapPin } from "./index-NR-SGw0i.js";
import { u as usePersistedTab } from "./use-persisted-tab-D4uQI4FI.js";
import { o as openPrintWindow } from "./print-report-B_FwCCVJ.js";
import { D as DocAttach } from "./DocAttach-DXr4lg6T.js";
import { P as Printer } from "./printer-CxrzQsyy.js";
import { T as TrendingUp, A as AppLayout, Q as LayoutDashboard, V as PiggyBank, j as Truck, k as Stethoscope, f as Scale, c as ClipboardList } from "./AppLayout-Cd3p4pui.js";
import { T as TrendingDown } from "./trending-down-4pr0_qth.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar, C as Cell } from "./generateCategoricalChart-NdsfRrIZ.js";
...
import { P as Pill } from "./pill-qdDCGe_B.js";
import { F as FileText, C as ClipboardCheck } from "./shield-alert-613BeFwq.js";
import { U as UtensilsCrossed } from "./utensils-crossed-B5sgjPEu.js";
import { T as TriangleAlert } from "./triangle-alert-CoxyMuM1.js";
import { B as Baby } from "./baby-_pbVyF8D.js";
import { S as ShieldCheck } from "./shield-check-CO5y2JJE.js";
import { S as Syringe } from "./syringe-Cy_6Z2ro.js";
import { A as Activity } from "./activity-DsyJdGlp.js";
...
async function generatePigAuditPDF(farmId) {
  const [jsPDFModule, autoTableModule] = await Promise.all([__vitePreload(() => import("./jspdf.es.min-B_yFMs3j.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), __vitePreload(() => import("./jspdf.plugin.autotable-rNuKHwSj.js"), true ? [] : void 0)]);
...
function SalmonellaMonitoringTab({ farmId }) {
  ...
  async function del(id) {
    ...
    await fetch(apiUrl(`farms/${farmId}/pig-salmonella-monitoring/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function PigVaccinationTab({ farmId }) {
  ...
  async function del(id) {
    ...
    await fetch(apiUrl(`farms/${farmId}/pig-vaccination-records/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function PigDiseaseMonitoringTab({ farmId }) {
  ...
  async function del(id) {
    ...
    await fetch(apiUrl(`farms/${farmId}/pig-disease-monitoring/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
