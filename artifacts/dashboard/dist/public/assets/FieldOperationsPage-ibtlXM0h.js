import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, l as useQuery, O as useMutation, j as jsxRuntimeExports, c as Button, S as Plus, I as Input, Q as React, M as MapPin, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label } from "./index-C3jhrBt5.js";
import { A as AppLayout, m as Shovel, C as CalendarDays, d as Wrench } from "./AppLayout-vONHBQWP.js";
import { T as Textarea } from "./textarea-Bg3GXNaK.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, g as SelectSeparator, e as SelectGroup, f as SelectLabel } from "./select-DpflwIBv.js";
...
import { U as UserCheck } from "./user-check-B9_ez9je.js";
import { a as Clock } from "./database-D-yt_-ll.js";
import { P as PoundSterling } from "./shield-alert-B-nfuXQr.js";
...
function FieldOperationsPage() {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/field-operations/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["field-operations", farmId] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Field Operations", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showDialog, onOpenChange: setShowDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "42rem" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: confirmDelete !== null, onOpenChange: () => setConfirmDelete(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "24rem" }, children: [
