import { a as useToast, c as useQueryClient, b as useAppStore, u as useLocation, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, e as LoaderCircle, X, A as ArrowRight, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, I as Input, N as DialogMutationError } from "./index-DkPmuGTu.js";
import { a as usePersistedFilter } from "./use-persisted-filter-D9iIURiC.js";
import { A as AppLayout, I as Info, C as CalendarDays, c as ClipboardList, s as AlertDialog, t as AlertDialogContent, v as AlertDialogHeader, w as AlertDialogTitle, x as AlertDialogDescription, y as AlertDialogFooter, z as AlertDialogCancel, D as AlertDialogAction } from "./AppLayout-qUltwIkA.js";
...
import { P as PoundSterling, F as FileText } from "./shield-alert-DxQ0cuRr.js";
      ...
      (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.8rem", fontWeight: 700, color: "#059669", textTransform: "uppercase", letterSpacing: "0.05em" }, children: "Farm-wide Drawdown" }),
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: 60, color: "#9ca3af" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 24, className: "animate-spin", style: { display: "inline" } }) }) : projects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "48px 24px", background: "#f9fafb", borderRadius: 10, border: "1px dashed #e5e7eb" }, children: [
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }, children: [
          ...
          isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid #f3f4f6", background: "#fafafa", padding: "12px 16px" }, children: [
            ...
            milestones.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: "20px 12px", color: "#9ca3af", fontSize: "0.82rem" }, children: "No milestones recorded yet — add one to track claim dates and evidence." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: milestones.map((m) => {
              const isPending = pendingCompletion?.milestoneId === m.id;
              const isUpdating = updatingMilestone === m.id;
              const needsDate = (s) => (s === "submitted" || s === "paid") && !m.completionDate;
...
function GrantsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1200, margin: "0 auto", padding: "24px 16px" }, children: [
    ...
    mainTab === "capital" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      exportFilteredRecords.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grants-cap-print", style: { display: "none" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontFamily: "Georgia, serif", color: "#111827", padding: "0 0 24px" }, children: [
