...
import { r as reactExports, m as useQuery, j as jsxRuntimeExports, b as useAppStore, R as Redirect, d as Button, e as LoaderCircle, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, N as DialogMutationError, C as Checkbox, _ as __vitePreload, M as MapPin } from "./index-1TyBJonr.js";
...
import { T as TrendingUp, A as AppLayout, Q as LayoutDashboard, V as PiggyBank, j as Truck, k as Stethoscope, f as Scale, c as ClipboardList } from "./AppLayout-Ct04za5p.js";
...
import { S as ShieldAlert, F as FileText, C as ClipboardCheck } from "./shield-alert-HvE4k3Y1.js";
...
import { B as Baby } from "./baby-Ds7Y5e7b.js";
...
async function generatePigAuditPDF(farmId) {
  const [jsPDFModule, autoTableModule] = await Promise.all([__vitePreload(() => import("./jspdf.es.min-D3T-2UxA.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), __vitePreload(() => import("./jspdf.plugin.autotable-rNuKHwSj.js"), true ? [] : void 0)]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Pig Production", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    pigAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm ${pigAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : pigAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        pigAlert.date && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 opacity-70 text-xs", children: [
          "Issued ",
          pigAlert.date
        ] })
      ] })
