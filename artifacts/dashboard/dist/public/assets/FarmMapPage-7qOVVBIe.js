...
import { b as useAppStore, r as reactExports, l as useQuery, j as jsxRuntimeExports, K as Map, o as Link, m as Card, I as Input, B as Building2, T as FlaskConical, M as MapPin, _ as __vitePreload } from "./index-DMNkf8lm.js";
import { A as AppLayout, O as Settings, W as Warehouse, g as TreePine, U as Users } from "./AppLayout-BTePU50s.js";
...
import { L as LayoutGrid } from "./layout-grid-C23ne6Zl.js";
...
function useFarmMap(containerRef, locations, onSelect) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-Jmw_QMNN.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
