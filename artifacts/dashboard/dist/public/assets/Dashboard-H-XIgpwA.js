import { r as reactExports, f as useControllableState, j as jsxRuntimeExports, P as Primitive, g as composeEventHandlers, h as Presence, i as createContextScope, k as useComposedRefs, D as DismissableLayer, l as cn, m as useQuery, n as Card, o as Link, p as CardContent, A as ArrowRight, b as useAppStore, q as useGetFarmActivity, R as Redirect, M as MapPin } from "./index-B1C3mzZ2.js";
import { C as CalendarDays, L as Landmark, S as Sprout, W as Warehouse, u as useUserRole, A as AppLayout, a as Wheat, b as Layers, c as ClipboardList, d as Wrench, e as ChartColumn } from "./AppLayout-A41ldoN7.js";
import { R as Root2$1, A as Anchor, c as createPopperScope, C as Content, a as Arrow } from "./index-BJQbCAmV.js";
import { T as TriangleAlert, L as Leaf } from "./triangle-alert-BUadPAGV.js";
import { S as ShieldCheck } from "./shield-check-BBN7XEcX.js";
import { E as ExternalLink } from "./external-link-DaMYhdml.js";
import { T as Tag } from "./tag-CFrz_uIX.js";
import { D as Droplets, F as FileText, C as ClipboardCheck, S as ShieldAlert, G as GraduationCap } from "./shield-alert-sO4r6egV.js";
...
import { T as Tractor } from "./tractor-CA-CFIge.js";
import { P as PawPrint } from "./paw-print-T6VHrNiQ.js";
import { C as ChartLine } from "./chart-line-Y-MZvFGZ.js";
import { C as CloudRain } from "./cloud-rain-W0jdRfdh.js";
import "./trash-2-DEs9ufEd.js";
...
const ORGANIC_COMPLIANCE_MODULE_KEY = "organic-compliance";
function hasOrganicComplianceModule(activeSubscriptions) {
  return activeSubscriptions.includes(ORGANIC_COMPLIANCE_MODULE_KEY);
}
function daysUntil$1(dateStr, today) {
  const dueDate = new Date(dateStr);
  dueDate.setHours(0, 0, 0, 0);
  const currentDate = new Date(today);
  currentDate.setHours(0, 0, 0, 0);
  return Math.round((dueDate.getTime() - currentDate.getTime()) / 864e5);
}
function getOrganicInspectionAlerts(records, today = /* @__PURE__ */ new Date()) {
  const currentDate = new Date(today);
  currentDate.setHours(0, 0, 0, 0);
  const in60Days = new Date(currentDate.getTime() + 60 * 24 * 60 * 60 * 1e3);
  const latestByCertifier = /* @__PURE__ */ new Map();
  for (const record of records) {
    const existing = latestByCertifier.get(record.certifier);
    if (!existing || record.inspectionDate && (!existing.inspectionDate || record.inspectionDate > existing.inspectionDate)) {
      latestByCertifier.set(record.certifier, record);
    }
  }
  return Array.from(latestByCertifier.values()).filter((record) => record.nextDueDate != null).map((record) => ({
    ...record,
    days: daysUntil$1(record.nextDueDate, currentDate)
  })).filter((record) => {
...
function organicInspectionAlertQueryOptions(farmId) {
  return {
...
function OrganicInspectionAlertPanel({ farmId }) {
  const { data } = useQuery(organicInspectionAlertQueryOptions(farmId));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(OrganicInspectionAlertContent, { records: data?.records });
}
function OrganicInspectionAlertContent({
  records
}) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: `border-l-4 ${overdueCount > 0 ? "border-l-red-400" : isUrgent ? "border-l-amber-400" : "border-l-green-400"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 border-b border-border flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        overdueCount > 0 || isUrgent ? /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: `w-4 h-4 ${overdueCount > 0 ? "text-red-500" : "text-amber-500"}` }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-4 h-4 text-green-600" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-base", children: "Organic Inspection Due" }),
        overdueCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold px-2 py-0.5 rounded-full bg-red-100 text-red-700", children: [
          overdueCount,
          " overdue"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { href: "/organic?tab=inspections", className: "text-xs text-primary font-medium inline-flex items-center gap-1 hover:underline", children: [
        "View register ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-3 h-3" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: alerts.slice(0, 3).map((alert) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "/organic?tab=inspections", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-6 py-4 flex items-center justify-between gap-4 hover:bg-black/[0.02] transition-colors cursor-pointer group ${overdue ? "bg-red-50/30" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${overdue ? "bg-red-100" : isUrgent ? "bg-amber-50" : "bg-green-50"}`, children: overdue || isUrgent ? /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: `w-4 h-4 ${overdue ? "text-red-500" : "text-amber-500"}` }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-4 h-4 text-green-600" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm font-semibold truncate ${overdue ? "text-red-800" : "text-foreground"}`, children: alert.certifier }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: `text-xs mt-0.5 ${overdue ? "text-red-600 font-medium" : dueToday ? "text-amber-600 font-medium" : "text-foreground/50"}`, children: [
                overdue ? "Overdue — was due" : "Next inspection due",
                " ",
                dueDateStr
              ] })
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-bold px-2.5 py-1 rounded-full whitespace-nowrap ${overdue ? "bg-red-100 text-red-700" : dueToday ? "bg-amber-100 text-amber-700" : alert.days <= 14 ? "bg-amber-50 text-amber-700" : "bg-green-50 text-green-700"}`, children: overdue ? `${Math.abs(alert.days)}d overdue` : dueToday ? "Today" : `${alert.days}d` }),
      ...
      alerts.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-3 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { href: "/organic?tab=inspections", className: "text-xs text-primary hover:underline underline-offset-2", children: [
        "View all ",
        alerts.length,
...
function UpcomingDatesPanel({ farmId, activeSubs }) {
  ...
  const organicInspections = organicInspectionsQ.data?.records ?? [];
  ...
  for (const pol of insurance) {
    ...
    const daysUntil2 = Math.ceil((expiry.getTime() - now.getTime()) / (1e3 * 60 * 60 * 24));
    items.push({
  ...
  for (const grant of activeGrants) {
    if (grant.purchaseDeadline) {
      ...
      if (d <= in60Days) {
        const daysUntil2 = Math.ceil((d.getTime() - now.getTime()) / (1e3 * 60 * 60 * 24));
        items.push({ label: `${grant.schemeName} — purchase deadline`, date: d, daysUntil: daysUntil2, href: "/grants", type: "Grant", urgent: daysUntil2 <= 14 });
      }
    }
    if (grant.claimDeadline) {
      ...
      if (d <= in60Days) {
        const daysUntil2 = Math.ceil((d.getTime() - now.getTime()) / (1e3 * 60 * 60 * 24));
        items.push({ label: `${grant.schemeName} — claim deadline`, date: d, daysUntil: daysUntil2, href: "/grants", type: "Grant", urgent: daysUntil2 <= 14 });
      }
    }
  }
  for (const c of calvings) {
    ...
    if (!c.calfEarTag && tag1Deadline <= in60Days) {
      const daysUntil2 = Math.ceil((tag1Deadline.getTime() - now.getTime()) / (1e3 * 60 * 60 * 24));
      items.push({ label: `Calf tag 1 deadline${dam}`, date: tag1Deadline, daysUntil: daysUntil2, href: "/dairy", type: "Calving", urgent: true });
    }
    if (!c.calfEarTag2 && tag2Deadline <= in60Days) {
      const daysUntil2 = Math.ceil((tag2Deadline.getTime() - now.getTime()) / (1e3 * 60 * 60 * 24));
      items.push({ label: `Calf tag 2 deadline${dam}`, date: tag2Deadline, daysUntil: daysUntil2, href: "/dairy", type: "Calving", urgent: daysUntil2 <= 3 });
    }
  }
  ...
  const latestInspectionByCertifier = /* @__PURE__ */ new Map();
  for (const inspection of organicInspections) {
    const existing = latestInspectionByCertifier.get(inspection.certifier);
    if (!existing || inspection.inspectionDate && (!existing.inspectionDate || inspection.inspectionDate > existing.inspectionDate)) {
...
function FpDerogationAlertsPanel({ farmId }) {
  const { data } = useQuery({
    queryKey: ["week-ahead-fp-derog", farmId],
    queryFn: () => fetch(`/api/farms/${farmId}/week-ahead?days=60`, { credentials: "include" }).then((r) => r.json()),
    staleTime: 5 * 6e4,
    enabled: !!farmId
  });
  const alerts = (data?.tasks ?? []).filter((t) => t.type === "organic_fp_derogation_expiry").map((t) => ({ ...t, days: daysUntil(t.dueDate) })).sort((a, b) => a.days - b.days);
  if (alerts.length === 0) return null;
  const overdueCount = alerts.filter((a) => a.days < 0).length;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: `border-l-4 ${overdueCount > 0 ? "border-l-red-400" : "border-l-amber-400"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 border-b border-border flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: `w-4 h-4 ${overdueCount > 0 ? "text-red-500" : "text-amber-500"}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-base", children: "FP Input Derogations Expiring" }),
        overdueCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold px-2 py-0.5 rounded-full bg-red-100 text-red-700", children: [
          overdueCount,
          " expired"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { href: "/organic-fresh-produce?tab=input-derogations", className: "text-xs text-primary font-medium inline-flex items-center gap-1 hover:underline", children: [
        "View all ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-3 h-3" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: alerts.slice(0, 5).map((alert) => {
        const overdue = alert.days < 0;
        const dueToday = alert.days === 0;
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "/organic-fresh-produce?tab=input-derogations", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-6 py-4 flex items-center justify-between gap-4 hover:bg-black/[0.02] transition-colors cursor-pointer group ${overdue ? "bg-red-50/30" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${overdue ? "bg-red-100" : "bg-amber-50"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: `w-4 h-4 ${overdue ? "text-red-500" : "text-amber-500"}` }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm font-semibold truncate ${overdue ? "text-red-800" : "text-foreground"}`, children: alert.title.replace(/^Overdue:\s*/i, "") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: `text-xs font-medium mt-0.5 flex items-center gap-1 ${overdue ? "text-red-600" : dueToday ? "text-amber-600" : "text-foreground/50"}`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-bold px-2.5 py-1 rounded-full whitespace-nowrap ${overdue ? "bg-red-100 text-red-700" : dueToday ? "bg-amber-100 text-amber-700" : alert.days <= 14 ? "bg-amber-50 text-amber-700" : "bg-amber-50/60 text-amber-600"}`, children: overdue ? `${Math.abs(alert.days)}d overdue` : dueToday ? "Today" : `${alert.days}d` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-foreground/20 group-hover:text-foreground/50 transition-colors" })
          ] })
        ] }) }, alert.id);
      }) }),
      alerts.length > 5 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-3 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { href: "/organic-fresh-produce?tab=input-derogations", className: "text-xs text-primary hover:underline underline-offset-2", children: [
        "View all ",
        alerts.length,
        " derogations expiring →"
      ] }) })
    ] })
  ] });
}
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Overview", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(UpcomingDatesPanel, { farmId, activeSubs }),
    activeSubs.includes("organic-fresh-produce") && /* @__PURE__ */ jsxRuntimeExports.jsx(FpDerogationAlertsPanel, { farmId }),
    hasOrganicComplianceModule(activeSubs) && /* @__PURE__ */ jsxRuntimeExports.jsx(OrganicInspectionAlertPanel, { farmId }),
