import { s as createLucideIcon, b as useAppStore, j as jsxRuntimeExports, R as Redirect, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, l as cn, o as Link, T as Plus, e as LoaderCircle, n as Card, A as ArrowRight, aO as toast, X } from "./index-szmq1rP5.js";
import { A as AppLayout, C as CalendarDays, P as Boxes, d as Wrench, j as Truck } from "./AppLayout-B_c4q11G.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-CH51Ih68.js";
import { L as LayoutList } from "./layout-list-GsDxVx21.js";
import { C as CircleCheckBig } from "./circle-check-big-pi8JRZKC.js";
import { U as UserPlus } from "./user-plus-BOtF0Ywy.js";
...
const FP_DEROGATION_EXPIRY_TYPES = [
  "organic_fp_input_log_derogation_expiry",
  "organic_fp_derogation_expiry"
];
function isFpDerogationExpiryType(type) {
  return FP_DEROGATION_EXPIRY_TYPES.includes(type);
}
...
function formatFpDerogationExpiryLabel(type, dueDate, today) {
...
function TaskCard({
  ...
  const inner = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      ...
      isFpDerogationExpiryType(task.type) && task.dueDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: cn("text-xs font-semibold mt-1.5 flex items-center gap-1", overdue ? "text-red-600" : "text-amber-600"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3" }),
        formatFpDerogationExpiryLabel(task.type, task.dueDate, today)
      ] }),
      overdue && !isFpDerogationExpiryType(task.type) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-red-600 mt-1.5 flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3" }),
        Math.abs(days),
        " day",
        Math.abs(days) !== 1 ? "s" : "",
