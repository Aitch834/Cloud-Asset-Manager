import { b as useAppStore, c as useQueryClient, m as useQuery, r as reactExports, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, L as Label, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, I as Input, N as DialogMutationError, J as DialogFooter } from "./index-DqqyMgV5.js";
import { u as usePersistedTab } from "./use-persisted-tab-BdPO-J0X.js";
import { A as AppLayout, S as Sprout } from "./AppLayout-CRCfUGIQ.js";
...
function RegenerativePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-7xl mx-auto", children: [
    ...
    tab === "practices" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-lg border overflow-x-auto", children: practicesQ.isError ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "p-4 text-sm text-red-600", children: "Failed to load practice records — please refresh." }) : practices.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "p-6 text-sm text-gray-500", children: "No practices recorded yet. Log each cover crop, no-till pass, grazing integration or input cut against one of the six principles — this builds the evidence pack verification schemes ask for." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
