import { t as useQueryClient, a as useToast, r as reactExports, O as useMutation, j as jsxRuntimeExports, d as LoaderCircle, l as useQuery, c as Button, S as Plus, Q as React, M as MapPin, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input } from "./index-BKcsQW2l.js";
...
function PhotoPanel({ incidentId, farmId, photos }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (photoId) => fetch(`/api/farms/${farmId}/fly-tipping/${incidentId}/photos/${photoId}`, { method: "DELETE" }),
