import { s as createLucideIcon, b as useAppStore, r as reactExports, u as useLocation, m as useQuery, j as jsxRuntimeExports, I as Input, d as Button, T as Plus, n as Card, o as CardContent, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, c as useQueryClient, a as useToast, S as useMutation, e as LoaderCircle, L as Label, N as DialogMutationError, B as Building2 } from "./index-DImoRxln.js";
import { A as AppLayout, U as Users, q as Smartphone } from "./AppLayout-3zwW38j4.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-CFwyOV3c.js";
import { p as printProReport } from "./print-report-DB1ygEK5.js";
import { a as useLookup } from "./use-lookup-B1uINIR_.js";
import { H as HardHat } from "./hard-hat-DZB-S2eC.js";
import { S as Search } from "./search-c3XpymI8.js";
import { U as UserX } from "./user-x-po2KDtnf.js";
import { L as Lock } from "./lock-DeKlOvcP.js";
import { U as User } from "./user-gy_V2t5N.js";
import { R as RefreshCw } from "./refresh-cw-CtFpOcR_.js";
...
import { T as Trash2 } from "./trash-2-Br3Vg5k2.js";
import { F as FileText, G as GraduationCap } from "./shield-alert-jNystpln.js";
import { S as ShieldCheck } from "./shield-check-zzaCF1Ns.js";
import { C as CircleCheck } from "./circle-check-ajiu3vQo.js";
import { P as Phone } from "./phone-B0a5z2-u.js";
import { A as Award } from "./award-_hw7Bu_k.js";
import { S as Send } from "./send-DU89uglw.js";
import { U as UserRound } from "./user-round-DJ3oUY2H.js";
import { M as Mail } from "./mail-DoW8qIpV.js";
import { S as Shield } from "./shield-DLZQmX9Y.js";
import { U as UserCheck } from "./user-check-DuJ1Nbrm.js";
import { P as Pen } from "./pen-yOm0dSjH.js";
...
function PpeRegisterSection({ farmId, members }) {
  ...
  const createIssueMut = useMutation({
    mutationFn: (b) => fetch(issueBase, { method: "POST", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify({ ...b, stockItemId: b.stockItemId ? parseInt(b.stockItemId) : null }) }).then(async (r) => {
      if (!r.ok) {
  ...
  const updateIssueMut = useMutation({
    mutationFn: (b) => fetch(`${issueBase}/${b.id}`, { method: "PUT", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify({ ...b, stockItemId: b.stockItemId ? parseInt(b.stockItemId) : null }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteIssueMut = useMutation({
    mutationFn: (id) => fetch(`${issueBase}/${id}`, { method: "DELETE", headers: authHeaders() }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const createStockMut = useMutation({
    mutationFn: (b) => fetch(stockBase, { method: "POST", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify({ ...b, quantityReceived: parseInt(b.quantityReceived || "0"), unitCostPence: b.unitCostPence ? Math.round(parseFloat(b.unitCostPence) * 100) : null, supplierId: b.supplierId ? parseInt(b.supplierId) : null }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteStockMut = useMutation({
    mutationFn: (id) => fetch(`${stockBase}/${id}`, { method: "DELETE", headers: authHeaders() }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const createRiskMut = useMutation({
    mutationFn: (b) => fetch(riskBase, { method: "POST", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify(riskPayload(b)) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateRiskMut = useMutation({
    mutationFn: (b) => fetch(`${riskBase}/${b.id}`, { method: "PUT", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify(riskPayload(b)) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteRiskMut = useMutation({
    mutationFn: (id) => fetch(`${riskBase}/${id}`, { method: "DELETE", headers: authHeaders() }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const [pendingCompleteStocktake, setPendingCompleteStocktake] = reactExports.useState(null);
  const createStocktakeMut = useMutation({
    mutationFn: (body) => fetch(stocktakeBase, { method: "POST", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const patchStocktakeItemMut = useMutation({
    mutationFn: ({ sessionId, itemId, countedQty, notes }) => fetch(`${stocktakeBase}/${sessionId}/items/${itemId}`, { method: "PATCH", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify({ countedQty, notes }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const completeStocktakeMut = useMutation({
    mutationFn: (sessionId) => fetch(`${stocktakeBase}/${sessionId}/complete`, { method: "POST", headers: authHeaders() }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteStocktakeMut = useMutation({
    mutationFn: (id) => fetch(`${stocktakeBase}/${id}`, { method: "DELETE", headers: authHeaders() }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const createPoMut = useMutation({
    mutationFn: (data) => fetch(ppoBase, { method: "POST", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify(data) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updatePoMut = useMutation({
    mutationFn: (data) => fetch(`${ppoBase}/${editPo?.id}`, { method: "PUT", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify(data) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deletePoMut = useMutation({
    mutationFn: (id) => fetch(`${ppoBase}/${id}`, { method: "DELETE", headers: authHeaders() }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const receivePoMut = useMutation({
    mutationFn: (data) => fetch(`${ppoBase}/${showGrnDialog?.id}/receive`, { method: "POST", headers: { "Content-Type": "application/json", ...authHeaders() }, body: JSON.stringify(data) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    showStockForm && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
      if (!o) {
        setShowStockForm(false);
        setEditStock(null);
        createStockMut.reset();
        updateStockMut.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: createStockMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: updateStockMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { style: { marginTop: 16 }, children: [
    ...
    showIssueForm && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
      if (!o) {
        setShowIssueForm(false);
        setEditIssue(null);
        createIssueMut.reset();
        updateIssueMut.reset();
      }
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg max-h-[90vh] overflow-y-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: createIssueMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: updateIssueMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { style: { marginTop: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => {
          setShowIssueForm(false);
          setEditIssue(null);
    ...
    deleteStockId !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteStockMut, message: "Failed to remove — please try again." }),
    ...
    deleteIssueId !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteIssueMut, message: "Failed to remove — please try again." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    subTab === "stocktakes" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      stocktakeNewOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: createStocktakeMut, message: "Failed to start stocktake — please try again." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      ...
      stocktakeDeleteId !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteStocktakeMut, message: "Failed to delete — please try again." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    subTab === "risk" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      showRiskForm && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: createRiskMut, message: "Failed to save — your entries are still here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: updateRiskMut, message: "Failed to save — your entries are still here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => {
            setShowRiskForm(false);
            setEditRisk(null);
      ...
      deleteRiskId !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteRiskMut, message: "Failed to delete — please try again." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    showPoForm && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: createPoMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: updatePoMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { style: { marginTop: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => {
          setShowPoForm(false);
          setEditPo(null);
    ...
    showGrnDialog && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: receivePoMut, message: "Failed to record receipt — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { style: { marginTop: 16 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        ...
        onConfirm: () => {
          if (pendingCompleteStocktake !== null) completeStocktakeMut.mutate(pendingCompleteStocktake, { onSuccess: () => setPendingCompleteStocktake(null) });
        },
        onCancel: () => {
          setPendingCompleteStocktake(null);
...
function AddMemberDialog({ farmId, open, onClose, departments }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: create, message: "Failed to save — your entries are still here." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => {
        reset();
        create.reset();
...
function InviteDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: invite, message: "Failed to send invitation — please try again." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => {
        reset();
        invite.reset();
