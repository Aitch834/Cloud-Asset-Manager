import { b as useAppStore, a as useToast, c as useQueryClient, m as useQuery, j as jsxRuntimeExports, U as FlaskConical, r as reactExports, S as useMutation, I as Input, d as Button, T as Plus, O as React, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, e as LoaderCircle, M as MapPin, N as DialogMutationError, J as DialogFooter } from "./index-Jc5ltdxf.js";
import { o as openPrintWindow } from "./print-report-ClU8-1P0.js";
import { u as useLookupStrings } from "./use-lookup-BY0BsYJl.js";
import { C as CropYearSelector } from "./CropYearSelector-D24_Xx8R.js";
...
import { A as AppLayout, j as Truck } from "./AppLayout-B3GaN3Ka.js";
...
import { D as Droplets, S as ShieldAlert } from "./shield-alert-CY6v8MhG.js";
...
import { W as Wind } from "./wind-Be6E1gno.js";
...
import { L as Link2 } from "./link-2-BuzR_W99.js";
import { P as Printer } from "./printer-SPoDe0Kj.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, a as LabelList, L as Legend, C as Cell } from "./generateCategoricalChart-Cwf5iP_1.js";
...
import { C as CircleCheckBig } from "./circle-check-big-CmgSj08L.js";
...
function PrintTab({ applications, farm, cropYear, setCropYear }) {
  ...
  const docHeader = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "2px solid #1a3a1a", paddingBottom: 10, marginBottom: 14 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      farm?.contactPhone && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "0.7rem", color: "#555", margin: "2px 0", lineHeight: 1.5 }, children: [
        "Tel: ",
        farm.contactPhone
      ] }),
...
function IpmPlanTab({ farmId }) {
  ...
  const [pendingDeletePlan, setPendingDeletePlan] = reactExports.useState(null);
  ...
  const deletePlanMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/ipm-plans/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-sm text-gray-400", children: "Loading…" }) : plans.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 text-center text-sm text-gray-400", children: "No IPM plans yet. Create your first plan above." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y", children: plans.map((p) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: `w-full text-left px-3 py-2.5 hover:bg-gray-50 transition-colors ${selectedPlan?.id === p.id ? "bg-green-50 border-l-2 border-green-600" : ""}`, onClick: () => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 mt-1.5", onClick: (e) => e.stopPropagation(), children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-xs text-red-600 hover:underline", onClick: () => setPendingDeletePlan(p.id), children: "Delete" })
            ] })
          ] }, p.id);
        }) })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        ...
        onConfirm: () => {
          if (pendingDeletePlan !== null) deletePlanMut.mutate(pendingDeletePlan, { onSuccess: () => setPendingDeletePlan(null) });
        },
        onCancel: () => {
...
function LerapTab({ farmId, products, fields }) {
  ...
  const [pendingDelLerap, setPendingDelLerap] = reactExports.useState(null);
  ...
  const delMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/lerap-assessments/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y", children: records.filter((r) => filterField === "__all__" || r.fieldId === Number(filterField)).map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-gray-50", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "h-7 px-2 text-red-500", onClick: () => setPendingDelLerap(r.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3.5 h-3.5" }) })
          ] }) })
        ] }, r.id)) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        ...
        mutation: delMut,
        onConfirm: () => {
          if (pendingDelLerap !== null) delMut.mutate(pendingDelLerap, { onSuccess: () => setPendingDelLerap(null) });
        },
        onCancel: () => {
          setPendingDelLerap(null);
          delMut.reset();
        }
      }
    )
