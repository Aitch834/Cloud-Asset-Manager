import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, l as useQuery, j as jsxRuntimeExports, T as FlaskConical, O as useMutation, I as Input, c as Button, S as Plus, Q as React, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, d as LoaderCircle, M as MapPin, J as DialogFooter } from "./index-fxZRGm6t.js";
import { o as openPrintWindow } from "./print-report-B_FwCCVJ.js";
import { u as useLookupStrings } from "./use-lookup-DemZNcD6.js";
...
import { A as AppLayout, j as Truck } from "./AppLayout-DGOTUjsH.js";
...
import { D as Droplets, S as ShieldAlert } from "./shield-alert-B-R7Zn0n.js";
...
import { L as Link2 } from "./link-2-BBMLAIsS.js";
import { P as Printer } from "./printer-D3hpg9tA.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, a as LabelList, L as Legend, C as Cell } from "./generateCategoricalChart-C9hKMiDl.js";
...
function ApplicationsTab({ applications, products, fields, farmId, loading, onRefresh, toast, initialSearch, cropYear, setCropYear }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/spray-applications`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(buildPayload(body)) }),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/spray-applications/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(buildPayload(body)) }),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/spray-applications/${id}`, { method: "DELETE" }),
    onSuccess: () => {
...
function ProductsTab({ products, farmId, loading, onRefresh, toast }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/spray-products`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/spray-products/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/spray-products/${id}`, { method: "DELETE" }),
    onSuccess: () => {
...
function LerapTab({ farmId, products, fields }) {
  ...
  const reviewMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/lerap-assessments/${id}/review`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
...
function SprayNotificationsTab({ farmId, applications, fields }) {
  ...
  const createMut = useMutation({ mutationFn: (b) => fetch(`/api/farms/${farmId}/spray-notifications`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()), onSuccess: () => {
    toast({ title: "Notification logged" });
    qc.invalidateQueries({ queryKey: ["spray-notifications", farmId] });
    setAddOpen(false);
    setForm({ ...emptyForm });
  }, onError: () => toast({ title: "Failed to save", variant: "destructive" }) });
  const updateMut = useMutation({ mutationFn: ({ id, b }) => fetch(`/api/farms/${farmId}/spray-notifications/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()), onSuccess: () => {
    toast({ title: "Notification updated" });
    qc.invalidateQueries({ queryKey: ["spray-notifications", farmId] });
    setEditRec(null);
  }, onError: () => toast({ title: "Failed to update", variant: "destructive" }) });
  const deleteMut = useMutation({ mutationFn: (id) => fetch(`/api/farms/${farmId}/spray-notifications/${id}`, { method: "DELETE" }), onSuccess: () => {
    toast({ title: "Notification deleted" });
    qc.invalidateQueries({ queryKey: ["spray-notifications", farmId] });
    setDeleteId(null);
  }, onError: () => toast({ title: "Failed to delete", variant: "destructive" }) });
  const createContactMut = useMutation({ mutationFn: (b) => fetch(`/api/farms/${farmId}/spray-notification-contacts`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()), onSuccess: () => {
  ...
  const updateContactMut = useMutation({ mutationFn: ({ id, b }) => fetch(`/api/farms/${farmId}/spray-notification-contacts/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()), onSuccess: () => {
    toast({ title: "Contact updated" });
    qc.invalidateQueries({ queryKey: ["spray-notification-contacts", farmId] });
    setEditContact(null);
    setContactForm({ ...emptyContact });
  }, onError: () => toast({ title: "Failed to update contact", variant: "destructive" }) });
  const deleteContactMut = useMutation({ mutationFn: (id) => fetch(`/api/farms/${farmId}/spray-notification-contacts/${id}`, { method: "DELETE" }), onSuccess: () => {
...
function ContainerDisposalTab({ farmId, products }) {
  ...
  const createMut = useMutation({
    mutationFn: (b) => fetch(`/api/farms/${farmId}/spray-container-disposals`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, b }) => fetch(`/api/farms/${farmId}/spray-container-disposals/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/spray-container-disposals/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Deleted" });
      qc.invalidateQueries({ queryKey: key });
      setDeleteId(null);
...
function StoreInspectionTab({ farmId }) {
  ...
  const createMut = useMutation({
    mutationFn: (b) => fetch(`/api/farms/${farmId}/spray-store-inspections`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, b }) => fetch(`/api/farms/${farmId}/spray-store-inspections/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/spray-store-inspections/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      toast({ title: "Deleted" });
      qc.invalidateQueries({ queryKey: key });
      setDeleteId(null);
