import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, l as useQuery, O as useMutation, j as jsxRuntimeExports, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input } from "./index-BKcsQW2l.js";
import { A as AppLayout, E as Flame } from "./AppLayout-B8_1RkJL.js";
...
function FarmIncidentsPage() {
  ...
  const handlePrintIncident = (inc) => {
    ...
    const tableHtml = `<table><thead><tr><th>Field</th><th>Detail</th></tr></thead><tbody>${rows.map(([label, value]) => `<tr><td style="font-weight:600;white-space:nowrap;width:200px">${esc(label)}</td><td>${esc(value)}</td></tr>`).join("")}</tbody></table>`;
    printProReport({
