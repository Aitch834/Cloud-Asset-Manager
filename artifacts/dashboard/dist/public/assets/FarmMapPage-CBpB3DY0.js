const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-Dz_2C9LB.js","assets/index-BKcsQW2l.js","assets/index-D-NU40dU.css"])))=>i.map(i=>d[i]);
import { b as useAppStore, r as reactExports, l as useQuery, j as jsxRuntimeExports, K as Map, o as Link, m as Card, I as Input, B as Building2, T as FlaskConical, M as MapPin, _ as __vitePreload } from "./index-BKcsQW2l.js";
import { A as AppLayout, O as Settings, W as Warehouse, g as TreePine, U as Users } from "./AppLayout-B8_1RkJL.js";
...
import { E as EyeOff } from "./eye-off-D4PXe1NG.js";
...
function useFarmMap(containerRef, locations, onSelect) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-Dz_2C9LB.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
