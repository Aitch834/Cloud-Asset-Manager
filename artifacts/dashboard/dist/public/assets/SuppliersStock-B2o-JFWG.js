import { b as useAppStore, r as reactExports, a as useToast, c as useQueryClient, m as useQuery, j as jsxRuntimeExports, S as useMutation, I as Input, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, N as DialogMutationError, J as DialogFooter, O as React, B as Building2, e as LoaderCircle } from "./index-Yg2hRptR.js";
import { a as usePersistedFilter } from "./use-persisted-filter-BYFafcK6.js";
import { TradeHistoryTab } from "./TradeHistory-BdfGYZRC.js";
...
import { A as AppLayout, I as Info, u as useUserRole, c as ClipboardList, j as Truck } from "./AppLayout-TxfsxeQa.js";
...
import { R as RefreshCw } from "./refresh-cw-BKnrpcmQ.js";
import { A as ArrowUp, a as ArrowDown } from "./arrow-up-BNbVJMYI.js";
import { E as Eye } from "./eye-BFp1nXc1.js";
import { C as ClipboardCheck } from "./shield-alert-BFDPM1VY.js";
import "./popover-BIE7qpVX.js";
import "./index-6FElKhib.js";
import "./shopping-cart-eJzlcAjK.js";
import "./generateCategoricalChart-Prlpvqph.js";
import "./LineChart-CIIHS33m.js";
import "./Line-grpV0fP6.js";
import "./CartesianGrid-CThxMmCC.js";
import "./BarChart-C2NouHdC.js";
import "./arrow-up-down-BwWVeThe.js";
...
const SUPPLIERS_TAB_IDS = ["suppliers", "products", "purchase-orders", "received", "levels", "movements", "trade-history", "stocktake"];
function SuppliersStockPage() {
  const { farmId } = useAppStore();
  const [tab, setTab] = usePersistedTab({ page: "suppliers-stock", farmId, validIds: SUPPLIERS_TAB_IDS, defaultTab: "levels", urlOverride: new URLSearchParams(window.location.search).get("tab") });
...
function StockLevelsTab({ levels, products, loading, farmId, onRefresh, toast, qc, onGoToProducts, onRaisePo }) {
  ...
  const adjMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/stock-movements`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: adjOpen, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: adjMut, message: "Failed to save — your entries are still here." }),
...
function GoodsReceivedTab({ deliveries, products, suppliers, purchaseOrders, loading, farmId, onRefresh, toast, onGoToProducts }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/stock-deliveries`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...body, costPence: body.costPence ? Math.round(parseFloat(body.costPence) * 100) : null }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: invoiceDelivery !== null, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: invoiceMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
...
function ProductsTab({ products, suppliers, loading, farmId, onRefresh, toast }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/stock-items`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/stock-items/${editItem.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: editItem ? updateMut : createMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
...
function PurchaseOrdersTab({ orders, products, suppliers, feedStock, loading, farmId, onRefresh, toast, qc, onGoToGRN, prefilledPo, onClearPrefilledPo }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/purchase-orders`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateStatusMut = useMutation({
    mutationFn: ({ poId, status }) => fetch(`/api/farms/${farmId}/purchase-orders/${poId}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ status }) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteMut = useMutation({
    mutationFn: (poId) => fetch(`/api/farms/${farmId}/purchase-orders/${poId}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: createMut, message: "Failed to create PO — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setOpen(false), children: "Cancel" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!viewPo, onOpenChange: (o) => {
      ...
      viewQ.isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 py-6 text-center", children: "Loading..." }) : detail ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: updateStatusMut, message: "Failed to update status — please try again." }),
...
function SuppliersTab({ suppliers, loading, farmId, onRefresh, toast }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/suppliers`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/suppliers/${editItem.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deactivateMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/suppliers/${id}/deactivate`, { method: "PATCH" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const reactivateMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/suppliers/${id}/reactivate`, { method: "PATCH" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function StocktakeTab({ farmId }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/stocktakes`, { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateItemMut = useMutation({
    mutationFn: ({ sessionId, itemId, body }) => fetch(`/api/farms/${farmId}/stocktakes/${sessionId}/items/${itemId}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const completeMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/stocktakes/${id}/complete`, { method: "POST", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/stocktakes/${id}`, { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
