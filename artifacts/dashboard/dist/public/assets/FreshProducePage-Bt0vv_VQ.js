const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-CXza-ZjH.js","assets/index-R3VuZ4m_.js","assets/index-UeFNfJ8M.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, c as Button, l as useQuery, R as Redirect, m as Card, n as CardContent, t as useQueryClient, a as useToast, O as useMutation, S as Plus, d as LoaderCircle, L as Label, I as Input, C as Checkbox, K as Map } from "./index-R3VuZ4m_.js";
import { L as LabSelector } from "./LabSelector-CFB7GBN0.js";
import { P as Printer } from "./printer-6YgnYG72.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-Sx4zuLlf.js";
import { B as BarChart } from "./BarChart-BbDEA4Qn.js";
import { C as CartesianGrid } from "./CartesianGrid-DyCDvZo2.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-DrL-5blr.js";
import { C as ChevronUp } from "./chevron-up-DQgAIiZ8.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-B5_u4SNN.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-CixSqt5V.js";
import { T as Textarea } from "./textarea-D7JCcopF.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-BNM7psQU.js";
...
import { u as useFarmMembers } from "./use-farm-members-NjvB8eEn.js";
import { u as useFarmName } from "./use-farm-name-DiCo9gJl.js";
import { S as StaffSelect } from "./staff-select-C59_z7uL.js";
import { b as apiUrl } from "./api-CpR0wkAb.js";
import { L as LayoutGrid } from "./layout-grid-0mPggVPl.js";
import { D as Droplets } from "./shield-alert-Cjv2OHEt.js";
import { P as Package } from "./use-safe-clerk-CR3cNHq7.js";
import { T as Thermometer } from "./thermometer-Co0CoyQ_.js";
import { E as Eye } from "./eye-d9KauOnE.js";
import { P as Pencil } from "./pencil-BQyOBZYa.js";
import { A as Archive } from "./archive-Brhbn0zZ.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-CXza-ZjH.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
