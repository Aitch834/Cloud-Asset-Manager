...
import { c as ClipboardList, T as TrendingUp, A as AppLayout } from "./AppLayout-UUn9I45b.js";
import { T as TabBar, a as TabButton } from "./tab-button-B1xgZju1.js";
import { a as api, f as formatDate, S as SccBadge, t as today, O as OutcomeBadge, E as EaseScoreBadge, P as PackageCheck, D as DctTab, b as SccEquipmentSection, c as DairySuppliesTab } from "./SccEquipmentSection-B0_IFCrD.js";
...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, _ as ReferenceLine, C as Cell, L as Legend } from "./generateCategoricalChart-DYpF37uT.js";
...
import { B as BcsTab, M as MobilityTab, a as BulkTankTab, R as RecordingVisitsTab } from "./RecordingVisitsTab-JxkHBXp9.js";
...
import "./thermometer-BBCiwv6G.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Dairy Records", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-7xl mx-auto", children: [
    ...
    dairyAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm mb-4 ${dairyAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : dairyAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        dairyAlert.date && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 opacity-70 text-xs", children: [
          "Issued ",
          dairyAlert.date
        ] })
      ] })
