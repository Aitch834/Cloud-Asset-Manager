import { r as reactExports, f as useControllableState, j as jsxRuntimeExports, P as Primitive, g as composeEventHandlers, h as Presence, i as createContextScope, k as useComposedRefs, D as DismissableLayer, l as cn, m as useQuery, n as Card, o as CardContent, p as Link, A as ArrowRight, b as useAppStore, q as useGetFarmActivity, R as Redirect, M as MapPin } from "./index-Jc5ltdxf.js";
import { C as CalendarDays, L as Landmark, S as Sprout, W as Warehouse, u as useUserRole, A as AppLayout, a as Wheat, b as Layers, c as ClipboardList, d as Wrench, e as ChartColumn } from "./AppLayout-B3GaN3Ka.js";
import { R as Root2$1, A as Anchor, c as createPopperScope, C as Content, a as Arrow } from "./index-MP8lBbOr.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-D6q6f7zb.js";
import { T as Tag } from "./tag-CPJMbfyx.js";
import { S as ShieldCheck } from "./shield-check-DEFR_x3P.js";
import { D as Droplets, F as FileText, C as ClipboardCheck, S as ShieldAlert, G as GraduationCap } from "./shield-alert-CY6v8MhG.js";
...
import { T as Tractor } from "./tractor-gBqmhAn7.js";
import { P as PawPrint } from "./paw-print-t49Dsesq.js";
import { C as ChartLine } from "./chart-line-CcTrWC5A.js";
import { C as CloudRain } from "./cloud-rain-BEHn_gOK.js";
import "./trash-2-CdRo6b-V.js";
...
function FpDerogationAlertsPanel({ farmId }) {
  ...
  const alerts = (data?.tasks ?? []).filter((t) => t.type === "organic_fp_derogation_expiry").map((t) => ({ ...t, days: daysUntil$1(t.dueDate) })).sort((a, b) => a.days - b.days);
...
function OrganicInspectionAlertPanel({ farmId }) {
  const { data } = useQuery({
    ...
    queryFn: () => fetch(`/api/farms/${farmId}/organic/inspections`, { credentials: "include" }).then((r) => {
