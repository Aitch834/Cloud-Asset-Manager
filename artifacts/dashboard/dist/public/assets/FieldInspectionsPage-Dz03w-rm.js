import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, O as useMutation, l as useQuery, j as jsxRuntimeExports, c as Button, S as Plus, I as Input, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, d as LoaderCircle } from "./index-BlNkE5Og.js";
...
import { C as ClipboardCheck } from "./shield-alert-BUHSxUrz.js";
...
import { S as SquareCheckBig } from "./square-check-big-9zZu0JUv.js";
...
function InspectionPhotoPanel({ recordId, farmId, photos }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (photoId) => fetch(`/api/farms/${farmId}/field-inspections/${recordId}/photos/${photoId}`, { method: "DELETE" }),
...
function RaiseTaskDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "32rem" }, children: [
...
function FieldInspectionsPage() {
  ...
  const createInspMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/field-inspections`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (data2) => {
      qc.invalidateQueries({ queryKey: ["field-inspections", farmId] });
  ...
  const updateInspMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/field-inspections/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["field-inspections", farmId] });
  ...
  useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/field-inspections/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["field-inspections", farmId] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-lg border border-gray-200 overflow-hidden", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16 text-gray-400 text-sm", children: "Loading inspections…" }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-16 gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filtered.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-gray-50 hover:bg-gray-50 transition-colors", children: [
    ...
    detailRecord && resolveOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => {
      setResolveOpen(false);
      setDetailRecord(null);
