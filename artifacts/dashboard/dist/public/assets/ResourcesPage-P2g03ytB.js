import { q as createLucideIcon, r as reactExports, Q as React, ak as reactDomExports, b as useAppStore, j as jsxRuntimeExports, R as Redirect, t as useQueryClient, l as useQuery, O as useMutation, k as cn, aY as toast, $ as X, S as Plus, m as Card } from "./index-CG7Bde15.js";
import { A as AppLayout, d as Wrench, j as Truck, C as CalendarDays, c as ClipboardList, R as RotateCcw } from "./AppLayout-DW85f8T1.js";
...
import { C as CircleAlert, a as Clock } from "./database-B6Muj3P5.js";
...
import { C as ChevronDown } from "./trash-2-VByqLcbQ.js";
import { P as Pencil } from "./pencil-BZ-m9pa0.js";
import { A as Archive } from "./archive-dbg87IhL.js";
...
function PlannerTab({ farmId, resources }) {
  ...
  const removeMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/task-resource-allocations/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["resource-planner", farmId, fromDate] }),
...
function ResourcesPage() {
  ...
  const archiveMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/resources/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["resources", farmId] });
