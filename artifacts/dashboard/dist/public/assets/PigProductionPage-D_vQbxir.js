const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-GnpdwBZB.js","assets/index-D3ay9Ao3.js","assets/index-CNUbH-zj.css","assets/typeof-WJl3ipnu.js"])))=>i.map(i=>d[i]);
import { r as reactExports, l as useQuery, j as jsxRuntimeExports, b as useAppStore, R as Redirect, c as Button, d as LoaderCircle, m as Card, n as CardContent, t as useQueryClient, a as useToast, O as useMutation, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, C as Checkbox, _ as __vitePreload, M as MapPin } from "./index-D3ay9Ao3.js";
...
import { T as TrendingUp, A as AppLayout, Q as LayoutDashboard, V as PiggyBank, j as Truck, q as Stethoscope, f as Scale, c as ClipboardList } from "./AppLayout-DRFFu3V0.js";
...
import { C as ComposedChart } from "./ComposedChart-Cuh84PgF.js";
...
import { P as Pill } from "./pill-lbHvysUu.js";
import { F as FileText, C as ClipboardCheck } from "./shield-alert-B8JTZTuq.js";
import { U as UtensilsCrossed } from "./utensils-crossed-D3LVePhg.js";
import { T as TriangleAlert } from "./triangle-alert-Zhn2K0n0.js";
import { B as Baby } from "./baby-DEOD1CYG.js";
import { S as ShieldCheck } from "./shield-check-B7Jnociy.js";
import { S as Syringe } from "./syringe-MB7-mES4.js";
import { A as Activity } from "./activity-Ct-g6Mrn.js";
import { F as FileDown } from "./file-down-Bq5uuUv6.js";
...
import { a as Clock } from "./database-C50ZkM3E.js";
...
function MovementsTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/pig-movements/${id}`), { method: "DELETE", credentials: "include" }),
...
function FciDocumentsTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/pig-fci-documents/${id}`), { method: "DELETE", credentials: "include" }),
...
function PigPenConsumptionView({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/pig-feed-consumption/${id}`), { method: "DELETE", credentials: "include" }),
...
function VetAssessmentsTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/pig-vet-assessments/${id}`), { method: "DELETE", credentials: "include" }),
...
function StockmanshipChecksTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/pig-stockmanship-checks/${id}`), { method: "DELETE", credentials: "include" }),
...
function TailBitingRisksTab({ farmId }) {
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/pig-tail-biting-risks/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["pig-tail-biting", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
...
function FarrowingRecordsTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/pig-farrowing-records/${id}`), { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["pig-farrowing", farmId] });
...
function PigRedTractorChecklistTab({ farmId }) {
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/pig-red-tractor-checklists/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["pig-rt-checklist", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
...
function MedicineRegisterTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/pig-medicine-treatments/${id}`), { method: "DELETE", credentials: "include" }),
...
function KillRecordsTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/pig-kill-records/${id}`), { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["pig-kill-records", farmId] });
      setConfirmDelete(null);
    },
...
async function generatePigAuditPDF(farmId) {
  const [jsPDFModule, autoTableModule] = await Promise.all([__vitePreload(() => import("./jspdf.es.min-GnpdwBZB.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), __vitePreload(() => import("./jspdf.plugin.autotable-rNuKHwSj.js"), true ? [] : void 0)]);
