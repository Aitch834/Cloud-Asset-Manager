import { c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, J as DialogFooter, a as useToast, X, e as LoaderCircle, l as cn, b as useAppStore, b5 as formatAlertIssuedAt, H as DialogDescription, C as Checkbox, N as DialogMutationError, n as Card, o as CardContent } from "./index-Bt49Vuc8.js";
import { D as DairyEnterpriseReport, A as AbrProcurementSection } from "./DairyEnterpriseReport-DtXBUPQf.js";
import { u as useSafeUser } from "./use-safe-clerk-BRXvgrOh.js";
import { u as usePersistedTab } from "./use-persisted-tab-DUbGiuTI.js";
import { a as usePersistedFilter, u as usePersistedNumberFilter } from "./use-persisted-filter-BkmEG9-P.js";
import { A as AppLayout, c as ClipboardList } from "./AppLayout-Ba5OirH6.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-BDSUTC3V.js";
import { B as Badge } from "./badge-BJOpwh6C.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-BxFoOzXR.js";
...
import { R as RecordAttachments } from "./RecordAttachments-B1-blFqq.js";
import { R as RaiseTaskDialog } from "./RaiseTaskDialog-8xAAM1bX.js";
import { b as SccEquipmentSection, c as DairySuppliesTab } from "./SccEquipmentSection-DWUScl_D.js";
import { B as BcsTab, M as MobilityTab, a as BulkTankTab, R as RecordingVisitsTab } from "./RecordingVisitsTab-CDU7opsz.js";
...
import { F as FileText, S as ShieldAlert, D as Droplets } from "./shield-alert-BNeNt00B.js";
import { U as Upload } from "./upload-BEnyQ9QV.js";
import { P as Paperclip } from "./paperclip-dm45c8W3.js";
import { I as Image } from "./image-CVL0K8qZ.js";
...
import { C as ChevronLeft } from "./chevron-left-DMKJNct6.js";
import { C as ChevronRight } from "./tractor-DHNIwOv5.js";
import { T as TriangleAlert } from "./triangle-alert-BcBj2QVV.js";
import { F as FileDown } from "./file-down-KJ4XWHUe.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, _ as ReferenceLine } from "./generateCategoricalChart-BdsI_vMv.js";
import { C as ComposedChart } from "./ComposedChart-mVAGwk_6.js";
...
import "./shopping-cart-FaoSyxMl.js";
import "./receipt-4dWOTHUQ.js";
import "./badge-check-DZUKFHLM.js";
import "./database-CtsfUahs.js";
import "./circle-x-DVCe8cjH.js";
import "./use-farm-name-BdEMQSfb.js";
import "./trending-down-Dla-ob4N.js";
...
import "./sparkles-ZF9Uxvus.js";
import "./chevrons-up-down-wBukq8dR.js";
import "./use-farm-members-Bn_tkxdE.js";
import "./staff-select-DhL34JrO.js";
import "./index-BlojoD0p.js";
import "./qr-code-CrgEgYKU.js";
import "./thermometer-D0CRH3OC.js";
import "./chart-no-axes-column-DGI8Yv7D.js";
import "./shared-BA6L89bM.js";
import "./Area-DcjnaVr4.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 border-t pt-6", children: [
    ...
    declarations.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-8 border-2 border-dashed rounded-lg text-sm text-gray-400", children: 'No declarations recorded yet. Click "New Annual Declaration" to log and print your first.' }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y", children: declarations.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-gray-50", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "h-7 px-2 text-red-500", onClick: () => setPendingDelete(d.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3.5 h-3.5" }) })
        ] }) })
      ] }, d.id)) })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        ...
        mutation: delMut,
        onConfirm: () => {
          if (pendingDelete !== null) delMut.mutate(pendingDelete, { onSuccess: () => setPendingDelete(null) });
        },
        onCancel: () => {
...
function downloadMastitisCsv(records, farmName, monthLabel) {
...
function printMastitisRecords(records, farmName, monthLabel) {
  const today2 = (/* @__PURE__ */ new Date()).toLocaleDateString("en-GB");
  const rows = records.map((r) => `
    <tr>
  ...
  openPrint(`<!DOCTYPE html><html><head><title>Organic Mastitis Register &mdash; ${esc(farmName)}</title><style>${PRINT_CSS}</style></head><body>
    ...
    <div class="hdr-r"><b>Mastitis Records</b><br>${records.length} record${records.length !== 1 ? "s" : ""}<br>Printed: ${esc(today2)}</div></div>
...
function printDctRegister(records, farmName, monthLabel) {
  const today2 = (/* @__PURE__ */ new Date()).toLocaleDateString("en-GB");
  ...
  openPrint(`<!DOCTYPE html><html><head><title>Organic Dry Cow Therapy Register &#8212; ${eFarmName}</title><style>${PRINT_CSS}</style></head><body>
    ...
    <div class="hdr-r"><b>${eMonthLabel}</b><br>${records.length} record${records.length !== 1 ? "s" : ""}<br>Printed: ${escHtml(today2)}</div></div>
...
function exportDctCsv(records, monthLabel) {
...
function MastitisTab({ farmId, farmName }) {
  const qc = useQueryClient();
  const { toast } = useToast();
  const [open, setOpen] = reactExports.useState(false);
  const [editing, setEditing] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    !isLoading && allRecords.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-gray-200 bg-white p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide", children: "12-Month Case Trend" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            variant: "outline",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs text-gray-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-3 h-3 rounded-sm bg-blue-400" }),
          "Standard"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs text-gray-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-3 h-3 rounded-sm bg-amber-400" }),
          "Chronic"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ComposedChart, { data: trendData, margin: { top: 2, right: 4, left: -28, bottom: 0 }, barCategoryGap: "30%", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#f0f0f0", vertical: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "label", tick: { fontSize: 10, fill: "#6b7280" }, axisLine: false, tickLine: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { allowDecimals: false, tick: { fontSize: 10, fill: "#6b7280" }, axisLine: false, tickLine: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Tooltip,
          {
            contentStyle: { fontSize: 12, borderRadius: 6, border: "1px solid #e5e7eb" },
            formatter: (value, name) => [value, name === "regular" ? "Standard" : "Chronic"],
            labelFormatter: (label) => `Month: ${label}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "regular", stackId: "cases", fill: "#60a5fa", name: "regular", radius: [0, 0, 0, 0] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "chronic", stackId: "cases", fill: "#fbbf24", name: "chronic", radius: [2, 2, 0, 0] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-between items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center bg-gray-50 border border-gray-200 rounded-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepMonthM(-1), className: "p-1 rounded-l hover:bg-gray-200 transition-colors", "aria-label": "Previous month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4 text-gray-600" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-gray-700 px-2", children: monthLabelM }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepMonthM(1), className: "p-1 rounded-r hover:bg-gray-200 transition-colors", "aria-label": "Next month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4 text-gray-600" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => printMastitisRecords(filtered, farmName, monthLabelM), disabled: filtered.length === 0, className: "gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "w-4 h-4" }),
          "Print"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => downloadMastitisCsv(filtered, farmName, monthLabelM), disabled: filtered.length === 0, className: "gap-1.5", children: [
...
function CalvingTab({ farmId, farmName }) {
  const qc = useQueryClient();
  const { toast } = useToast();
  const [open, setOpen] = reactExports.useState(false);
  const [editing, setEditing] = reactExports.useState(null);
  ...
  function stepMonthC(dir) {
    const next = calvFilterMonth + dir;
    if (next < 0) {
      setCalvFilterYear(calvFilterYear - 1);
      setCalvFilterMonth(11);
    } else if (next > 11) {
      setCalvFilterYear(calvFilterYear + 1);
      setCalvFilterMonth(0);
    } else {
      setCalvFilterMonth(next);
    }
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-between items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center bg-gray-50 border border-gray-200 rounded-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepMonthC(-1), className: "p-1 rounded-l hover:bg-gray-200 transition-colors", "aria-label": "Previous month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4 text-gray-600" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-gray-700 px-2", children: monthLabelC }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepMonthC(1), className: "p-1 rounded-r hover:bg-gray-200 transition-colors", "aria-label": "Next month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4 text-gray-600" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => downloadCalvingCsv(calvingRecords, farmName, monthLabelC), disabled: calvingRecords.length === 0, className: "gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileDown, { className: "w-4 h-4" }),
          "Download CSV"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => printCalvingRecords(calvingRecords, farmName, monthLabelC), disabled: calvingRecords.length === 0, className: "gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "w-4 h-4" }),
          "Print"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: openAdd, children: [
...
function DctTab({ farmId, farmName }) {
  const qc = useQueryClient();
  const { toast } = useToast();
  const [open, setOpen] = reactExports.useState(false);
  const [editing, setEditing] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-between items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center bg-gray-50 border border-gray-200 rounded-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepMonth(-1), className: "p-1 rounded-l hover:bg-gray-200 transition-colors", "aria-label": "Previous month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4 text-gray-600" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-gray-700 px-2", children: monthLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepMonth(1), className: "p-1 rounded-r hover:bg-gray-200 transition-colors", "aria-label": "Next month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4 text-gray-600" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => printDctRegister(filteredList, farmName, monthLabel), disabled: filteredList.length === 0, className: "gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "w-3.5 h-3.5" }),
          "Print"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => exportDctCsv(filteredList, monthLabel), disabled: filteredList.length === 0, className: "gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileDown, { className: "w-3.5 h-3.5" }),
          "CSV Export"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: openAdd, children: [
...
function FeedNutritionTab({ farmId, farmName }) {
  ...
  const nowFeed = /* @__PURE__ */ new Date();
  ...
  function stepFeedMonth(dir) {
    const next = feedFilterMonth + dir;
    if (next < 0) {
      setFeedFilterYear(feedFilterYear - 1);
      setFeedFilterMonth(11);
    } else if (next > 11) {
      setFeedFilterYear(feedFilterYear + 1);
      setFeedFilterMonth(0);
    } else {
      setFeedFilterMonth(next);
    }
  }
  const feedMonthLabel = new Date(feedFilterYear, feedFilterMonth, 1).toLocaleDateString("en-GB", { month: "long", year: "numeric" });
  const records = reactExports.useMemo(() => allFeedRecords.filter((r) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between bg-gray-50 border border-gray-200 rounded-md px-3 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepFeedMonth(-1), className: "p-1 rounded hover:bg-gray-200 transition-colors", "aria-label": "Previous month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4 text-gray-600" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-gray-700", children: feedMonthLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepFeedMonth(1), className: "p-1 rounded hover:bg-gray-200 transition-colors", "aria-label": "Next month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4 text-gray-600" }) })
    ] }),
    records.length > 0 && (() => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
        records.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 9, className: "text-center text-muted-foreground py-8", children: allFeedRecords.length > 0 ? `No feed records for ${feedMonthLabel} — use the arrows to browse other months.` : "No feed records yet — click Add Feed Record to begin." }) }),
        records.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
...
function TreatmentsTab({ farmId, farmName }) {
  ...
  const nowTreat = /* @__PURE__ */ new Date();
  ...
  function stepTreatMonth(dir) {
    const next = treatFilterMonth + dir;
    if (next < 0) {
      setTreatFilterYear(treatFilterYear - 1);
      setTreatFilterMonth(11);
    } else if (next > 11) {
      setTreatFilterYear(treatFilterYear + 1);
      setTreatFilterMonth(0);
    } else {
      setTreatFilterMonth(next);
    }
  }
  ...
  const f = (k) => (e) => setForm((p) => ({ ...p, [k]: e.target.value }));
  const filteredDairyTreatments = reactExports.useMemo(() => records.filter((r) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between bg-gray-50 border border-gray-200 rounded-md px-3 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepTreatMonth(-1), className: "p-1 rounded hover:bg-gray-200 transition-colors", "aria-label": "Previous month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4 text-gray-600" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-gray-700", children: treatMonthLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => stepTreatMonth(1), className: "p-1 rounded hover:bg-gray-200 transition-colors", "aria-label": "Next month", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4 text-gray-600" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Date" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
        ...
        records.length > 0 && filteredDairyTreatments.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { colSpan: 8, className: "text-center text-muted-foreground py-8", children: [
          "No standalone treatments for ",
          treatMonthLabel,
...
function OrganicDairyPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Organic Dairy", children: farmId && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ArableFarmSettingsChecklist, { farmId, reportLabel: "dairy" }),
    dairyAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm ${dairyAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : dairyAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "mastitis", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MastitisTab, { farmId, farmName: name }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "calving", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CalvingTab, { farmId, farmName: name }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "dct", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DctTab, { farmId, farmName: name }) }),
...
function downloadCalvingCsv(records, farmName, monthLabel) {
...
function printCalvingRecords(records, farmName, monthLabel) {
  const today2 = (/* @__PURE__ */ new Date()).toLocaleDateString("en-GB");
  const easeLabel = ["", "Unassisted", "Easy pull", "Hard pull", "Mech. assist", "C-section"];
  const rows = records.map((r) => `
    <tr>
  ...
  openPrint(`<!DOCTYPE html><html><head><title>Organic Calving Register &mdash; ${esc(farmName)}</title><style>${PRINT_CSS}</style></head><body>
    ...
    <div class="hdr-r"><b>Calving Records</b><br>${records.length} calving${records.length !== 1 ? "s" : ""}<br>Printed: ${esc(today2)}</div></div>
