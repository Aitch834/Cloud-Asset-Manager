import { b as useAppStore, m as useQuery, j as jsxRuntimeExports, R as Redirect, U as FlaskConical, a as useToast, c as useQueryClient, r as reactExports, S as useMutation, e as LoaderCircle, d as Button, T as Plus, n as Card, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, L as Label, I as Input, N as DialogMutationError, aA as Check } from "./index-H8kC7A26.js";
...
import { A as AppLayout, c as ClipboardList, B as BookOpen, I as Info } from "./AppLayout-BJPAbu-D.js";
import { T as TabBar, a as TabButton } from "./tab-button-7rbwa08H.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-F9kQS8Ou.js";
import { C as Command, a as CommandInput, b as CommandList, c as CommandEmpty, d as CommandGroup, e as CommandItem } from "./command-T-hQulOU.js";
...
function downloadInputRegisterCsv(records, farmName, cropYear) {
  const fmtDate = (v) => {
    if (!v) return "";
    try {
      return new Date(v).toLocaleDateString("en-GB");
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        records.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => downloadInputRegisterCsv(records, farmName, yearFilter === "all" ? null : Number(yearFilter)), className: "gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "w-4 h-4" }),
            "Export CSV"
          ] }),
