import { b as useAppStore, j as jsxRuntimeExports, R as Redirect, a4 as useSearch, r as reactExports, m as useQuery, l as cn, T as Plus, e as LoaderCircle, n as Card, c as useQueryClient, S as useMutation, aM as toast, p as Link, A as ArrowRight, B as Building2 } from "./index-XTnQG40m.js";
import { A as AppLayout, c as ClipboardList, e as ChartColumn, d as Wrench, U as Users } from "./AppLayout-CHbvi0yr.js";
...
import { S as Send } from "./send-NQsycALb.js";
...
function ReportsView({ farmId, farm }) {
...
function TaskBoardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Task Board", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl space-y-6", children: [
      ...
      view === "reports" && /* @__PURE__ */ jsxRuntimeExports.jsx(ReportsView, { farmId, farm: farm?.farm ?? farm?.record ?? farm }),
