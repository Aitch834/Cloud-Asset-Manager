import { q as createLucideIcon, b as useAppStore, t as useQueryClient, a as useToast, r as reactExports, l as useQuery, O as useMutation, j as jsxRuntimeExports, c as Button, S as Plus, B as Building2, M as MapPin, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, d as LoaderCircle, L as Label, I as Input, T as FlaskConical } from "./index-C3jhrBt5.js";
...
import { A as AppLayout, W as Warehouse, b as Layers, E as Flame, j as Truck, a as Wheat } from "./AppLayout-vONHBQWP.js";
...
import { u as useSafeUser } from "./use-safe-clerk-i3mLLQVd.js";
...
import { R as ResponsiveContainer, C as Cell, T as Tooltip, X as XAxis, Y as YAxis, B as Bar } from "./generateCategoricalChart-BBhaWXxI.js";
...
import { C as CircleCheckBig } from "./circle-check-big-DQofdast.js";
...
function StockMovementsTab({ farmId, locationId }) {
  ...
  const [filterYear, setFilterYear] = reactExports.useState(String((/* @__PURE__ */ new Date()).getFullYear()));
  ...
  const deleteMov = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/storage-locations/${locationId}/movements/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["location-movements", farmId, locationId] });
      setDeleteMovId(null);
...
function MerchantChargesPanel({ farmId, locationId, location }) {
  ...
  const deleteCharge = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/storage-locations/${locationId}/charges/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["merchant-charges", farmId, locationId] });
  ...
  const autoGenMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/storage-locations/${locationId}/charges/auto-generate`, { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: (data) => {
      qc.invalidateQueries({ queryKey: ["merchant-charges", farmId, locationId] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 7, className: "px-0 py-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/20 border-t px-6 py-4 space-y-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: autoGenOpen, onOpenChange: (o) => {
      setAutoGenOpen(o);
      if (!o) setAutoGenForm(emptyAutoGen());
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 480 }, "aria-describedby": void 0, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
...
function GrainDryingTab({ farmId, locationId }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/grain-drying/${id}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["grain-drying", farmId, locationId] });
      setDeleteId(null);
...
function GrainConditioningTab({ farmId, locationId }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/grain-conditioning/${id}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["grain-conditioning", farmId, locationId] });
      setDeleteId(null);
      toast({ title: "Record deleted" });
...
function GrainMonitoringPanel({ farmId, locationId, locationType }) {
  ...
  const deleteTest = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/grain-quality-tests/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["grain-quality-tests", farmId, locationId] });
  ...
  const deleteTemp = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/grain-temperature-logs/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["grain-temperature-logs", farmId, locationId] });
...
function StorageLocationsPage() {
  ...
  const [mainTab, setMainTab] = reactExports.useState("locations");
  const saveMut = useMutation({
