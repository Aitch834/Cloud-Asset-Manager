const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-B8jsEK8O.js","assets/index-BKcsQW2l.js","assets/index-D-NU40dU.css","assets/typeof-WJl3ipnu.js"])))=>i.map(i=>d[i]);
import { r as reactExports, l as useQuery, j as jsxRuntimeExports, b as useAppStore, R as Redirect, c as Button, d as LoaderCircle, m as Card, n as CardContent, t as useQueryClient, O as useMutation, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, C as Checkbox, _ as __vitePreload, M as MapPin } from "./index-BKcsQW2l.js";
import { o as openPrintWindow } from "./print-report-B_FwCCVJ.js";
import { D as DocAttach } from "./DocAttach-DIDQlizr.js";
import { P as Printer } from "./printer-BplHN2gK.js";
import { T as TrendingUp, A as AppLayout, Q as LayoutDashboard, V as PiggyBank, j as Truck, q as Stethoscope, f as Scale, c as ClipboardList } from "./AppLayout-B8_1RkJL.js";
...
import { C as ComposedChart } from "./ComposedChart-B9-vJbWT.js";
...
import { P as Pill } from "./pill-PUVRaCwd.js";
import { F as FileText, C as ClipboardCheck } from "./shield-alert-CPHe-hz7.js";
import { U as UtensilsCrossed } from "./utensils-crossed-BTU64APS.js";
import { T as TriangleAlert } from "./triangle-alert-DP76btZo.js";
import { B as Baby } from "./baby-CXQ7AGx0.js";
import { S as ShieldCheck } from "./shield-check-CWBpqMg4.js";
import { S as Syringe } from "./syringe-DGZq_NSU.js";
import { A as Activity } from "./activity-Dq9PUq7A.js";
import { F as FileDown } from "./file-down-BxwXxuCh.js";
...
import { a as Clock } from "./database-BbsdnltO.js";
...
function TailBitingRisksTab({ farmId }) {
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/pig-tail-biting-risks/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["pig-tail-biting", farmId] }) });
...
function PigRedTractorChecklistTab({ farmId }) {
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/pig-red-tractor-checklists/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["pig-rt-checklist", farmId] }) });
...
async function generatePigAuditPDF(farmId) {
  const [jsPDFModule, autoTableModule] = await Promise.all([__vitePreload(() => import("./jspdf.es.min-B8jsEK8O.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), __vitePreload(() => import("./jspdf.plugin.autotable-rNuKHwSj.js"), true ? [] : void 0)]);
