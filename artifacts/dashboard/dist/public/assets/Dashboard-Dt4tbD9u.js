import { r as reactExports, f as useControllableState, j as jsxRuntimeExports, P as Primitive, g as composeEventHandlers, h as Presence, i as createContextScope, k as useComposedRefs, D as DismissableLayer, l as cn, m as useQuery, n as Card, o as CardContent, p as Link, A as ArrowRight, b as useAppStore, q as useGetFarmActivity, R as Redirect, M as MapPin } from "./index-BnjpV_Ud.js";
import { C as CalendarDays, L as Landmark, S as Sprout, W as Warehouse, u as useUserRole, A as AppLayout, a as Wheat, b as Layers, c as ClipboardList, d as Wrench, e as ChartColumn } from "./AppLayout-Fa2ZjcyU.js";
import { R as Root2$1, A as Anchor, c as createPopperScope, C as Content, a as Arrow } from "./index-D0GE8V3c.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-CJY4hRK_.js";
import { T as Tag } from "./tag-BB6-LdqN.js";
import { S as ShieldCheck } from "./shield-check-i-KPqyCE.js";
import { D as Droplets, F as FileText, C as ClipboardCheck, S as ShieldAlert, G as GraduationCap } from "./shield-alert-DtDMLgAz.js";
...
import { T as Tractor } from "./tractor-D4oo6-aL.js";
import { P as PawPrint } from "./paw-print-BTUzxfpP.js";
import { C as ChartLine } from "./chart-line-B2UTdlEW.js";
import { C as CloudRain } from "./cloud-rain-Bz1Gn30P.js";
import "./trash-2-Ae4Ay1fe.js";
...
function OrganicInspectionAlertPanel({ farmId }) {
  ...
  for (const r of records) {
    ...
    if (!existing || r.inspectionDate && (!existing.inspectionDate || r.inspectionDate > existing.inspectionDate)) {
      latestByCertifier.set(r.certifier, r);
    }
  }
  const alerts = Array.from(latestByCertifier.values()).filter((r) => r.nextDueDate != null).map((r) => ({ ...r, days: daysUntil(r.nextDueDate) })).filter((r) => new Date(r.nextDueDate).setHours(0, 0, 0, 0) <= in60Days.getTime()).sort((a, b) => a.days - b.days);
  if (alerts.length === 0) return null;
  const overdueCount = alerts.filter((a) => a.days < 0).length;
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Overview", children: [
    ...
    activeSubs.includes("organic-compliance") && /* @__PURE__ */ jsxRuntimeExports.jsx(OrganicInspectionAlertPanel, { farmId }),
