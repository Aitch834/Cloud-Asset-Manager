...
import { A as AppLayout, Z as Zap, E as Flame, c as ClipboardList } from "./AppLayout-BVlSEslh.js";
...
import { Q as QRCode } from "./browser-BBCpX_QU.js";
...
const buildPatEquipmentQrPayload = (farmId, assetNumber) => `BDE:F${farmId}:${assetNumber}`;
...
function PatTestingTab({ farmId, openId }) {
  ...
  const rowRefs = reactExports.useRef(/* @__PURE__ */ new Map());
  const autoOpened = reactExports.useRef(false);
  async function handlePrintLabel(eq) {
