const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-BNIrJNex.js","assets/index-D6khxeYT.js","assets/index-CvKl1u23.css"])))=>i.map(i=>d[i]);
import { b as useAppStore, r as reactExports, m as useQuery, j as jsxRuntimeExports, K as Map, p as Link, n as Card, I as Input, B as Building2, U as FlaskConical, M as MapPin, _ as __vitePreload } from "./index-D6khxeYT.js";
import { a as usePersistedFilter } from "./use-persisted-filter-CDyuFqsx.js";
import { A as AppLayout, O as Settings, W as Warehouse, g as TreePine, U as Users } from "./AppLayout-BaRj1j3r.js";
...
import { L as LayoutGrid } from "./layout-grid-RbXbCAGv.js";
...
function useFarmMap(containerRef, locations, onSelect) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-BNIrJNex.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
