const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-Db0hV3NX.js","assets/index-DBtws24D.js","assets/index-DusVVWCa.css","assets/typeof-WJl3ipnu.js"])))=>i.map(i=>d[i]);
import { r as reactExports, m as useQuery, j as jsxRuntimeExports, b as useAppStore, R as Redirect, d as Button, e as LoaderCircle, n as Card, o as CardContent, c as useQueryClient, a as useToast, O as useMutation, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, X as DialogMutationError, C as Checkbox, _ as __vitePreload, M as MapPin } from "./index-DBtws24D.js";
...
import { T as TrendingUp, A as AppLayout, Q as LayoutDashboard, V as PiggyBank, j as Truck, q as Stethoscope, f as Scale, c as ClipboardList } from "./AppLayout-BbMiFEbZ.js";
...
import { U as UtensilsCrossed } from "./utensils-crossed-Cd5MnSI2.js";
...
async function generatePigAuditPDF(farmId) {
  const [jsPDFModule, autoTableModule] = await Promise.all([__vitePreload(() => import("./jspdf.es.min-Db0hV3NX.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), __vitePreload(() => import("./jspdf.plugin.autotable-rNuKHwSj.js"), true ? [] : void 0)]);
