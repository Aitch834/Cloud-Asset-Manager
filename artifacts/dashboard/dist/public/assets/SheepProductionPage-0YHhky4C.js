import { r as reactExports, l as useQuery, j as jsxRuntimeExports, b as useAppStore, d as LoaderCircle, t as useQueryClient, a as useToast, O as useMutation, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, I as Input, C as Checkbox, L as Label } from "./index-D3ay9Ao3.js";
...
import { R as RaiseTaskDialog } from "./RaiseTaskDialog-B1Jrhc98.js";
import { P as Printer } from "./printer-D5Z3uuCG.js";
import { T as TrendingUp, A as AppLayout, Y as Scissors, f as Scale, e as ChartColumn, c as ClipboardList } from "./AppLayout-DRFFu3V0.js";
import { T as TrendingDown } from "./trending-down-BXTkzDSE.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar, C as Cell } from "./generateCategoricalChart-BwSoQy17.js";
...
import { C as ChevronDown, T as Trash2 } from "./trash-2-B3x8gsTz.js";
...
import { u as useFarmMembers } from "./use-farm-members-Dfj5e__3.js";
...
function TuppingTab({ farmId }) {
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/sheep-tupping-records/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["sheep-tupping", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
...
function ScanningTab({ farmId }) {
  ...
  const save = useMutation({
    mutationFn: (body) => {
      const url = editing ? api(`farms/${farmId}/sheep-scanning-records/${editing.id}`) : api(`farms/${farmId}/sheep-scanning-records`);
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/sheep-scanning-records/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["sheep-scanning", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
  const sf = (k, v) => setForm((f) => ({ ...f, [k]: v }));
...
function WeighTab({ farmId }) {
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/sheep-weigh-records/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["sheep-weigh", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
  const sf = (k, v) => setForm((f) => ({ ...f, [k]: v }));
...
function WeighingEquipmentTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/weighing-equipment/${id}`), { method: "DELETE", credentials: "include" }),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["weighing-equipment", farmId] }),
    onError: () => toast({ title: "Delete failed", variant: "destructive" })
  });
  const saveCal = useMutation({
    mutationFn: (body) => fetch(api(`farms/${farmId}/weighing-equipment/${viewing.id}/calibrations`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }),
    onSuccess: () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: calOpen, onOpenChange: setCalOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { children: [
...
function ShearingTab({ farmId }) {
  ...
  const save = useMutation({
    mutationFn: (body) => {
      const url = editing ? api(`farms/${farmId}/sheep-shearing-records/${editing.id}`) : api(`farms/${farmId}/sheep-shearing-records`);
      return fetch(url, { method: editing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) });
    },
    onSuccess: () => {
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/sheep-shearing-records/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["sheep-shearing", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
  const sf = (k, v) => setForm((f) => ({ ...f, [k]: v }));
...
function HealthTab({ farmId }) {
  ...
  const saveVacc = useMutation({ mutationFn: (body) => {
    const url = editing ? api(`farms/${farmId}/sheep-vaccination-programmes/${editing.id}`) : api(`farms/${farmId}/sheep-vaccination-programmes`);
    return fetch(url, { method: editing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) });
  }, onSuccess: () => {
  ...
  const saveDisease = useMutation({ mutationFn: (body) => {
    const url = editing ? api(`farms/${farmId}/sheep-disease-monitoring/${editing.id}`) : api(`farms/${farmId}/sheep-disease-monitoring`);
    return fetch(url, { method: editing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) });
  }, onSuccess: () => {
  ...
  const delVacc = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/sheep-vaccination-programmes/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["sheep-vacc", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
  const delDisease = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/sheep-disease-monitoring/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["sheep-disease", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
  const sf = (k, v) => setForm((f) => ({ ...f, [k]: v }));
...
function RTChecklistTab({ farmId }) {
  ...
  const save = useMutation({ mutationFn: (body) => {
    const url = editing ? api(`farms/${farmId}/sheep-rt-checklists/${editing.id}`) : api(`farms/${farmId}/sheep-rt-checklists`);
    return fetch(url, { method: editing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) });
  }, onSuccess: () => {
  ...
  const del = useMutation({ mutationFn: (id) => fetch(api(`farms/${farmId}/sheep-rt-checklists/${id}`), { method: "DELETE", credentials: "include" }), onSuccess: () => qc.invalidateQueries({ queryKey: ["sheep-rt", farmId] }), onError: () => toast({ title: "Delete failed", variant: "destructive" }) });
  const sf = (k, v) => setForm((f) => ({ ...f, [k]: v }));
...
function SheepAnalyticsTab({ farmId }) {
  const { data: scanning = [] } = useQuery({ queryKey: ["sheep-scanning", farmId], queryFn: () => fetch(api(`farms/${farmId}/sheep-scanning-records`), { credentials: "include" }).then((r) => r.json()) });
  const { data: weigh = [] } = useQuery({ queryKey: ["sheep-weigh", farmId], queryFn: () => fetch(api(`farms/${farmId}/sheep-weigh-records`), { credentials: "include" }).then((r) => r.json()) });
  const { data: shearing = [] } = useQuery({ queryKey: ["sheep-shearing", farmId], queryFn: () => fetch(api(`farms/${farmId}/sheep-shearing-records`), { credentials: "include" }).then((r) => r.json()) });
  const { data: tupping = [] } = useQuery({ queryKey: ["sheep-tupping", farmId], queryFn: () => fetch(api(`farms/${farmId}/sheep-tupping-records`), { credentials: "include" }).then((r) => r.json()) });
...
function SheepProductionPage() {
  ...
  const [tab, setTab] = reactExports.useState("tupping");
  if (!farmId) {
