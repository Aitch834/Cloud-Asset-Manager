import { b as useAppStore, r as reactExports, a as useToast, c as useQueryClient, m as useQuery, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, M as MapPin, e as LoaderCircle, O as React, X, A as ArrowRight, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, N as DialogMutationError, J as DialogFooter, C as Checkbox } from "./index-CPTnvEXt.js";
...
import { A as AppLayout, a as Wheat, G as Gauge, e as ChartColumn, j as Truck, I as Info, E as Flame, Z as Zap, c as ClipboardList, f as Scale, T as TrendingUp, J as CloudSun } from "./AppLayout-BwXO7xhU.js";
...
import { P as PoundSterling, F as FileText } from "./shield-alert-B7niEs8n.js";
...
import { F as FileCheck } from "./file-check-DDpc1NuK.js";
...
function StrawSaleInvoicePrint({ sale, farmId, onClose }) {
  ...
  const { data: farm } = useQuery({
    ...
    queryFn: () => fetch(`/api/farms/${farmId}`, { credentials: "include" }).then((r) => r.json()).then((response) => response.record ?? response),
    staleTime: 6e4
  });
...
function StrawManagementPage() {
  ...
  const { data: farmDetail } = useQuery({
    ...
    queryFn: () => fetch(`/api/farms/${farmId}`, { credentials: "include" }).then((r) => r.ok ? r.json() : null).then((response) => response?.record ?? response),
    enabled: !!farmId,
    staleTime: 3e5
  });
