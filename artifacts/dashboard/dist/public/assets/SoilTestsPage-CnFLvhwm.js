...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, _ as ReferenceLine } from "./generateCategoricalChart-DgqQgZxT.js";
import { L as LineChart } from "./LineChart-DLlfhBCE.js";
import { C as CartesianGrid } from "./CartesianGrid-DFbS8pBB.js";
import { L as Line } from "./Line-CytDvMPL.js";
import { C as Cpu } from "./cpu-zQ5nex84.js";
import { C as CircleCheckBig } from "./circle-check-big-BUS1H59b.js";
import { I as Info, A as AppLayout, T as TrendingUp, i as TestTube, U as Users } from "./AppLayout-BDmxP4Lp.js";
import { C as CircleAlert, a as Clock } from "./database-CQgHlEm4.js";
import { o as openPrintWindow } from "./print-report-B_FwCCVJ.js";
import { C as CropYearSelector } from "./CropYearSelector-Kou0T19b.js";
...
import { E as Ellipsis } from "./ellipsis-BfK1qSc5.js";
import { A as Archive } from "./archive-DmsyIPyg.js";
import { H as History } from "./history-ooMyCs4j.js";
import { U as UserCheck } from "./user-check-9L09aEKQ.js";
...
import "./triangle-alert-B8QTyc48.js";
...
function CsvImportDialog({ open, onClose, probe, farmId }) {
  ...
  const doImport = async () => {
    ...
    const lines = text.trim().split(/\r?\n/);
    const headers = lines[0].split(",").map((h) => h.trim().replace(/^"|"$/g, "").toLowerCase());
    const rowVals = lines.slice(1).map((line) => {
      const vals = line.split(",").map((v) => v.trim().replace(/^"|"$/g, ""));
