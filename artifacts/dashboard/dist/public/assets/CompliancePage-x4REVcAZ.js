import { b as useAppStore, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, d as Button, L as Label, I as Input, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, N as DialogMutationError, O as React } from "./index-BEkyPlmL.js";
import { u as usePersistedTab } from "./use-persisted-tab-CMS2fV0R.js";
import { A as AppLayout, r as Bug, I as Info } from "./AppLayout-Dg7puaaH.js";
...
import { a as printElementReport, e as escapeHtml } from "./print-report-ClU8-1P0.js";
...
function CompliancePage() {
  ...
  function printPlan() {
    ...
    printElementReport(document.querySelector("[data-compliance-plan-report]"), {
      ...
      farmName: typeof fd?.name === "string" ? fd.name : void 0,
      farmAddress: fd?.address ? String(fd.address) : void 0,
      cphNumber: fd?.cphNumber ? String(fd.cphNumber) : void 0,
      sbiNumber: fd?.sbiNumber ? String(fd.sbiNumber) : void 0,
      redTractorId: fd?.redTractorId ? String(fd.redTractorId) : void 0,
  ...
  function printDeclarationForm() {
    ...
    const escapedFormVersion = escapeHtml((/* @__PURE__ */ new Date()).toLocaleDateString("en-GB", { month: "long", year: "numeric" }));
...
<div class="footer">
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Compliance & Contingency Plans", children: [
    ...
    tab === "biosecurity" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl", "data-compliance-plan-report": true, children: [
    ...
    tab === "contingency" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl", "data-compliance-plan-report": true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
