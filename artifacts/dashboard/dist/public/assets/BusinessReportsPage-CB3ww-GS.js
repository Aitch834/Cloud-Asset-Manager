import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, d as Button, m as useQuery, c as useQueryClient, S as useMutation } from "./index-DK42mN77.js";
...
import { A as AppLayout, e as ChartColumn, T as TrendingUp } from "./AppLayout-UUn9I45b.js";
...
function GrossMarginTab({ farmId, year, onRegisterExport }) {
  ...
  const agriEnvTxIncome = costs.filter((t) => t.category === "Agri-Environment Scheme").reduce((s, t) => s + (t.amountPence ?? 0), 0);
...
function PLTab({ farmId, year, onRegisterExport }) {
  ...
  const agriEnvSchemeTxs = costs.filter((t) => t.category === "Agri-Environment Scheme" && t.transactionType === "income");
  const unlinkedAgriEnvTxTotal = agriEnvSchemeTxs.filter((t) => !t.agriEnvProjectId).reduce((s, t) => s + (t.amountPence ?? 0), 0);
    ...
    onRegisterExport(() => {
      const rows = [
        ...
        ...agriEnvYearTotal > 0 ? [
          ...
          ...agriEnvActiveProjects.length > 1 ? agriEnvActiveProjects.map((p) => [`  ↳ ${p.schemeName}`, fmt(p.yearClaimedPence), ""]) : []
        ] : [],
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
      ...
      agriEnvYearTotal > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        agriEnvActiveProjects.length > 1 && agriEnvActiveProjects.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { background: "#f7fef9" }, children: [
...
const MILESTONE_STATUSES = ["pending", "submitted", "paid", "overdue"];
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { colSpan: 6, style: { padding: 0 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "0.8rem" }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: pMilestones.map((ms, mi) => {
                        ...
                        const needsDate = (s) => (s === "submitted" || s === "paid") && !ms.completionDate;
