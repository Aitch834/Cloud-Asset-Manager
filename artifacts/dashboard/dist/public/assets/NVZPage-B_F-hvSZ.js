import { b as useAppStore, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, I as Input, d as Button, T as Plus, U as FlaskConical, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, N as DialogMutationError } from "./index-DImoRxln.js";
...
import { A as AppLayout, I as Info, c as ClipboardList, U as Users } from "./AppLayout-3zwW38j4.js";
...
import { a as TabButton } from "./tab-button-r3HbhExw.js";
...
import { D as Droplets } from "./shield-alert-jNystpln.js";
...
function NVZPage() {
  ...
  const [tab, setTab] = usePersistedTab({ page: "nvz", farmId, validIds: ["summary", "log", "risk-assessments", "closed-periods", "budget-calc", "contacts"], defaultTab: "summary" });
  const [selectedYear, setSelectedYear] = usePersistedNumberFilter({ page: "nvz", filter: "year", farmId, defaultValue: (/* @__PURE__ */ new Date()).getFullYear() });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "NVZ Compliance", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: formOpen, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: editRecord ? updateMut : addMut, message: "Failed to save — your entries are still here." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteId !== null, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deleteMut, message: "Failed to delete — the record is still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "mt-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: raAddOpen || !!raEditItem, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: raEditItem ? raUpdateMut : raCreateMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "mt-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: raDeleteId !== null, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: raDeleteMut, message: "Failed to delete — the record is still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "mt-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: contactAddOpen || !!contactEditItem, onOpenChange: (open) => {
      if (!open) {
        setContactAddOpen(false);
        setContactEditItem(null);
        contactCreateMut.reset();
        contactUpdateMut.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: contactEditItem ? contactUpdateMut : contactCreateMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => {
          setContactAddOpen(false);
          setContactEditItem(null);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: contactDeleteId !== null, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: contactDeleteMut, message: "Failed to remove — the contact is still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "mt-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: nvzEditField !== null, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: nvzEditMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "mt-4", children: [
