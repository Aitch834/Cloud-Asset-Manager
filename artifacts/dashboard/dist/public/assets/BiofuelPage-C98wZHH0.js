import { s as createLucideIcon, b as useAppStore, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, M as MapPin, B as Building2, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, N as DialogMutationError } from "./index-Dnqxw-hJ.js";
import { O as OtherSelect } from "./other-select-Ls2KB1ri.js";
import { u as useLookupStrings } from "./use-lookup-BCZPZiwv.js";
import { A as AppLayout, e as ChartColumn, j as Truck, I as Info } from "./AppLayout-BVlSEslh.js";
...
function BiofuelPage() {
  ...
  const [activeTab, setActiveTab] = usePersistedTab({ page: "biofuel", farmId, validIds: ["overview", "certification", "fields", "buyers", "deliveries"], defaultTab: "overview" });
  ...
  reactExports.useEffect(() => {
    if (pendingConfirm?.mutation?.isSuccess) setPendingConfirm(null);
  }, [pendingConfirm?.mutation?.isSuccess]);
  ...
  const deleteCertMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/biofuel/certification/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
  ...
  const deleteFieldMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/biofuel/field-declarations/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteDeliveryMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/biofuel/deliveries/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deactivateBuyerMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/biofuel/buyers/${id}/deactivate`, { method: "PATCH" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
      ...
      activeTab === "certification" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        certs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", borderRadius: 12, padding: 48, textAlign: "center", border: "1px solid #e5e7eb" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", onClick: () => {
              deleteCertMut.reset();
              setPendingConfirm({ title: "Delete Certification", msg: "Delete this certification record? This cannot be undone.", fn: () => deleteCertMut.mutate(cert.id), mutation: deleteCertMut });
            }, style: { color: "#dc2626" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14 }) })
          ] })
        ] }, cert.id)) })
      ] }),
        ...
        fields.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", borderRadius: 12, padding: 48, textAlign: "center", border: "1px solid #e5e7eb" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: fields.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: i < fields.length - 1 ? "1px solid #f3f4f6" : "none" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "12px 16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 6 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", style: { color: "#dc2626" }, onClick: () => {
                deleteFieldMut.reset();
                setPendingConfirm({ title: "Delete Declaration", msg: "Delete this field land eligibility declaration? This cannot be undone.", fn: () => deleteFieldMut.mutate(f.id), mutation: deleteFieldMut });
      ...
      activeTab === "deliveries" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        deliveries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", borderRadius: 12, padding: 48, textAlign: "center", border: "1px solid #e5e7eb" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, flexShrink: 0 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", style: { color: "#dc2626" }, onClick: () => {
              deleteDeliveryMut.reset();
              setPendingConfirm({ title: "Delete Delivery", msg: "Delete this delivery record? This cannot be undone.", fn: () => deleteDeliveryMut.mutate(d.id), mutation: deleteDeliveryMut });
...
function CertificationDialog({ open, onClose, initial, onSave, saving, mutation }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 560 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation, message: "Failed to save — your entries are still here." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
