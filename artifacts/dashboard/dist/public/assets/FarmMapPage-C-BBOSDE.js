const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-T1BKLx71.js","assets/index-D-jKMZvJ.js","assets/index-CNUbH-zj.css"])))=>i.map(i=>d[i]);
import { b as useAppStore, r as reactExports, l as useQuery, j as jsxRuntimeExports, K as Map, o as Link, m as Card, I as Input, B as Building2, T as FlaskConical, M as MapPin, _ as __vitePreload } from "./index-D-jKMZvJ.js";
import { A as AppLayout, O as Settings, W as Warehouse, g as TreePine, U as Users } from "./AppLayout-DvS9fOSf.js";
...
function useFarmMap(containerRef, locations, onSelect) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-T1BKLx71.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
