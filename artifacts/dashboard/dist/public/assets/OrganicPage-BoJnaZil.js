import { b as useAppStore, r as reactExports, l as useQuery, j as jsxRuntimeExports, R as Redirect, T as FlaskConical, a as useToast, t as useQueryClient, O as useMutation, d as LoaderCircle, c as Button, S as Plus, m as Card, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, L as Label, I as Input, ay as Check } from "./index-DVTlKOh9.js";
import { A as AppLayout, c as ClipboardList, B as BookOpen, I as Info } from "./AppLayout-BIJWl-oS.js";
import { T as TabBar, a as TabButton } from "./tab-button-BHo_YKDF.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-ngSojBZs.js";
import { C as Command, a as CommandInput, b as CommandList, c as CommandEmpty, d as CommandGroup, e as CommandItem } from "./command-Byh6cNc1.js";
import { R as RaiseTaskDialog } from "./RaiseTaskDialog-B2bQumOA.js";
import { T as Textarea } from "./textarea-X2OVCz6L.js";
import { D as DocAttach } from "./DocAttach-kWx-RGhr.js";
import { L as Leaf } from "./triangle-alert-DBB24Am8.js";
import { S as ShieldCheck } from "./shield-check-C5aR4326.js";
import { E as ExternalLink } from "./external-link-BvxKCuGP.js";
...
function printInspectionRegister(records, farmName) {
...
function CertificationTab({ farmId }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/organic/certification`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, ...body }) => fetch(`/api/farms/${farmId}/organic/certification/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-cert", farmId] });
      setEditRecord(null);
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic/certification/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-cert", farmId] });
      setDeleteId(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: openAdd, children: [
...
function FieldsTab({ farmId, farmName }) {
  ...
  const createM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/organic/fields`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/organic/fields/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-fields", farmId] });
      setFormOpen(false);
      setEditing(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        records.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => printFieldStatusRegister(records, farmName), className: "gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteId !== null, onOpenChange: (v) => !v && setDeleteId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
...
function InspectionsTab({ farmId, farmName }) {
  ...
  const records = data?.records ?? [];
  const createM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/organic/inspections`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/organic/inspections/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-inspections", farmId] });
      setFormOpen(false);
      setEditing(null);
  ...
  const deleteM = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic/inspections/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-inspections", farmId] });
      setDeleteId(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: () => printInspectionRegister(records, farmName), disabled: records.length === 0, className: "gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "w-4 h-4" }),
        "Print Register"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => {
    ...
    records.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-1", children: "No inspections recorded" }),
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: records.map((r) => {
...
function RestrictedInputsTab({ farmId, farmName }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    records.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => printRestrictedInputsLog(records, farmName), className: "gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "w-4 h-4" }),
      "Print Restricted Inputs Log"
    ] }) }),
    records.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-8 text-center", children: [
...
function InputRegisterTab({ farmId, farmName }) {
  ...
  const createM = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/organic/inputs`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateM = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/organic/inputs/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-inputs", farmId] });
      setFormOpen(false);
      setEditing(null);
  ...
  const deleteM = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic/inputs/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-inputs", farmId] });
      setDeleteId(null);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        records.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => printInputRegister(records, farmName, yearFilter === "all" ? null : yearFilter), className: "gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "w-4 h-4" }),
            "Print Register"
          ] })
        ] })
...
function OrganicPage() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("certification");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-6 space-y-6", children: [
    ...
    activeTab === "certification" && /* @__PURE__ */ jsxRuntimeExports.jsx(CertificationTab, { farmId }),
