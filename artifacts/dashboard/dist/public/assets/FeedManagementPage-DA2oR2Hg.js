import { b as useAppStore, a as useToast, c as useQueryClient, m as useQuery, r as reactExports, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, M as MapPin, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, N as DialogMutationError, J as DialogFooter, H as DialogDescription } from "./index-DImoRxln.js";
...
import { A as AppLayout, I as Info, j as Truck } from "./AppLayout-3zwW38j4.js";
...
import { C as CircleX } from "./circle-x-BhNaQlkV.js";
import { P as Package } from "./use-safe-clerk-D_3ZxoO7.js";
import { C as CircleCheck } from "./circle-check-ajiu3vQo.js";
import { C as CircleAlert, a as Clock } from "./database-D57eqhDv.js";
import { G as GitBranch } from "./git-branch-CCtP8bcR.js";
...
import { a as ArrowDown, A as ArrowUp } from "./arrow-up-DwcQlIRN.js";
...
function FeedManagementPage() {
  ...
  const [pendingDeleteFpo, setPendingDeleteFpo] = reactExports.useState(null);
  function openFpoAdd() {
    setEditFpo(null);
    setFpoForm({
      supplierName: "",
  ...
  const deleteFpoMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/feed-purchase-orders/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
  ...
  const delDeliveryMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/feed-deliveries/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const delStockMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/feed-stock/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Feed Management", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showDeliveryDialog, onOpenChange: (o) => {
      setShowDeliveryDialog(o);
      if (!o) deliveryMut.reset();
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deliveryMut, message: "Failed to save — your entries are still here." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showStockDialog, onOpenChange: (o) => {
      setShowStockDialog(o);
      if (!o) stockMut.reset();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-xl max-h-[92vh] overflow-y-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: stockMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      ...
      filteredFpos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16 text-gray-400", children: [
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-lg border p-4 ${isOverdue ? "border-red-300 bg-red-50" : isReceived ? "border-green-200 bg-green-50/60" : isCancelled ? "border-gray-200 bg-gray-50/60" : "border-amber-200 bg-white"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-xs px-2 py-1 rounded border border-red-200 text-red-600 bg-white hover:bg-red-50 flex items-center transition-colors", onClick: () => setPendingDeleteFpo(Number(fpo.id)), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3 h-3" }) })
          ] })
        ] }) }, String(fpo.id));
      }) })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!reorderBin, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: reorderMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showFpoDialog, onOpenChange: (v) => {
      if (!v) {
        setShowFpoDialog(false);
        fpoMut.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: fpoMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: receiveId !== null, onOpenChange: (v) => {
      if (!v) {
        setReceiveId(null);
        receiveFpoMut.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: receiveFpoMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        ...
        onConfirm: () => {
          if (pendingDeleteFpo !== null) deleteFpoMut.mutate(pendingDeleteFpo, { onSuccess: () => setPendingDeleteFpo(null) });
        },
        onCancel: () => {
          setPendingDeleteFpo(null);
          deleteFpoMut.reset();
        }
      }
    )
...
function MedicatedFeedTab({ farmId }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/medicated-feed/${id}`, { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
