const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src--mNsI0y-.js","assets/index-Cgwa2fkn.js","assets/index-CAOhs4IG.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, n as Card, o as CardContent, c as useQueryClient, a as useToast, O as useMutation, S as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, X as DialogMutationError, K as Map } from "./index-Cgwa2fkn.js";
import { L as LabSelector } from "./LabSelector-Dw6vVM_i.js";
import { P as Printer } from "./printer-F9DFLNWF.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-CoWsB4Q_.js";
...
import { C as ChevronDown, T as Trash2 } from "./trash-2-4wGGdwwT.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-D8J6skGX.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src--mNsI0y-.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
