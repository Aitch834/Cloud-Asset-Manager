...
import { s as createLucideIcon, b as useAppStore, r as reactExports, _ as __vitePreload, j as jsxRuntimeExports, c as useQueryClient, a as useToast, m as useQuery, S as useMutation, U as FlaskConical, d as Button, T as Plus, K as Map, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, N as DialogMutationError, J as DialogFooter, M as MapPin, e as LoaderCircle } from "./index-Dnqxw-hJ.js";
...
import { C as CropYearSelector } from "./CropYearSelector-CLGPiieh.js";
import { b as cropYearLabel, c as currentCropYear, i as isInCropYear } from "./cropYear-Dmv-iNR6.js";
import { A as AppLayout, h as List, S as Sprout, a as Wheat, i as TestTube, e as ChartColumn, N as Navigation } from "./AppLayout-BVlSEslh.js";
...
import { C as CircleCheckBig } from "./circle-check-big-D-JNMTvY.js";
import { C as ChevronLeft } from "./chevron-left-CWV4q5Ts.js";
import { F as FileText } from "./shield-alert-B9V96hAV.js";
import { E as Eye } from "./eye-Bn13R6Dr.js";
import { M as MessageSquare } from "./message-square-DX7BTmdE.js";
...
import { A as ArrowUpRight } from "./arrow-up-right-SQlomqyn.js";
...
function TrialMapView({ trials, cropYear }) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-nQ_jVHIf.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
...
function TrialDetailView({ trial, farmId, onBack, fields }) {
  ...
  const addCommMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/crop-trials/${trial.id}/communications`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteCommMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/crop-trials/${trial.id}/communications/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const addPlotMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/crop-trials/${trial.id}/plots`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deletePlotMut = useMutation({
    mutationFn: (plotId) => fetch(`/api/farms/${farmId}/crop-trials/${trial.id}/plots/${plotId}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const addTreatmentMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/crop-trials/${trial.id}/plots/${selectedPlot.id}/treatments`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const addObsMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/crop-trials/${trial.id}/plots/${selectedPlot.id}/observations`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const addYieldMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/crop-trials/${trial.id}/plots/${selectedPlot.id}/yields`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addPlotOpen, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: addPlotMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    deletePlotId !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => {
      if (!o) {
        setDeletePlotId(null);
        deletePlotMut.reset();
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: deletePlotMut, message: "Failed to delete — please try again." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addTreatmentOpen, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: addTreatmentMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addObsOpen, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: addObsMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addYieldOpen, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogMutationError, { mutation: addYieldMut, message: "Failed to save — your entries are still here." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
...
function CropTrialsPage() {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/crop-trials`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/crop-trials/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/crop-trials/${id}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
