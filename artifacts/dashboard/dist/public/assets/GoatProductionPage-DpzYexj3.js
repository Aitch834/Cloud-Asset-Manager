import { r as reactExports, m as useQuery, j as jsxRuntimeExports, b as useAppStore, e as LoaderCircle, c as useQueryClient, a as useToast, S as useMutation, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, I as Input, C as Checkbox, L as Label, N as DialogMutationError } from "./index-DK42mN77.js";
...
import { T as TrendingUp, A as AppLayout, f as Scale, e as ChartColumn, c as ClipboardList } from "./AppLayout-UUn9I45b.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6 max-w-6xl", children: [
    ...
    goatAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm ${goatAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : goatAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        goatAlert.date && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 opacity-70 text-xs", children: [
          "Issued ",
          goatAlert.date
        ] })
      ] })
