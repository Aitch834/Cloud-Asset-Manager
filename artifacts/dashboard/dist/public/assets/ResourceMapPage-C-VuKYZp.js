const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-5lgNjl51.js","assets/index-BBuRpIbX.js","assets/index-CBkBuZTA.css"])))=>i.map(i=>d[i]);
import { s as createLucideIcon, b as useAppStore, r as reactExports, m as useQuery, j as jsxRuntimeExports, M as MapPin, _ as __vitePreload } from "./index-BBuRpIbX.js";
import { A as AppLayout, N as Navigation, Z as Zap, j as Truck, O as Settings } from "./AppLayout-PQ5TRDgt.js";
...
function useResourceMap(containerRef, pings, assets) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-5lgNjl51.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
