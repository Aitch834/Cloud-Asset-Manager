import { q as createLucideIcon, b as useAppStore, a as useToast, t as useQueryClient, l as useQuery, O as useMutation, r as reactExports, j as jsxRuntimeExports, R as Redirect, m as Card, n as CardContent, L as Label, I as Input, M as MapPin, c as Button, d as LoaderCircle, C as Checkbox, $ as X, B as Building2, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter } from "./index-CH03FTk5.js";
import { u as useUpload } from "./use-upload-Dc07KN3y.js";
import { A as AppLayout, n as LogOut, j as Truck } from "./AppLayout-BxE6YHy9.js";
...
import { C as Copy } from "./copy-DKsZm80x.js";
...
import { U as UserRound } from "./user-round-DJa-7V0M.js";
...
import { K as Key } from "./key-Ds6Me6I1.js";
import { I as Image } from "./image-DDIC2ypq.js";
import { U as Upload } from "./upload-DinYu9tt.js";
import { C as CreditCard } from "./credit-card-BTyTVwaN.js";
...
function BcmsCredentialsCard({ farmId, bcmsHoldingNumber }) {
  ...
  const saveMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/bcms-credentials`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
...
function FarmSettings() {
  ...
  const handleSave = () => {
    ...
    updateFarm({
      ...
      postcode: formData.postcode.trim() || void 0,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Single Business Identifier (Rural Payments Agency)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    formData.sectors.sectorViticulture && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
            "Issued by the ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Food Standards Agency" }),
            " (FSA) when you register a vineyard or winery at food.gov.uk. This is your holding-level wine production registration — separate from the per-block FSA Vine Register entries in the Viticulture module."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Include country code if outside the UK" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
