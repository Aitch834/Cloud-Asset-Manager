import { r as reactExports, m as useQuery, j as jsxRuntimeExports, b as useAppStore, u as useLocation } from "./index-XTnQG40m.js";
import { u as usePersistedTab } from "./use-persisted-tab-Bsr31cbJ.js";
import { d as Wrench, F as Fuel, A as AppLayout, T as TrendingUp } from "./AppLayout-CHbvi0yr.js";
...
import { C as ChevronDown } from "./trash-2-eLoXoyLO.js";
import { C as ChevronRight, T as Tractor } from "./tractor-P6EmQ9Bl.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: reportRef, className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3 no-print", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => printElementReport(reportRef.current, { title: "Fleet Cost Report", subtitle: `${year} fleet cost analysis`, farmName }), className: "h-9 px-3 rounded-lg border border-border bg-background text-sm flex items-center gap-1.5 hover:bg-muted/50", children: [
