...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, _ as ReferenceLine } from "./generateCategoricalChart-ChTjMMmR.js";
...
import { I as Info, A as AppLayout, T as TrendingUp, i as TestTube, U as Users } from "./AppLayout-FSCQu3Bg.js";
...
import { E as Ellipsis } from "./ellipsis-pXFFaf61.js";
import { A as Archive } from "./archive-D1x-djdh.js";
...
function SoilLocationPicker({ lat, lng, locationDescription, onLatLngChange, onDescriptionChange }) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-BJeJQAyV.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
