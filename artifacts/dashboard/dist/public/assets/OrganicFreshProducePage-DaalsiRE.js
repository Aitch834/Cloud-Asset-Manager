import { b as useAppStore, m as useQuery, j as jsxRuntimeExports, n as Card, U as FlaskConical, c as useQueryClient, a as useToast, r as reactExports, S as useMutation, d as Button, T as Plus, e as LoaderCircle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, L as Label, I as Input, N as DialogMutationError, O as React } from "./index-Cyec2zqN.js";
...
import { A as AppLayout, W as Warehouse, I as Info, c as ClipboardList } from "./AppLayout-BrjK6Ogn.js";
...
import { CropsTab, WaterTestsTab, HarvestTab, IntakeTab, PackhouseTab, AllergenTab } from "./FreshProducePage-DmMzEGwF.js";
...
import { F as FileText, D as Droplets } from "./shield-alert-8xr2y_zZ.js";
import { P as Package } from "./use-safe-clerk-BemvNBL1.js";
import { T as Thermometer } from "./thermometer-gFPz0em_.js";
...
import "./LabSelector-C9m9jhEg.js";
...
import "./layout-grid-C4R4wRwS.js";
import "./archive-wE84VUcP.js";
...
function printFpInputLog(rows, farmName, yearLabel) {
  ...
  const rowsHtml = rows.map((r) => {
    ...
    if (needsDerogCol && r.derogationExpiryDate) {
      const expiryMs = new Date(r.derogationExpiryDate).setHours(0, 0, 0, 0);
      const formatted = new Date(r.derogationExpiryDate).toLocaleDateString("en-GB");
      const daysLeft = Math.round((expiryMs - todayMs) / 864e5);
      derogCell = expiryMs < todayMs ? `<span class="expiry-expired">${formatted}</span>` : formatted;
      daysCell = expiryMs < todayMs ? `<span class="expiry-expired">${daysLeft}</span>` : String(daysLeft);
    }
    return `
    <tr>
  ...
  downloadCsvFile(`fp-input-log${yearPart}-${slug}.csv`, [
    ...
    ...rows.map((r) => {
      ...
      if (needsDerог && r.derogationExpiryDate) {
        ...
        const expiryMs = new Date(r.derogationExpiryDate).setHours(0, 0, 0, 0);
        daysRemaining = Math.round((expiryMs - todayMs) / 864e5);
      }
      return [
