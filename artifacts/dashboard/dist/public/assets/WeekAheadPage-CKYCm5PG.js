import { s as createLucideIcon, b as useAppStore, j as jsxRuntimeExports, R as Redirect, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, l as cn, p as Link, T as Plus, e as LoaderCircle, n as Card, aO as toast, X, A as ArrowRight } from "./index-D5ac2D7t.js";
import { A as AppLayout, C as CalendarDays, P as Boxes, d as Wrench, j as Truck } from "./AppLayout-CBaXLtVv.js";
...
function TaskCard({
  ...
  const inner = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      ...
      ["organic_fp_input_log_derogation_expiry", "organic_fp_derogation_expiry"].includes(task.type) && task.dueDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: cn("text-xs font-semibold mt-1.5 flex items-center gap-1", overdue ? "text-red-600" : "text-amber-600"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3" }),
        overdue ? "Expired" : "Expires",
        " ",
        new Date(task.dueDate).toLocaleDateString("en-GB", { day: "numeric", month: "short", year: "numeric" })
      ] }),
      overdue && !["organic_fp_input_log_derogation_expiry", "organic_fp_derogation_expiry"].includes(task.type) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-red-600 mt-1.5 flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3" }),
        Math.abs(days),
        " day",
        Math.abs(days) !== 1 ? "s" : "",
