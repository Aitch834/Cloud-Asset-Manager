import { q as createLucideIcon, b as useAppStore, r as reactExports, l as useQuery, j as jsxRuntimeExports, t as useQueryClient, a as useToast, O as useMutation, c as Button, S as Plus, M as MapPin, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, d as LoaderCircle, B as Building2, A as ArrowRight, $ as X, b2 as printHtml } from "./index-D3ay9Ao3.js";
import { A as AppLayout, T as TrendingUp, U as Users, c as ClipboardList, a as Wheat, e as ChartColumn, C as CalendarDays, F as Fuel } from "./AppLayout-DRFFu3V0.js";
...
import { R as Receipt } from "./receipt-CJAdAERG.js";
import { T as Tractor, A as ArrowLeft } from "./tractor-CO_kLi01.js";
...
import { F as FileText, S as ShieldAlert, C as ClipboardCheck } from "./shield-alert-B8JTZTuq.js";
...
import { S as SquareCheckBig } from "./square-check-big-DS5uHshX.js";
import { C as Circle } from "./circle-RUSIM0TD.js";
import { U as User } from "./user-DRDR8ci5.js";
...
function CustomersTab({ farmId, customers, isLoading }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/farm-customers/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["farm-customers", farmId] });
...
function AgreementsTab({ farmId, customers }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/service-agreements/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["service-agreements", farmId] });
...
function GrainIntakeTab({ farmId, customers }) {
  ...
  const saveMv = useMutation({
    mutationFn: ({ intakeId, body }) => fetch(`/api/farms/${farmId}/grain-intakes/${intakeId}/movements`, { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const deleteMv = useMutation({
    mutationFn: ({ intakeId, mvId }) => fetch(`/api/farms/${farmId}/grain-intakes/${intakeId}/movements/${mvId}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["grain-movements", farmId, expandedId] });
...
function WorkOrdersTab({ farmId, customers, onRaiseInvoice }) {
  ...
  const createMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/task-assignments`, { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/task-assignments/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["work-orders", farmId] });
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/task-assignments/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["work-orders", farmId] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  onClick: () => {
                    if (confirm(`Delete work order ${wo.workOrderRef ?? wo.title}?`)) deleteMut.mutate(wo.id);
                  },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 520 }, "aria-describedby": void 0, children: [
...
function InvoicesTab({ farmId, customers, prefill }) {
  ...
  const saveMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/service-invoices`, { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(body) }).then((r) => r.json()),
  ...
  const markPaid = useMutation({
    mutationFn: ({ id, paymentDate }) => fetch(`/api/farms/${farmId}/service-invoices/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ status: "paid", paymentDate }) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["service-invoices", farmId] });
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/service-invoices/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["service-invoices", farmId] });
...
function HireBookingDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl max-h-[90vh] overflow-y-auto", children: [
...
function BookingDetailPanel({
  ...
  const deleteCondMut = useMutation({
    mutationFn: (condId) => fetch(`/api/farms/${farmId}/equipment-hire/${bookingId}/conditions/${condId}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["hire-booking-detail", farmId, bookingId] });
  ...
  const deleteFuelMut = useMutation({
    mutationFn: (fuelId) => fetch(`/api/farms/${farmId}/equipment-hire/${bookingId}/fuel/${fuelId}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["hire-booking-detail", farmId, bookingId] });
...
function EquipmentHireTab({
  ...
  const cancelMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/equipment-hire/${id}`, { method: "DELETE", credentials: "include" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["equipment-hire", farmId] });
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filtered.map((row) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t hover:bg-muted/30 transition-colors cursor-pointer", onClick: () => setSelectedId(b.id), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 text-right", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 justify-end", children: [
            ...
            !["cancelled", "invoiced"].includes(b.status) && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", title: "Cancel", onClick: () => {
              if (confirm("Cancel this booking?")) cancelMut.mutate(b.id);
            }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3.5 w-3.5 text-red-500" }) })
          ] }) })
        ] }, b.id);
      }) })
    ] }) }),
...
function FarmServicesPage() {
  ...
  const [tab, setTab] = reactExports.useState(() => {
    ...
    const t = p.get("tab");
    const valid = ["customers", "agreements", "grain", "invoices", "work-orders", "hire"];
