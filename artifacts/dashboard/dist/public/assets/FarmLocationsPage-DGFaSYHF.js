import { b as useAppStore, t as useQueryClient, a as useToast, r as reactExports, l as useQuery, O as useMutation, B as Building2, T as FlaskConical, M as MapPin, j as jsxRuntimeExports, o as Link, c as Button, K as Map, S as Plus, m as Card, I as Input, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription } from "./index-DVTlKOh9.js";
import { W as Warehouse, g as TreePine, U as Users, A as AppLayout } from "./AppLayout-BIJWl-oS.js";
...
import { L as LayoutGrid } from "./layout-grid-CegEsRlX.js";
...
function FarmLocationsPage() {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/farm-locations/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["farm-locations", farmId] });
      setDeleteId(null);
    },
