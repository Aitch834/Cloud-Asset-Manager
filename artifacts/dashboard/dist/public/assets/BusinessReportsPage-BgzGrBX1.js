import { b as useAppStore, r as reactExports, j as jsxRuntimeExports, d as Button, m as useQuery, c as useQueryClient, S as useMutation } from "./index-zOeBAfPt.js";
...
import { A as AppLayout, e as ChartColumn, T as TrendingUp } from "./AppLayout-BlR6vELz.js";
...
function SubsidiesTab({ farmId, year, onRegisterExport }) {
  ...
  const updateMilestoneStatus = useMutation({
    mutationFn: async ({ milestoneId, projectId, status }) => {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "0.8rem" }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: pMilestones.map((ms, mi) => {
                        ...
                        return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: mi < pMilestones.length - 1 ? "1px solid #f3f4f6" : "none" }, children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "0.45rem 0.875rem" }, onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "select",
                            {
                              disabled: isUpdating,
