import { b as useAppStore, l as useQuery, j as jsxRuntimeExports, t as useQueryClient, a as useToast, r as reactExports, O as useMutation, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, L as Label, I as Input, C as Checkbox, Q as React, d as LoaderCircle, m as Card, n as CardContent } from "./index-DKBMd7uR.js";
import { R as RecordAttachments } from "./RecordAttachments-CAwitW2c.js";
import { A as AppLayout, o as Bell, c as ClipboardList } from "./AppLayout-BPk5oW6I.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DVtxacMy.js";
import { B as Badge } from "./badge-Dh2rvif7.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-fKB2I0YD.js";
...
import { F as FileText } from "./shield-alert-DfBfD1or.js";
import { T as TriangleAlert } from "./triangle-alert-DQLNjx6y.js";
import { C as ChevronRight } from "./tractor-B2v-VfL4.js";
import { M as Mail } from "./mail-Cmm9KGzr.js";
import { A as ArrowUpFromLine, a as ArrowDownToLine } from "./arrow-up-from-line-ehW084RL.js";
...
import "./use-lookup-UXexC4gR.js";
import "./tab-button-B9ah5hIq.js";
import "./index-ByKGvoBl.js";
import "./print-report-B_FwCCVJ.js";
import "./LabSelector-DCrxkqJO.js";
import "./circle-x-BwCFHYRf.js";
import "./file-down-BgWgXOC6.js";
import "./generateCategoricalChart-CKDhA_HC.js";
import "./BarChart-CRBhuPku.js";
import "./CartesianGrid-_G_47VCI.js";
import "./PieChart-H-HWsbv4.js";
import "./syringe-DN5PdezA.js";
const CERTIFIERS = [
  "Soil Association",
...
function ConversionTab({ farmId, farmName }) {
  ...
  const remove = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-livestock/conversion/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-livestock-conversion", farmId] });
  ...
  const deleteNotif = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-livestock/parallel-notifications/${id}`, { method: "DELETE" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    notifConversion && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => setNotifConversion(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "58rem" }, className: "max-h-[90vh] overflow-y-auto", children: [
...
function FeedTab({ farmId, farmName }) {
  ...
  const remove = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-livestock/feed/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-livestock-feed", farmId] });
      toast({ title: "Record deleted" });
    },
...
function OutdoorAccessTab({ farmId, farmName }) {
  ...
  const remove = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-livestock/outdoor-access/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-livestock-outdoor-access", farmId] });
      toast({ title: "Record deleted" });
    },
...
function TreatmentsTab({ farmId, farmName }) {
  ...
  const remove = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-livestock/treatments/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-livestock-treatments", farmId] });
      toast({ title: "Record deleted" });
    },
...
function FeedDerogationTab({ farmId }) {
  ...
  const deleteCase = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-livestock/feed-derogations/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["feed-derogations", farmId] });
  ...
  const deleteCorr = useMutation({
    mutationFn: ({ derogationId, corrId }) => fetch(`/api/farms/${farmId}/organic-livestock/feed-derogations/${derogationId}/correspondence/${corrId}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["feed-derogation-corr", expandedId] }),
    onError: () => toast({ title: "Delete failed", variant: "destructive" })
  });
  const deleteDoc = useMutation({
    mutationFn: ({ derogationId, docId }) => fetch(`/api/farms/${farmId}/organic-livestock/feed-derogations/${derogationId}/documents/${docId}`, { method: "DELETE" }).then((r) => r.json()),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: corrDialogOpen, onOpenChange: setCorrDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", children: [
...
function KiddingSection({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-livestock/kidding-records/${id}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["ol-kidding-records", farmId] });
...
function OrgVetPrescriptionsSection({ farmId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    deletePending && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => setDeletePending(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
...
function OrgSheepDippingSection({ farmId }) {
  ...
  const createMut = useMutation({
    mutationFn: (b) => fetch(base, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateMut = useMutation({
    mutationFn: (b) => fetch(`${base}/${b.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["sheep-dipping", farmId] });
      setShowForm(false);
      setEditing(null);
...
function OrganicLivestockPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Organic Livestock", children: farmId && /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "conversion", children: [
