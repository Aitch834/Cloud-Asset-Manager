const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-BHFohDN2.js","assets/index-q2SF5na-.js","assets/index-DYHSEa_I.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b4 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-q2SF5na-.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-B8iJdQjz.js";
import { L as LabSelector } from "./LabSelector-BKQtAmeH.js";
import { a as useRawFarmName, b as useFarmName } from "./use-farm-name-BLp9B05c.js";
import { a as printElementReport } from "./print-report-ClU8-1P0.js";
import { P as Printer } from "./printer-10yXKt4Q.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-C8ELQpE2.js";
import { B as BarChart } from "./BarChart-pxjagNqw.js";
import { C as CartesianGrid } from "./CartesianGrid-D5VuQ-WS.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-B75lyEQ5.js";
import { C as ChevronUp } from "./chevron-up-BAjydpF5.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-C5yd-eIS.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-DLEWRumu.js";
...
import { S as ShieldAlert, D as Droplets } from "./shield-alert-Bi25-ayP.js";
import { L as LayoutGrid } from "./layout-grid-CC2GsAx8.js";
...
import { A as Archive } from "./archive-D0Uqw1yD.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-BHFohDN2.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
