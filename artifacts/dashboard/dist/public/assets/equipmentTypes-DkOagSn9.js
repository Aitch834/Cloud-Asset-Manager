...
const VEHICLE_TYPES = new Set(EQUIPMENT_TYPES.filter((t) => t.category === "vehicle").map((t) => t.value));
const IMPLEMENT_TYPES = new Set(EQUIPMENT_TYPES.filter((t) => t.category === "implement").map((t) => t.value));
export {
  EQUIPMENT_TYPES as E,
  IMPLEMENT_TYPES as I,
  VEHICLE_TYPES as V
};
