import { b as useAppStore, r as reactExports, l as useQuery, j as jsxRuntimeExports, K as Map, A as ArrowRight, T as FlaskConical, m as Card, t as useQueryClient, a as useToast, O as useMutation, c as Button, S as Plus, d as LoaderCircle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, J as DialogFooter, H as DialogDescription } from "./index-DZ3-mP8N.js";
import { A as AppLayout, _ as Grape, e as ChartColumn, c as ClipboardList, S as Sprout, X as Scissors, r as Bug, G as Gauge, d as Wrench, B as BookOpen, T as TrendingUp } from "./AppLayout-D1dNxWO5.js";
...
import { W as Wine, B as Beaker, D as Droplet, a as BatchTrailQuickSearch, b as WineProductionTab, c as WineryStockTab, H as HarvestReceptionTab, P as PressingRecordsTab, F as FermentationRecordsTab, V as VesselRegisterTab, C as CellarOpsTab, d as BottlingRecordsTab, S as So2TestingTab, E as EquipmentRegisterTab, O as OverviewTab, e as VineRegisterTab, f as BlocksTab, g as VineyardBlockMapTab, h as PhenologyTab, i as OperationsTab, j as HarvestTab, k as ScoutingTab, G as GiComplianceTab, L as LicensingTab, l as ExciseDutyTab, T as TastingsToursTab, A as AgeVerificationTab, m as SprayDiaryTab, n as SoilAnalysisTab, o as ViticulturalAnalyticsTab, p as VintageSeasonReportTab, q as ViticulturalEnterpriseReport } from "./ViticulturePage-BOJtdNca.js";
...
import { L as Leaf } from "./triangle-alert-5soG8eC6.js";
...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar } from "./generateCategoricalChart-24XzhbV8.js";
...
import "./Line-D2QMU-qR.js";
import "./LineChart-DsdbQf2W.js";
import "./printer-CT2VuHAd.js";
import "./badge-DzRqu2VD.js";
import "./search-be6P8BKW.js";
import "./git-branch-DQpegs1L.js";
import "./eye-CW3qQfnM.js";
import "./circle-check-Ba89GTDu.js";
import "./circle-x-dE8i-h2V.js";
import "./csv-Dr539t8b.js";
import "./globe-BTLGUEMl.js";
...
function BlockConversionTab({ farmId }) {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => fetch(`/api/farms/${farmId}/organic-viticulture/block-status/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["org-vit-block-status", farmId] });
      setDeleting(null);
      toast({ title: "Deleted" });
...
function InputLogTab({ farmId, blocks }) {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => fetch(`/api/farms/${farmId}/organic-viticulture/input-log/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["org-vit-input-log", farmId] });
      setDeleting(null);
      toast({ title: "Deleted" });
...
function CopperRegisterTab({ farmId, blocks }) {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => fetch(`/api/farms/${farmId}/organic-viticulture/copper-log/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["org-vit-copper-log", farmId] });
      setDeleting(null);
      toast({ title: "Deleted" });
...
function InputDerogationsTab({ farmId }) {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => fetch(`/api/farms/${farmId}/organic-viticulture/input-derogations/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["org-vit-derogations", farmId] });
      setDeleting(null);
  ...
  const deleteCorr = useMutation({
    mutationFn: async (id) => fetch(`/api/farms/${farmId}/organic-viticulture/input-derogation-correspondence/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["org-vit-derog-corr", farmId, expandedId] });
...
function CertificatesTab({ farmId }) {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => fetch(`/api/farms/${farmId}/organic-viticulture/certificates/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["org-vit-certs", farmId] });
      setDeleting(null);
      toast({ title: "Deleted" });
