const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-DPjKra4W.js","assets/index-CVAOLzqi.js","assets/index-CNUbH-zj.css","assets/typeof-WJl3ipnu.js"])))=>i.map(i=>d[i]);
import { r as reactExports, l as useQuery, j as jsxRuntimeExports, b as useAppStore, R as Redirect, c as Button, d as LoaderCircle, m as Card, n as CardContent, t as useQueryClient, a as useToast, O as useMutation, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, C as Checkbox, _ as __vitePreload, M as MapPin } from "./index-CVAOLzqi.js";
...
import { T as TrendingUp, A as AppLayout, Q as LayoutDashboard, V as PiggyBank, j as Truck, q as Stethoscope, f as Scale, c as ClipboardList } from "./AppLayout-DF-K4gcR.js";
...
import { F as FileText, C as ClipboardCheck } from "./shield-alert-CXhiHolV.js";
import { U as UtensilsCrossed } from "./utensils-crossed-CsgNJ2II.js";
...
async function generatePigAuditPDF(farmId) {
  const [jsPDFModule, autoTableModule] = await Promise.all([__vitePreload(() => import("./jspdf.es.min-DPjKra4W.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), __vitePreload(() => import("./jspdf.plugin.autotable-rNuKHwSj.js"), true ? [] : void 0)]);
