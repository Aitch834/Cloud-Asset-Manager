import { b as useAppStore, m as useQuery, j as jsxRuntimeExports, R as Redirect, b4 as formatAlertIssuedAt, u as useLocation, c as useQueryClient, a as useToast, r as reactExports, S as useMutation, d as Button, T as Plus, e as LoaderCircle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, N as DialogMutationError, J as DialogFooter, n as Card, o as CardContent, H as DialogDescription, C as Checkbox } from "./index-D-0vFWNm.js";
...
import { A as AppLayout } from "./AppLayout-C8XAlai2.js";
...
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-DvY5qrss.js";
import { R as RecordAttachments } from "./RecordAttachments-rvWZu7wf.js";
import { b as SccEquipmentSection, c as DairySuppliesTab } from "./SccEquipmentSection-CHSqOYoJ.js";
import { p as printBirthRecordReport } from "./birth-record-report-BlDgWc7B.js";
import { u as useFarmReportMeta } from "./use-farm-name-CmLyVbWn.js";
import { A as AbrKitStockSection } from "./AbrKitStockSection-63Te9czi.js";
import "./index-BRdXvFsw.js";
import { A as AbrProcurementSection, D as DairyEnterpriseReport } from "./DairyEnterpriseReport-nk5VNYEx.js";
import { S as ShieldAlert, D as Droplets } from "./shield-alert-BTlqutDK.js";
...
import "./use-safe-clerk-BqAMf2ql.js";
...
import "./shopping-cart-BDEQ7oDj.js";
import "./circle-x-Bl6kHPLN.js";
import "./print-report-ClU8-1P0.js";
import "./vmdMedicines-mq70NSvP.js";
import "./file-down-cXxHyPUX.js";
import "./chevron-left-aslVSCdE.js";
import "./sparkles-DVKeU6hV.js";
import "./chevrons-up-down-Du9AMMZY.js";
import "./confirm-dialog-CDZ8cs25.js";
import "./receipt-5byz6_8a.js";
import "./badge-check-BzFCRnRo.js";
import "./trending-down-DwZsEbju.js";
...
const SHEEP_DAIRY_TAB_IDS = ["milk", "tupping", "mastitis", "kidding", "treatments", "bcs", "tank", "mv", "assurance", "abr-kit", "scc-equipment", "enterprise", "supplies"];
function SheepDairyPage() {
  const { farmId } = useAppStore();
  const [tab, setTab] = usePersistedTab({ page: "sheep-dairy", farmId, validIds: SHEEP_DAIRY_TAB_IDS, defaultTab: "milk" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Sheep Dairy", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-7xl mx-auto", children: [
    ...
    sheepAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm mb-4 ${sheepAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : sheepAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
...
function MastitisTab({ farmId }) {
  ...
  const mastiYears = reactExports.useMemo(() => {
    const s = new Set(records.map((r) => Number(String(r.incidentDate || "").slice(0, 4))).filter((y) => y > 2e3));
  ...
  const [selectedYear, setSelectedYear] = usePersistedNumberFilter({
    ...
    isValid: (y) => y > 2e3 && y <= currentYear + 1
  });
  ...
  const filteredCompare = reactExports.useMemo(
  ...
  const analytics = reactExports.useMemo(() => {
    ...
    filtered.forEach((r) => {
      if (r.pathogenIdentified?.trim()) {
        ...
        pathPrimary[p] = (pathPrimary[p] || 0) + 1;
      }
    });
    const pathCompare = {};
    filteredCompare.forEach((r) => {
      if (r.pathogenIdentified?.trim()) {
        const p = r.pathogenIdentified.trim();
        pathCompare[p] = (pathCompare[p] || 0) + 1;
      }
    });
    const pathNames = /* @__PURE__ */ new Set([...Object.keys(pathPrimary), ...Object.keys(pathCompare)]);
    const pathData = Array.from(pathNames).map((name) => ({ name, value: pathPrimary[name] ?? 0, value_cmp: pathCompare[name] ?? 0 })).sort((a, b) => b.value - a.value).slice(0, 8);
    const animalMap = {};
    filtered.forEach((r) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    mastiYears.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      YearCompareSelector,
      {
    ...
    analytics.trend.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-b border-border bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-semibold", children: [
        "Monthly Case Trend",
        compareYear ? ` — ${selectedYear} vs ${compareYear}` : ` — ${selectedYear}`
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: analytics.trend, margin: { top: 4, right: 8, bottom: 4, left: 0 }, children: [
        ...
        compareYear && /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, { iconSize: 10, wrapperStyle: { fontSize: 11 } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "cases", name: compareYear ? String(selectedYear) : "Cases", fill: COMPARE_COLORS[0], radius: [3, 3, 0, 0], maxBarSize: 32 }),
        compareYear && /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "cases_cmp", name: String(compareYear), fill: COMPARE_COLORS[1], radius: [3, 3, 0, 0], maxBarSize: 32 })
      ] }) }) })
    ] }),
    (analytics.outcomeData.length > 0 || analytics.pathData.length > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      ...
      analytics.pathData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-b border-border bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-semibold", children: [
          "Pathogen Breakdown",
          compareYear ? ` — ${selectedYear} vs ${compareYear}` : ""
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: Math.max(160, analytics.pathData.length * 28), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: analytics.pathData, layout: "vertical", margin: { top: 0, right: 8, bottom: 0, left: 8 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#e5e7eb" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
          compareYear && /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, { iconSize: 10, wrapperStyle: { fontSize: 11 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "value", name: compareYear ? String(selectedYear) : "Cases", fill: COMPARE_COLORS[0], radius: [0, 3, 3, 0], maxBarSize: 18 }),
          compareYear && /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "value_cmp", name: String(compareYear), fill: COMPARE_COLORS[1], radius: [0, 3, 3, 0], maxBarSize: 18 })
        ] }) }) })
      ] })
    ] }),
...
function SheepLambingTab({ farmId }) {
  ...
  const [form, setForm] = reactExports.useState(blank);
  const set = (k, v) => setForm((p) => ({ ...p, [k]: v }));
  const printBirthRecord = (record) => printBirthRecordReport({
    species: "sheep",
    recordId: record.id,
    ...farmMeta,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    viewRec && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => setViewRec(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "36rem" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setViewRec(null), children: "Close" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: () => printBirthRecord(viewRec), children: [
...
function BulkTankTab({ farmId }) {
  ...
  const [monYear, setMonYear] = usePersistedFilter({ page: "sheep-dairy-bulk-tank", filter: "year", farmId, defaultValue: String((/* @__PURE__ */ new Date()).getFullYear()) });
