...
import { a as TabButton } from "./tab-button-hghQ5WfP.js";
import { R as RaiseTaskDialog } from "./RaiseTaskDialog-oGtoD0OO.js";
import { B as BuyerCombobox } from "./BuyerCombobox-CckZzHkY.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-UiobzvrN.js";
...
function NVZPage() {
  ...
  const raCreateMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/nvz-risk-assessments`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...body, fieldIds: JSON.stringify(raFieldIds) }) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const raUpdateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/nvz-risk-assessments/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...body, fieldIds: JSON.stringify(raFieldIds) }) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const raDeleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/nvz-risk-assessments/${id}`, { method: "DELETE" }),
    onSuccess: () => {
  ...
  const contactCreateMut = useMutation({
    mutationFn: (body) => fetch(`/api/farms/${farmId}/contacts`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const contactUpdateMut = useMutation({
    mutationFn: ({ id, body }) => fetch(`/api/farms/${farmId}/contacts/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const contactDeleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/contacts/${id}`, { method: "DELETE" }),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/nvz-applications/${id}`, { method: "DELETE" }),
    onSuccess: () => {
