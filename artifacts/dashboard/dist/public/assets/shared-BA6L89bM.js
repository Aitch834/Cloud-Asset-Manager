...
import { m as useQuery, r as reactExports, j as jsxRuntimeExports, d as Button, c as useQueryClient, a as useToast, S as useMutation, _ as __vitePreload } from "./index-Bt49Vuc8.js";
import { b as buildViticultureCsvContent } from "./csv-xyC-P3sa.js";
...
import { c as ClipboardList } from "./AppLayout-Ba5OirH6.js";
...
async function downloadVineRegisterPdf(records, farmName, fsaVineRef, farmMeta) {
  const [jsPDFModule, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-C9s166Vh.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0),
...
async function printHarvest(records, farmName, farmId, blocks, farmMeta, yearLabel, chemCols) {
...
export {
  today as A,
  BBCH_STAGES as B,
  buildVarietyColorMap as C,
  DataTable as D,
  Empty as E,
  FarmSettingsWarning as F,
  buildUniqueBlockColorMap as G,
  buildBlockColorMap$1 as H,
  ...
  downloadVineOperationsPdf as e,
  downloadVineRegisterPdf as f,
  downloadVineSprayDiaryPdf as g,
  emailHarvestReport as h,
  emailOrganicWineRecords as i,
  emailRpaReference as j,
  emailVineRegister as k,
  exportCSV as l,
  fmt as m,
  fmtDate as n,
  fmtNum as o,
  printDiseaseScouting as p,
  printExciseReturn as q,
  printHarvest as r,
  printOperations as s,
  printOrganicWineRecords as t,
  useFarmMeta as u,
  printPhenology as v,
  printRpaReference as w,
  printSprayRecords as x,
  printVineRegister as y,
  printVineSprayDiaryReport as z
};
