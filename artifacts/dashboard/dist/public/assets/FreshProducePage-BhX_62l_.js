const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-bYKR-iC3.js","assets/index-4wIcluQc.js","assets/index-Dg4iJCjm.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b4 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-4wIcluQc.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-ByjMpLcz.js";
import { L as LabSelector } from "./LabSelector-CbgC48ub.js";
import { a as useRawFarmName, b as useFarmName } from "./use-farm-name-C18kuk3-.js";
import { a as printElementReport } from "./print-report-ClU8-1P0.js";
import { P as Printer } from "./printer-DJ6mK7iu.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-pqsj6KEO.js";
import { B as BarChart } from "./BarChart-CShVTdBt.js";
import { C as CartesianGrid } from "./CartesianGrid-iwxY5Pq-.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-DEYK9HKP.js";
import { C as ChevronUp } from "./chevron-up-DXbgD6YR.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-C_y_XhGu.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-DD_uqc9q.js";
import { T as Textarea } from "./textarea-T7FfHphM.js";
import { C as ConfirmDialog } from "./confirm-dialog-BQT126Np.js";
...
import { u as useFarmMembers } from "./use-farm-members-CKloWi8R.js";
import { S as StaffSelect } from "./staff-select-CIEFAc8a.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { S as ShieldAlert, D as Droplets } from "./shield-alert-NerF-xDF.js";
import { L as LayoutGrid } from "./layout-grid-oUrlsjir.js";
import { P as Package } from "./use-safe-clerk-BvAJD8DS.js";
import { T as Thermometer } from "./thermometer-DSxaCxrD.js";
import { E as Eye } from "./eye-DJ2FSTV7.js";
import { P as Pencil } from "./pencil-rbaSqCvR.js";
import { A as Archive } from "./archive-41V04LCZ.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-bYKR-iC3.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
