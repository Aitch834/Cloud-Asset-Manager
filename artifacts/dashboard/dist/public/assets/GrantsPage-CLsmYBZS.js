import { a as useToast, c as useQueryClient, b as useAppStore, u as useLocation, r as reactExports, m as useQuery, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, e as LoaderCircle, X, A as ArrowRight, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, I as Input, N as DialogMutationError } from "./index-BciYlE5o.js";
import { A as AppLayout, I as Info, C as CalendarDays, c as ClipboardList, s as AlertDialog, t as AlertDialogContent, v as AlertDialogHeader, w as AlertDialogTitle, x as AlertDialogDescription, y as AlertDialogFooter, z as AlertDialogCancel, D as AlertDialogAction } from "./AppLayout-KZBMoq3D.js";
...
function AgriEnvTab({ farmId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: openAddProject, style: { display: "flex", alignItems: "center", gap: 6, flexShrink: 0, marginLeft: 16 }, children: [
        ...
        isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid #f3f4f6", background: "#fafafa", padding: "12px 16px" }, children: [
          ...
          milestones.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: "20px 12px", color: "#9ca3af", fontSize: "0.82rem" }, children: "No milestones recorded yet — add one to track claim dates and evidence." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: milestones.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "10px 14px", display: "flex", alignItems: "flex-start", gap: 10 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 12, flexWrap: "wrap", marginTop: 3 }, children: [
                m.dueDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: "0.78rem", color: "#6b7280" }, children: [
                  "Due: ",
...
function GrantsPage() {
  ...
  const [mainTab, setMainTab] = reactExports.useState("capital");
