...
import { s as createLucideIcon, b as useAppStore, r as reactExports, m as useQuery, j as jsxRuntimeExports, M as MapPin, _ as __vitePreload } from "./index-Bt49Vuc8.js";
import { A as AppLayout, N as Navigation, Z as Zap, j as Truck, O as Settings } from "./AppLayout-Ba5OirH6.js";
...
function useResourceMap(containerRef, pings, assets) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-BS669xOR.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
