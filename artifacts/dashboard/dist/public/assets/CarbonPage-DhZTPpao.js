import { q as createLucideIcon, t as useQueryClient, r as reactExports, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, J as DialogFooter, c as Button, d as LoaderCircle, b as useAppStore, R as Redirect, m as Card, n as CardContent, a as useToast, l as useQuery, O as useMutation, S as Plus, C as Checkbox } from "./index-CVAOLzqi.js";
import { p as printProReport } from "./print-report-B_FwCCVJ.js";
import { F as FileText } from "./shield-alert-CXhiHolV.js";
...
import { A as AppLayout, e as ChartColumn, E as Flame, Z as Zap, S as Sprout } from "./AppLayout-DF-K4gcR.js";
...
import { u as useLookupStrings } from "./use-lookup-Eaot5ClA.js";
import { B as BuyerCombobox } from "./BuyerCombobox-CkZI8cVW.js";
import { R as RecordAttachments } from "./RecordAttachments-Ct_F_7Vu.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-BfpWy8jt.js";
...
import { S as Sparkles } from "./sparkles-CK9gINfF.js";
...
function FctImportDialog({ open, farmId, onClose }) {
  ...
  const doImport = async () => {
    ...
    try {
      ...
      await fetch(api$1(`farms/${farmId}/carbon-audits`), {
        method: "POST",
      ...
      if (importEmissions) {
        for (const rec of plan.emissions) {
          await fetch(api$1(`farms/${farmId}/carbon-emissions`), {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
            body: JSON.stringify({
      ...
      if (importSeq) {
        for (const rec of plan.sequestration) {
          await fetch(api$1(`farms/${farmId}/carbon-sequestration`), {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
            body: JSON.stringify({
...
function AuditsTab({ farmId, prefillAudit, onPrefillUsed }) {
  ...
  const { data: auditorSuppliers = [] } = useQuery({
    ...
    queryFn: () => fetch(api(`farms/${farmId}/contractor-suppliers`), { credentials: "include" }).then((r) => r.ok ? r.json() : { records: [] }).then((d) => d.records ?? [])
  });
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/carbon-audits/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function GenerateDialog({ farmId, onDone }) {
  const { toast } = useToast();
  const [year, setYear] = reactExports.useState(String((/* @__PURE__ */ new Date()).getFullYear() - 1));
  ...
  const confirm = async () => {
    if (!preview) return;
    setSaving(true);
    const records = preview.map((s, i) => ({ s, i })).filter(({ i }) => selected.has(i)).map(({ s, i }) => ({
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      preview !== null && preview.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border overflow-auto max-h-80", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: preview.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `border-t transition-opacity ${selected.has(i) ? "" : "opacity-40"}`, children: [
...
function EmissionsTab({ farmId }) {
  ...
  const save = useMutation({
    mutationFn: (b) => fetch(api(`farms/${farmId}/carbon-emissions`), { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(b) }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/carbon-emissions/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      preview !== null && preview.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-lg border max-h-80 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: preview.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `border-t ${!selected.has(i) ? "opacity-40" : ""}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2 font-medium", children: s.featureType }),
...
function SequestrationTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/carbon-sequestration/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    ], rows: filteredSeqRows, onView: setViewRecord, onEdit: (r) => handleOpen(r), onDelete: (r) => del.mutate(r.id) }),
    viewRecord && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => setViewRecord(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "42rem" }, children: [
...
function ReductionActionsTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/carbon-reduction-actions/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function ReportsTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/sustainability-reports/${id}`), { method: "DELETE", credentials: "include" }),
  ...
  const { data: schemeRecords = [] } = useQuery({
    ...
    queryFn: () => fetch(api(`farms/${farmId}/scheme-records`), { credentials: "include" }).then((r) => r.ok ? r.json() : []).then((d) => Array.isArray(d) ? d : [])
  });
...
function RenewableEnergyTab({ farmId }) {
  ...
  const save = useMutation({
    mutationFn: (b) => fetch(editing ? api(`farms/${farmId}/renewable-energy-production/${editing.id}`) : api(`farms/${farmId}/renewable-energy-production`), { method: editing ? "PUT" : "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify(b) }),
    onSuccess: () => {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/renewable-energy-production/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function BngTab({ farmId }) {
  ...
  const del = useMutation({
    mutationFn: (id) => fetch(api(`farms/${farmId}/biodiversity-net-gain/${id}`), { method: "DELETE", credentials: "include" }).then(async (r) => {
      if (!r.ok) {
        const t = await r.text().catch(() => "");
        throw new Error(t || `Request failed (${r.status})`);
      }
...
function CarbonAutoCalcTab({ farmId, onUseForAudit }) {
  ...
  const [prefillYear, setPrefillYear] = reactExports.useState(String((/* @__PURE__ */ new Date()).getFullYear() - 1));
