import { c as useQueryClient, a as useToast, r as reactExports, S as useMutation, j as jsxRuntimeExports, e as LoaderCircle } from "./index-D6bw93Jo.js";
...
function PhotoPanel({ incidentId, farmId, photos, resource = "fly-tipping", queryKey }) {
  ...
  const deleteMut = useMutation({
    mutationFn: (photoId) => fetch(`/api/farms/${farmId}/${resource}/${incidentId}/photos/${photoId}`, { method: "DELETE" }).then(async (r) => {
      if (!r.ok) {
