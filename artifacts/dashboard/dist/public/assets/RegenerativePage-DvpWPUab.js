import { b as useAppStore, c as useQueryClient, m as useQuery, r as reactExports, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, L as Label, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, I as Input, N as DialogMutationError, J as DialogFooter } from "./index-CZ0mNknL.js";
import { u as usePersistedTab } from "./use-persisted-tab-By7QVuWI.js";
import { A as AppLayout, S as Sprout } from "./AppLayout-DxTSR_Kp.js";
...
function RegenerativePage() {
  ...
  const farmName = farmQ.data?.name ?? farmQ.data?.farmName ?? `Farm ${farmId}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-7xl mx-auto", children: [
    ...
    tab === "summary" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "ml-2", onClick: () => {
          ensurePrintStyle();
          window.print();
        }, children: [
