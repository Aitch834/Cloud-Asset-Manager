import { b as useAppStore, t as useQueryClient, a as useToast, j as jsxRuntimeExports, R as Redirect, l as useQuery, r as reactExports, O as useMutation, c as Button, S as Plus, I as Input, d as LoaderCircle, m as Card, n as CardContent, M as MapPin, k as cn, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, B as Building2, L as Label, J as DialogFooter } from "./index-fxZRGm6t.js";
import { A as AppLayout, U as Users, C as CalendarDays, c as ClipboardList, M as CheckCheck } from "./AppLayout-DGOTUjsH.js";
...
import { U as UserPlus } from "./user-plus-CcD0z91r.js";
import { a as Clock } from "./database-C5if5ZOW.js";
import { S as Send } from "./send-BZlkeHlp.js";
...
function ExpandedContractorSection({ contractor, farmId }) {
  ...
  const addContactMut = useMutation({
    mutationFn: (b) => fetch(`${base}/contacts`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const updateContactMut = useMutation({
    mutationFn: (b) => fetch(`${base}/contacts/${b.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["contractors-hs", farmId] });
  ...
  const deleteContactMut = useMutation({
    mutationFn: (id) => fetch(`${base}/contacts/${id}`, { method: "DELETE" }).then((r) => r.json()),
  ...
  const addRamsMut = useMutation({
    mutationFn: (b) => fetch(`${base}/rams`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["contractors-hs", farmId] });
  ...
  const updateRamsMut = useMutation({
    mutationFn: (b) => fetch(`${base}/rams/${b.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(b) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["contractors-hs", farmId] });
      setEditingRams(null);
      setShowRamsForm(false);
  ...
  const deleteRamsMut = useMutation({
    mutationFn: (id) => fetch(`${base}/rams/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["contractors-hs", farmId] }),
    onError: () => toast({ title: "Delete failed", variant: "destructive" })
  });
  const markReviewedMut = useMutation({
    mutationFn: (ramsId) => fetch(`${base}/rams/${ramsId}/review`, { method: "PATCH" }).then((r) => r.json()),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["contractors-hs", farmId] }),
    onError: () => toast({ title: "Update failed", variant: "destructive" })
  });
  const raiseTaskMut = useMutation({
    mutationFn: ({ ramsId, body }) => fetch(`${base}/rams/${ramsId}/review-task`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["contractors-hs", farmId] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border mt-0 px-5 pt-4 pb-5 bg-muted/20", children: [
    ...
    activeTab === "rams" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      ...
      rams.map((r) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("p-3 bg-white rounded-lg border space-y-2", isReviewed ? "border-green-200" : hasPendingTask ? "border-amber-200" : "border-border"), children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Contractors H&S File", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin h-6 w-6 text-muted-foreground" }) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-16 text-center", children: [
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("rounded-xl border bg-white overflow-hidden", !c.isActive && "opacity-60"), children: [
        ...
        expanded && /* @__PURE__ */ jsxRuntimeExports.jsx(ExpandedContractorSection, { contractor: c, farmId })
      ] }, c.id);
    }) }),
