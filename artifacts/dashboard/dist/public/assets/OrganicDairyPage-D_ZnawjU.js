import { t as useQueryClient, r as reactExports, l as useQuery, j as jsxRuntimeExports, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, L as Label, I as Input, J as DialogFooter, a as useToast, $ as X, d as LoaderCircle, k as cn, b as useAppStore, O as useMutation, H as DialogDescription, C as Checkbox, Q as React, m as Card, n as CardContent } from "./index-CH03FTk5.js";
import { D as DairyEnterpriseReport, A as AbrProcurementSection } from "./DairyEnterpriseReport-CzBYrXUD.js";
...
import { B as BcsTab, M as MobilityTab, a as BulkTankTab, R as RecordingVisitsTab, S as SccEquipmentSection, D as DairySuppliesTab } from "./DairyPage-Bb8a_gtY.js";
...
import { F as FileDown } from "./file-down-DiSmahKh.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, _ as ReferenceLine } from "./generateCategoricalChart-CCMAiNYM.js";
...
import "./shopping-cart-D2UB2txv.js";
import "./receipt-DwxJJsAm.js";
import "./badge-check-8sLrWCVm.js";
import "./database-DVamQyeK.js";
import "./circle-x-Bw65bDPY.js";
import "./trending-down-Bo6PaPsT.js";
...
import "./use-farm-members-CbovQ1m3.js";
import "./staff-select-DDZHdyqq.js";
import "./vmdMedicines-mq70NSvP.js";
import "./sparkles-BUTKTrvn.js";
import "./chart-no-axes-column-B0Tw6-kK.js";
import "./PieChart-CUEyl8mo.js";
import "./thermometer-C4nDmAFe.js";
...
function HerdConversionTab({ farmId, farmName }) {
  ...
  const remove = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-dairy/herd-conversion/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-dairy-herd-conversion", farmId] });
...
function MilkCollectionsTab({ farmId, farmName }) {
  ...
  const remove = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-dairy/collections/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-dairy-collections", farmId] });
      toast({ title: "Record deleted" });
    },
...
function FeedNutritionTab({ farmId, farmName }) {
  ...
  const remove = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-dairy/feed/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-dairy-feed", farmId] });
      toast({ title: "Record deleted" });
    },
...
function TreatmentsTab({ farmId, farmName }) {
  ...
  const remove = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/organic-dairy/treatments/${id}`, { method: "DELETE" }),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["organic-dairy-treatments", farmId] });
      toast({ title: "Record deleted" });
    },
...
function OrganicDairyPage() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("herd-conversion");
