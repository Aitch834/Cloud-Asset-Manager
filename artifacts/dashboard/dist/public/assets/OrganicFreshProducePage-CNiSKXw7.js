import { b as useAppStore, m as useQuery, j as jsxRuntimeExports, n as Card, U as FlaskConical, c as useQueryClient, a as useToast, r as reactExports, S as useMutation, d as Button, T as Plus, e as LoaderCircle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, L as Label, I as Input, N as DialogMutationError, O as React } from "./index-Bt49Vuc8.js";
...
import { A as AppLayout, W as Warehouse, I as Info, c as ClipboardList } from "./AppLayout-Ba5OirH6.js";
...
import { CropsTab, WaterTestsTab, HarvestTab, IntakeTab, PackhouseTab, AllergenTab } from "./FreshProducePage-DtTedQyv.js";
...
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-BcBj2QVV.js";
import { S as ShieldCheck } from "./shield-check-OBBp21kx.js";
import { F as FileText, D as Droplets } from "./shield-alert-BNeNt00B.js";
import { P as Package } from "./use-safe-clerk-BRXvgrOh.js";
import { T as Thermometer } from "./thermometer-D0CRH3OC.js";
...
import "./LabSelector-DIYnGstl.js";
...
import "./layout-grid-aKbWAH51.js";
import "./archive-rYFDXpCj.js";
import "./index-I99mqdaD.js";
import "./index-Ct0O508g.js";
const FP_INPUT_LOG_CSV_HEADERS = [
  "Date Applied",
  "Crop Year",
  "Input / Product",
  "Type",
...
function calendarDayNumber(date) {
  return Date.UTC(date.year, date.month - 1, date.day) / 864e5;
}
function getFpInputLogDaysRemaining(expiryDate, today = /* @__PURE__ */ new Date()) {
...
function needsDerogationColumn(row) {
  return row.approvalStatus === "restricted" || row.approvalStatus === "derogation";
}
function buildFpInputLogCsvRows(rows, today = /* @__PURE__ */ new Date()) {
  return rows.map((row) => {
    let expiryDate = "";
    let daysRemaining = "";
...
function buildFpInputLogPrintRows(rows, today = /* @__PURE__ */ new Date()) {
  return rows.map((row) => {
    let derogCell = "—";
    let daysCell = "—";
    if (needsDerogationColumn(row) && row.derogationExpiryDate) {
      const formatted = new Date(row.derogationExpiryDate).toLocaleDateString("en-GB");
      const daysLeft = getFpInputLogDaysRemaining(row.derogationExpiryDate, today);
      derogCell = daysLeft != null && daysLeft < 0 ? `<span class="expiry-expired">${formatted}</span>` : formatted;
      daysCell = daysLeft != null && daysLeft < 0 ? `<span class="expiry-expired">${daysLeft}</span>` : String(daysLeft ?? "—");
    }
    return `
    <tr>
      <td>${row.applicationDate ? new Date(row.applicationDate).toLocaleDateString("en-GB") : "—"}</td>
...
function exportFpInputLogCsv(rows, farmName, yearLabel) {
...
function InputLogTab({ farmId, farmName }) {
  ...
  const [yearFilter, setYearFilter] = usePersistedFilter({ page: "ofp-input-log", filter: "year", farmId, defaultValue: String((/* @__PURE__ */ new Date()).getFullYear()) });
  ...
  const save = useMutation({
    mutationFn: async (b) => {
      const payload = {
        ...b,
        derogationExpiryDate: b.derogationExpiryDate || null
      };
      const r = await fetch(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center flex-wrap gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => exportFpInputLogCsv(rows, farmName, yearFilter === "all" ? "All Years" : String(yearFilter)), disabled: rows.length === 0, className: "gap-1.5", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin w-5 h-5" }) : rows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-10 text-center space-y-2", children: [
      ...
      const expiryBadge = (() => {
        ...
        if (!row.derogationExpiryDate) return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium px-2 py-0.5 rounded-full border bg-gray-50 text-gray-500 border-gray-200", children: "Derogation expiry: not set" });
        const expiry = new Date(row.derogationExpiryDate);
        const today = /* @__PURE__ */ new Date();
        today.setHours(0, 0, 0, 0);
        const daysLeft = Math.floor((expiry.getTime() - today.getTime()) / 864e5);
        if (daysLeft < 0) return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium px-2 py-0.5 rounded-full border bg-red-50 text-red-700 border-red-300 inline-flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3 shrink-0" }),
          "Derogation expired ",
          fmt(row.derogationExpiryDate)
        ] });
        if (daysLeft <= 30) return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium px-2 py-0.5 rounded-full border bg-amber-50 text-amber-700 border-amber-300", children: [
          "Derogation expiry: ",
          fmt(row.derogationExpiryDate),
          " (",
          daysLeft,
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium px-2 py-0.5 rounded-full border bg-blue-50 text-blue-700 border-blue-200", children: [
          "Derogation expiry: ",
          fmt(row.derogationExpiryDate)
        ] });
      })();
    ...
    viewRecord && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => setViewRecord(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "42rem" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 text-sm", children: [
        ...
        (viewRecord.approvalStatus === "restricted" || viewRecord.approvalStatus === "derogation") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          viewRecord.derogationExpiryDate ? (() => {
            const daysLeft = daysUntil(viewRecord.derogationExpiryDate);
            if (daysLeft !== null && daysLeft < 0) {
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-medium px-2 py-0.5 rounded-full border bg-red-50 text-red-700 border-red-300 inline-flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3 shrink-0" }),
                "Derogation expired ",
                fmt(viewRecord.derogationExpiryDate)
              ] });
            }
            if (daysLeft !== null && daysLeft <= 30) {
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-medium px-2 py-0.5 rounded-full border bg-amber-50 text-amber-700 border-amber-300", children: [
                "Derogation expiry: ",
                fmt(viewRecord.derogationExpiryDate),
                " (",
                daysLeft,
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-medium px-2 py-0.5 rounded-full border bg-blue-50 text-blue-700 border-blue-200", children: [
              "Derogation expiry: ",
              fmt(viewRecord.derogationExpiryDate)
            ] });
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 max-h-[70vh] overflow-y-auto pr-1", children: [
        ...
        (form.approvalStatus === "restricted" || form.approvalStatus === "derogation") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-1", children: "Date the certifier's approval expires, if applicable." })
        ] }) }),
