import { q as createLucideIcon, b as useAppStore, r as reactExports, j as jsxRuntimeExports, a as useToast, t as useQueryClient, l as useQuery, O as useMutation, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, Q as React, d as LoaderCircle } from "./index-CG7Bde15.js";
import { A as AppLayout, a as Wheat, f as Scale, a0 as Milk, X as Bird, V as PiggyBank, e as ChartColumn } from "./AppLayout-DW85f8T1.js";
import { T as Textarea } from "./textarea-B_gJAVX3.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-WOrv5jfW.js";
import { B as Badge } from "./badge-CTGlS_m1.js";
import { T as TabBar, a as TabButton } from "./tab-button-BsDBmiTS.js";
import { B as BuyerCombobox } from "./BuyerCombobox-DKsaOk-I.js";
import { S as ShoppingCart } from "./shopping-cart-CITaSSbq.js";
import { F as FileText, D as Droplets } from "./shield-alert-1PMzBpNJ.js";
import { P as Printer } from "./printer-B7MrZxvv.js";
import { E as Eye } from "./eye-DjWmum6l.js";
import { P as Pencil } from "./pencil-BZ-m9pa0.js";
import { T as Trash2, C as ChevronDown } from "./trash-2-VByqLcbQ.js";
import { C as ChevronRight } from "./tractor-Orxob8jR.js";
import { C as CircleAlert } from "./database-B6Muj3P5.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, C as Cell, L as Legend } from "./generateCategoricalChart-DiHRC4dV.js";
import { B as BarChart } from "./BarChart-DcwOvEGZ.js";
import { C as CartesianGrid } from "./CartesianGrid-Cu9SXghJ.js";
import { P as PieChart, a as Pie } from "./PieChart-rehUOD1f.js";
import { F as File } from "./file-DgsT8aHG.js";
import { P as Paperclip } from "./paperclip-DsAXNbSc.js";
import "./use-safe-clerk-DE9vZTtv.js";
import "./triangle-alert-BnOSZuM5.js";
import "./shield-check-BdnLiSiq.js";
import "./index-bou60Qep.js";
import "./index-DvnT0yIX.js";
import "./chevron-up-s5j0KfO_.js";
import "./popover-DflgTU7a.js";
import "./command-Bufj6r67.js";
import "./search-DjOMUlYV.js";
import "./chevrons-up-down-DLSQYzzE.js";
import "./user-plus-BiKqxxeL.js";
const __iconNode = [
...
function GrainSalesTab({ farmId }) {
  ...
  const [cropYearFilter, setCropYearFilter] = reactExports.useState("__all__");
  ...
  const postMut = useMutation({
    mutationFn: (body) => editing ? fetch(`/api/farms/${farmId}/grain-sales/${editing.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/grain-sales`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const delMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/grain-sales/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["grain-sales", farmId] });
      setDeleteId(null);
      toast({ title: "Deleted" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteId !== null, onOpenChange: (v) => !v && setDeleteId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 400 }, children: [
...
function LivestockTradingTab({ farmId }) {
  ...
  const [lsYearFilter, setLsYearFilter] = reactExports.useState("__all__");
  ...
  const dwMut = useMutation({
    mutationFn: (body) => editingDW ? fetch(`/api/farms/${farmId}/livestock-deadweight-sales/${editingDW.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/livestock-deadweight-sales`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const dwDelMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/livestock-deadweight-sales/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["dw-sales", farmId] });
      setDeleteDWId(null);
    },
  ...
  const martMut = useMutation({
    mutationFn: (body) => editingMart ? fetch(`/api/farms/${farmId}/livestock-mart-sales/${editingMart.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/livestock-mart-sales`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const martDelMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/livestock-mart-sales/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["mart-sales", farmId] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteDWId !== null, onOpenChange: (v) => !v && setDeleteDWId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 400 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteMartId !== null, onOpenChange: (v) => !v && setDeleteMartId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 400 }, children: [
...
function MilkSalesTab({ farmId }) {
  ...
  const [deleteId, setDeleteId] = reactExports.useState(null);
  const [milkYearFilter, setMilkYearFilter] = reactExports.useState("__all__");
  const empty = {
    statementMonth: "",
    buyerId: null,
    buyer: "",
  ...
  const mut = useMutation({
    mutationFn: (body) => editing ? fetch(`/api/farms/${farmId}/milk-statements/${editing.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/milk-statements`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const delMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/milk-statements/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["milk-statements", farmId] });
      setDeleteId(null);
    },
...
function PoultrySettlementTab({ farmId }) {
  ...
  const [poultryYearFilter, setPoultryYearFilter] = reactExports.useState("__all__");
  const emptyBatch = {
    flockRef: "",
    integratorId: null,
    integratorName: "",
  ...
  const batchMut = useMutation({
    mutationFn: (body) => editingBatch ? fetch(`/api/farms/${farmId}/poultry-batch-settlements/${editingBatch.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/poultry-batch-settlements`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const batchDelMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/poultry-batch-settlements/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["poultry-batch-settlements", farmId] });
  ...
  const eggMut = useMutation({
    mutationFn: (body) => editingEgg ? fetch(`/api/farms/${farmId}/egg-sales/${editingEgg.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/egg-sales`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const eggDelMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/egg-sales/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["egg-sales", farmId] });
      setDeleteEggId(null);
    },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteBatchId !== null, onOpenChange: (v) => !v && setDeleteBatchId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 400 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteEggId !== null, onOpenChange: (v) => !v && setDeleteEggId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 400 }, children: [
...
function PigSalesTab({ farmId }) {
  ...
  const [viewRecord, setViewRecord] = reactExports.useState(null);
  const [deleteId, setDeleteId] = reactExports.useState(null);
  const [pigYearFilter, setPigYearFilter] = reactExports.useState("__all__");
  const empty = {
    killDate: "",
    processorId: null,
    processor: "",
  ...
  const records = q.data?.records ?? [];
  const mut = useMutation({
    mutationFn: (body) => editing ? fetch(`/api/farms/${farmId}/pig-kill-records/${editing.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/pig-kill-records`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const delMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/pig-kill-records/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["pig-kill-records", farmId] });
      setDeleteId(null);
    },
...
function DirectSalesTab({ farmId }) {
  ...
  const [directYearFilter, setDirectYearFilter] = reactExports.useState("__all__");
  const empty = {
    saleDate: "",
    customerId: null,
    channel: "farm_shop",
  ...
  const mut = useMutation({
    mutationFn: (body) => editing ? fetch(`/api/farms/${farmId}/direct-sales/${editing.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/direct-sales`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const delMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/direct-sales/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["direct-sales", farmId] });
      setDeleteId(null);
    },
...
function ReportsTab({ farmId }) {
  const [reportYearFilter, setReportYearFilter] = reactExports.useState("__all__");
  const farmQ = useQuery({ queryKey: ["farm-detail", farmId], queryFn: () => fetch(`/api/farms/${farmId}`).then((r) => r.json()), enabled: !!farmId, select: (d) => d.record });
  const farm = farmQ.data;
...
function GrainContractsTab({ farmId }) {
  ...
  const saveMut = useMutation({
    mutationFn: (body) => editing ? fetch(`/api/farms/${farmId}/crop-contracts/${editing.id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()) : fetch(`/api/farms/${farmId}/crop-contracts`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }).then((r) => r.json()),
    onSuccess: () => {
  ...
  const delMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/crop-contracts/${id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["crop-contracts", farmId] });
      setDeleteId(null);
...
function SettlementNotesTab({ farmId }) {
  ...
  const lsDelMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/livestock-settlement-notes/${id}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["livestock-settlement-notes", farmId] });
      setDeleteId(null);
  ...
  const grDelMut = useMutation({
    mutationFn: (id) => fetch(`/api/farms/${farmId}/grain-settlement-notes/${id}`, { method: "DELETE", credentials: "include" }).then((r) => r.json()),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["grain-settlement-notes", farmId] });
      setDeleteId(null);
      toast({ title: "Record deleted" });
...
function SalesTradingPage() {
  ...
  const [tab, setTab] = reactExports.useState("grain");
  if (!farmId) {
