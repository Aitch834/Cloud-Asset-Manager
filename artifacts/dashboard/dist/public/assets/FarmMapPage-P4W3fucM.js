const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-ghadND61.js","assets/index-Cyec2zqN.js","assets/index-DYHSEa_I.css"])))=>i.map(i=>d[i]);
import { b as useAppStore, r as reactExports, m as useQuery, j as jsxRuntimeExports, K as Map, p as Link, n as Card, I as Input, B as Building2, U as FlaskConical, M as MapPin, _ as __vitePreload } from "./index-Cyec2zqN.js";
import { a as usePersistedFilter } from "./use-persisted-filter-DJPXe-Sp.js";
import { A as AppLayout, O as Settings, W as Warehouse, g as TreePine, U as Users } from "./AppLayout-BrjK6Ogn.js";
...
import { L as LayoutGrid } from "./layout-grid-C4R4wRwS.js";
...
function useFarmMap(containerRef, locations, onSelect) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-ghadND61.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
