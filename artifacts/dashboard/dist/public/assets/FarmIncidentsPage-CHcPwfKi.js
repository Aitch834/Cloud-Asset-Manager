import { b as useAppStore, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, O as React, S as useMutation, j as jsxRuntimeExports, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, N as DialogMutationError, J as DialogFooter, L as Label, I as Input, p as Link } from "./index-Bt49Vuc8.js";
import { a as usePersistedFilter } from "./use-persisted-filter-BkmEG9-P.js";
import { A as AppLayout, E as Flame, c as ClipboardList } from "./AppLayout-Ba5OirH6.js";
...
function FarmIncidentsPage() {
  ...
  const handlePrintIncident = (inc) => {
    ...
    printProReport({
      ...
      authority: inc.policeAttended ? "Police" : inc.fireAttended ? "Fire & Rescue Service" : inc.eaAttended ? "Environment Agency" : void 0,
      authorityReferenceLabel: inc.policeAttended ? "Police reference" : inc.fireAttended ? "Fire reference" : inc.eaAttended ? "Environment Agency reference" : void 0,
