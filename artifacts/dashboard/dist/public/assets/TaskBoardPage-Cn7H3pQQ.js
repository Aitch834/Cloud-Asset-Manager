import { b as useAppStore, j as jsxRuntimeExports, R as Redirect, b0 as useSearch, r as reactExports, l as useQuery, k as cn, S as Plus, d as LoaderCircle, m as Card, t as useQueryClient, O as useMutation, aY as toast, o as Link, A as ArrowRight, B as Building2 } from "./index-D3ay9Ao3.js";
import { A as AppLayout, c as ClipboardList, e as ChartColumn, U as Users } from "./AppLayout-DRFFu3V0.js";
...
import { M as MessageSquare } from "./message-square-JSOQryhJ.js";
...
function AssignmentCard({ a, farmId, autoExpand, forceOpen }) {
  ...
  const deleteMut = useMutation({
    mutationFn: () => fetch(`/api/farms/${farmId}/task-assignments/${a.id}`, { method: "DELETE" }).then((r) => r.json()),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["task-assignments", farmId] });
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1 flex-wrap", children: [
                  ...
                  a.taskType === "field-inspection" && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "/field-inspections", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-semibold px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 border border-amber-200 cursor-pointer hover:bg-amber-100 flex items-center gap-1 w-fit", children: [
