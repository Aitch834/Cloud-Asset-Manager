import { b as useAppStore, m as useQuery, j as jsxRuntimeExports, R as Redirect, b5 as formatAlertIssuedAt, u as useLocation, c as useQueryClient, a as useToast, r as reactExports, S as useMutation, d as Button, T as Plus, e as LoaderCircle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, N as DialogMutationError, n as Card, o as CardContent } from "./index-Bt49Vuc8.js";
...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, B as Bar, C as Cell, L as Legend } from "./generateCategoricalChart-BdsI_vMv.js";
...
function GoatDairyPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Goat Dairy", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-7xl mx-auto", children: [
    ...
    goatAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm mb-4 ${goatAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : goatAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "w-4 h-4 mt-0.5 shrink-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: goatAlert.level === "national" ? "National Goat Disease Alert" : goatAlert.level === "regional" ? "Regional Goat Disease Alert" : "Goat Disease Notice" }),
        goatAlert.message && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2", children: goatAlert.message }),
        (goatAlert.issuedAt || goatAlert.date) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 opacity-70 text-xs", children: formatAlertIssuedAt(goatAlert.issuedAt, goatAlert.date) })
      ] })
    ] }),
...
function BulkTankTab({ farmId }) {
  ...
  const [monYear, setMonYear] = usePersistedFilter({ page: "goat-dairy-bulk-tank", filter: "year", farmId, defaultValue: String((/* @__PURE__ */ new Date()).getFullYear()) });
