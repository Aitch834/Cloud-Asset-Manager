import { s as createLucideIcon, b as useAppStore, a as useToast, c as useQueryClient, m as useQuery, S as useMutation, r as reactExports, j as jsxRuntimeExports, R as Redirect, n as Card, o as CardContent, L as Label, I as Input, M as MapPin, d as Button, e as LoaderCircle, C as Checkbox, X, a5 as ToastAction, B as Building2, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, N as DialogMutationError, J as DialogFooter } from "./index-Bt49Vuc8.js";
import { u as useUpload } from "./use-upload-DzEm77V2.js";
import { A as AppLayout, o as LogOut, j as Truck } from "./AppLayout-Ba5OirH6.js";
...
import { C as Copy } from "./copy-D9JYgvS1.js";
...
import { U as UserRound } from "./user-round-X2X8fK6Y.js";
import { P as Phone } from "./phone-WtCXQJg_.js";
import { S as Save } from "./save-UH7bQRiz.js";
import { C as CircleCheck } from "./circle-check-Cue8w0uP.js";
import { S as ShieldCheck } from "./shield-check-OBBp21kx.js";
import { S as Shield } from "./shield-WYCNNpeY.js";
import { E as EyeOff } from "./eye-off-C-uOh6R1.js";
import { E as Eye } from "./eye-DqxeDLT_.js";
import { T as Trash2 } from "./trash-2-jIx2__Xo.js";
import { W as WifiOff } from "./wifi-off-smSgUWSL.js";
import { C as Cpu } from "./cpu-DRJHThqX.js";
...
import { C as CreditCard } from "./credit-card-Doe3NK0a.js";
...
function getSmsPhoneSyncCandidate({
  savedContactPhone,
...
function buildSmsPhoneUpdatePayload(phoneNumber) {
  return { phoneNumber };
}
const SECTORS = [
...
function farmToFormData(farm) {
  return {
    ...
    irrigationCropPricePerTonne: farm.irrigationCropPricePerTonne?.toString() || "",
    irrigationApplicationRateMm: farm.irrigationApplicationRateMm?.toString() || "",
    ...
    barrelRetirementThresholdGbp: farm.barrelRetirementThresholdGbp?.toString() || ""
  };
}
...
function FarmSettings() {
  ...
  const { data: smsProfile, isSuccess: smsProfileLoaded } = useQuery({
  ...
  const platformIdleBarrelDaysHint = platformConfig?.["winery.barrelIdleThresholdDays"] ?? platformConfig?.barrel_idle_days_default;
  const platformNeutralFillsHint = platformConfig?.["winery.barrelNeutralOakFills"] ?? platformConfig?.barrel_neutral_fills_default;
  const defaultIdleBarrelDays = Number.isInteger(platformIdleBarrelDays) && platformIdleBarrelDays > 0 ? platformIdleBarrelDays : 90;
  const defaultNeutralFills = Number.isInteger(platformNeutralFills) && platformNeutralFills > 0 ? platformNeutralFills : 4;
  const defaultRetirementThresholdGbp = Number.isInteger(platformRetirementThresholdPence) && platformRetirementThresholdPence > 0 ? platformRetirementThresholdPence / 100 : 600;
  const updateSmsPhone = useMutation({
    ...
    onSuccess: (_data, phoneNumber) => {
      queryClient.setQueryData(
        ["account-profile"],
        (profile) => profile ? { ...profile, phoneNumber } : profile
      );
  ...
  const contactPhoneBeforeSaveRef = reactExports.useRef(null);
  ...
  const clearIrrigationDefault = useMutation({
    mutationFn: async (field) => {
      const res = await fetch(apiUrl(`farms/${farmId}`), {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
  ...
  const handleSave = () => {
    ...
    contactPhoneBeforeSaveRef.current = typeof currentFarm?.contactPhone === "string" ? currentFarm.contactPhone : null;
    updateFarm({
    ...
    formData.sectors.sectorViticulture && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          !formData.idleBarrelDays && platformIdleBarrelDaysHint ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded px-2 py-1 mt-1", children: [
            "Using platform default: ",
            platformIdleBarrelDaysHint,
            " days"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
            "A barrel empty for longer than this many days is flagged as idle in the vessel register. Leave blank to use the platform default of ",
            defaultIdleBarrelDays,
            " days."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          !formData.approachingNeutralFills && platformNeutralFillsHint ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded px-2 py-1 mt-1", children: [
            "Using platform default: ",
            platformNeutralFillsHint,
            " fills"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
            "Barrels at or beyond this fill number are flagged as approaching neutral oak influence. Leave blank to use the platform default of ",
            defaultNeutralFills,
            " fills."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "settings-barrel-retirement-threshold", children: "Barrel Retirement Cost Threshold (£)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
            "When total maintenance spend on a barrel exceeds this amount, a retirement warning is shown. Leave blank to use the platform default of £",
            defaultRetirementThresholdGbp,
            "."
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  clearIrrigationDefault.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-3.5 h-3.5 mr-1" }),
                  "Clear"
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "settings-irrig-crop-price", children: "Saved Crop Price (£ per tonne)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: formData.irrigationCropPricePerTonne ? `£${Number(formData.irrigationCropPricePerTonne).toFixed(2)} / tonne` : "Not set"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Saved from the Irrigation Advisor and used as the farm default across devices." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "settings-irrig-app-rate", children: "Saved Application Rate (mm)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                "aria-live": "polite",
                className: "flex-1 min-h-10 rounded-md border border-input bg-muted/30 px-3 py-2 text-sm",
                children: formData.irrigationApplicationRateMm ? `${Number(formData.irrigationApplicationRateMm).toFixed(2)} mm` : "Not set"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
