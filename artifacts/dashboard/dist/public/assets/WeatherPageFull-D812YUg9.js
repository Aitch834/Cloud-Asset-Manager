import { s as createLucideIcon, b as useAppStore, j as jsxRuntimeExports, a as useToast, c as useQueryClient, r as reactExports, m as useQuery, S as useMutation, d as Button, T as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, e as LoaderCircle, M as MapPin, L as Label, I as Input, N as DialogMutationError, J as DialogFooter } from "./index-Bt49Vuc8.js";
...
import { A as AppLayout, T as TrendingUp, j as Truck } from "./AppLayout-Ba5OirH6.js";
...
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip } from "./generateCategoricalChart-BdsI_vMv.js";
...
function DevicesTab({ farmId, farmName }) {
  const { toast } = useToast();
  const qc = useQueryClient();
  const [addOpen, setAddOpen] = reactExports.useState(false);
  ...
  const printRegister = () => printRecordsReport({
    ...
    columns: [
      ...
      { label: "Last calibrated", value: (r) => fmt(r.calibrationDate) },
      { label: "Calibration due", value: (r) => fmt(r.calibrationDueDate) }
    ],
    records
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, gap: 12 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, flexShrink: 0 }, children: [
        records.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: printRegister, children: [
...
function WeatherPageFull() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Weather Records", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1100, margin: "0 auto" }, children: [
    ...
    farmId && tab === "devices" && /* @__PURE__ */ jsxRuntimeExports.jsx(DevicesTab, { farmId, farmName }),
