import { b as useAppStore, a as useToast, t as useQueryClient, r as reactExports, l as useQuery, Q as React, O as useMutation, j as jsxRuntimeExports, c as Button, S as Plus, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, L as Label, I as Input, o as Link } from "./index-CG7Bde15.js";
import { A as AppLayout, E as Flame, c as ClipboardList } from "./AppLayout-DW85f8T1.js";
...
import { P as PhotoPanel } from "./PhotoPanel-B9NL6lX_.js";
...
function FarmIncidentsPage() {
  ...
  const handleCsvExport = () => {
    ...
    a.href = url;
    a.download = `farm-incidents-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.csv`;
    a.click();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Farm Incidents", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18, flexWrap: "wrap", gap: 10 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: [{ value: "all", label: "All" }, ...STATUSES].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
                  ...
                  (inc.photos ?? []).length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { title: `${inc.photos.length} evidence photo${inc.photos.length === 1 ? "" : "s"} attached`, style: {
                    ...
                    inc.photos.length
                  ] }) : ["Fire", "Theft", "Criminal Damage"].includes(inc.incidentType) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { title: "No photo evidence attached — insurers usually require photos for this incident type", style: {
                    display: "inline-flex",
                    alignItems: "center",
                    gap: 4,
                    padding: "2px 8px",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addOpen, onOpenChange: setAddOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 680, maxHeight: "90vh", overflowY: "auto" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: editId !== null, onOpenChange: () => setEditId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 680, maxHeight: "90vh", overflowY: "auto" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteId !== null, onOpenChange: () => setDeleteId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: 420 }, children: [
