import { b as useAppStore, r as reactExports, c as useQueryClient, a as useToast, m as useQuery, j as jsxRuntimeExports, R as Redirect, d as Button, e as LoaderCircle, U as FlaskConical, S as useMutation, T as Plus, n as Card, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, H as DialogDescription, L as Label, I as Input, N as DialogMutationError, aC as Check } from "./index-DaWtA8cs.js";
...
import { A as AppLayout, c as ClipboardList, B as BookOpen, I as Info } from "./AppLayout-Dl_MNypY.js";
import { T as TabBar, a as TabButton } from "./tab-button-B5o9jk_4.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-bjn-tEep.js";
import { C as Command, a as CommandInput, b as CommandList, c as CommandEmpty, d as CommandGroup, e as CommandItem } from "./command-BMslbKC9.js";
...
import { b as buildCsv, d as downloadCsvFile } from "./csv-Bp-zopWX.js";
import { z as zipSync } from "./browser-BlOK38Vy.js";
...
import { C as Calendar } from "./calendar-CGuXgkGs.js";
import { a as Clock } from "./database-8QliO_KP.js";
import { P as Package } from "./use-safe-clerk-BZ3dURNB.js";
import { C as ChevronsUpDown } from "./chevrons-up-down-BLOPHS3S.js";
import "./shield-alert-CETkZOyO.js";
...
const RESTRICTED_INPUT_APPROVAL_STATUS_LABELS = {
  permitted: "Permitted",
  restricted: "Restricted (notify certifier)",
  derogation: "Derogation Required"
};
const RESTRICTED_INPUT_COLUMNS = [
...
function getRestrictedInputCsvHeaders() {
  return RESTRICTED_INPUT_COLUMNS.map((column) => column.label);
}
function getRestrictedInputPrintHeaders() {
  return RESTRICTED_INPUT_COLUMNS.map((column) => column.label);
}
function getRestrictedInputPrintHeaderHtml() {
  return getRestrictedInputPrintHeaders().map((label) => `<th>${label}</th>`).join("");
}
function getRestrictedInputValues(record) {
  return RESTRICTED_INPUT_COLUMNS.map((column) => column.getValue(record));
}
function getRestrictedInputPrintCellStyle(index) {
  return RESTRICTED_INPUT_COLUMNS[index]?.printStyle;
}
const ORGANIC_INSPECTION_CSV_HEADERS = [
  "Date",
  "Certifier",
  "Inspector",
  "Outcome",
...
function buildOrganicInspectionCsvRows(records) {
  return [
...
function buildFieldStatusCsvExport(records, farmName) {
  const fmtDate = (v) => {
    if (!v) return "";
    try {
...
function buildRestrictedInputsCsvExport(records, farmName, filter) {
...
function buildCertificationSummaryCsvExport(records, farmName) {
  const dateStr = (/* @__PURE__ */ new Date()).toISOString().slice(0, 10);
  const fmtDate = (val) => {
    if (!val) return "";
    try {
...
function downloadInputRegisterCsv(records, farmName, cropYear, approvalStatusFilter) {
  ...
  downloadCsvFile(`input-register${yearPart}${statusPart}-${safeName}.csv`, [
    ...
    ...records.map((r) => [
      ...
      r.poReference ?? "",
      r.grnReference ?? "",
      RESTRICTED_INPUT_APPROVAL_STATUS_LABELS[r.approvalStatus] ?? r.approvalStatus,
...
function printInputRegister(records, farmName, cropYear, approvalStatusFilter = "all") {
  const today = (/* @__PURE__ */ new Date()).toLocaleDateString("en-GB", { day: "numeric", month: "long", year: "numeric" });
  const yearLabel = cropYear ? `Crop Year ${cropYear}` : "All Years";
  const approvalStatusLabel = approvalStatusFilter !== "all" ? `${RESTRICTED_INPUT_APPROVAL_STATUS_LABELS[approvalStatusFilter] ?? approvalStatusFilter} only` : "";
  const rows = records.map((r) => `<tr>
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    records.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-medium px-2 py-0.5 rounded-full border ${APPROVAL_STATUS_COLORS[r.approvalStatus] ?? APPROVAL_STATUS_COLORS.permitted}`, children: RESTRICTED_INPUT_APPROVAL_STATUS_LABELS[r.approvalStatus] ?? r.approvalStatus }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
        ...
        records.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => printInputRegister(filteredRecords, farmName, yearFilter === "all" ? null : Number(yearFilter), approvalStatusFilter), className: "gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "w-4 h-4" }),
            "Print Register"
          ] })
        ] })
    ...
    filteredRecords.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold mb-1", children: [
        ...
        approvalStatusFilter !== "all" ? ` with status "${RESTRICTED_INPUT_APPROVAL_STATUS_LABELS[approvalStatusFilter] ?? approvalStatusFilter}"` : ""
      ] }),
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: r.productName }),
            r.inputType && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-foreground/60 bg-secondary px-2 py-0.5 rounded-full", children: r.inputType }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-medium px-2 py-0.5 rounded-full border ${statusColor}`, children: RESTRICTED_INPUT_APPROVAL_STATUS_LABELS[r.approvalStatus] ?? r.approvalStatus })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-foreground/60 space-y-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-3 flex-wrap", children: [
    ...
    viewRecord && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => setViewRecord(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { style: { maxWidth: "42rem" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: RESTRICTED_INPUT_APPROVAL_STATUS_LABELS[viewRecord.approvalStatus] ?? viewRecord.approvalStatus })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function OrganicPage() {
  ...
  const { data: auditCertData, isLoading: auditCertLoading, isError: auditCertError } = useQuery({
    queryKey: ["organic-cert", farmId],
  ...
  const { data: auditFieldsData, isLoading: auditFieldsLoading, isError: auditFieldsError } = useQuery({
    queryKey: ["organic-fields", farmId],
  ...
  const { data: auditInspectionsData, isLoading: auditInspectionsLoading, isError: auditInspectionsError } = useQuery({
    queryKey: ["organic-inspections", farmId],
  ...
  const { data: auditInputsData, isLoading: auditInputsLoading, isError: auditInputsError } = useQuery({
    queryKey: ["organic-inputs", farmId, "all"],
  ...
  const auditPackCounts = {
    ...
    restrictedInputs: auditInputsData?.records?.filter((r) => r.approvalStatus === "restricted" || r.approvalStatus === "derogation").length ?? null
  };
  ...
  ].join(" · ") : auditPackCountsError ? "Register counts unavailable — try again before downloading" : auditPackCountsLoading ? "Checking register counts…" : "Register counts unavailable";
  const auditPackTitle = auditPackHasCounts ? emptyAuditRegisters.length > 0 ? `Download all four compliance registers in one ZIP file. ${emptyAuditRegisters.join("; ")}.` : "Download all four compliance registers in one ZIP file." : "Download all four compliance registers in one ZIP file";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "p",
        {
          ...
          "aria-live": "polite",
          children: [
            emptyAuditRegisters.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3.5 h-3.5 inline-block mr-1 align-[-2px]" }),
...
function buildInspectionsCsvExport(records, farmName, year) {
  const safeName = farmName.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "");
  const yearPart = "";
  const dateStr = (/* @__PURE__ */ new Date()).toISOString().slice(0, 10);
  return {
