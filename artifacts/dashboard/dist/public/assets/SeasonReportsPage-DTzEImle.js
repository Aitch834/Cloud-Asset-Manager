import { s as createLucideIcon, b as useAppStore, u as useLocation, m as useQuery, r as reactExports, j as jsxRuntimeExports, d as Button, e as LoaderCircle, U as FlaskConical } from "./index-DgyPGl3H.js";
...
import { A as AppLayout, a1 as FileChartColumn, a as Wheat, r as Bug, S as Sprout, a0 as Milk } from "./AppLayout-PhK-zROm.js";
...
import { c as buildProReport } from "./print-report-ClU8-1P0.js";
import { A as ArableFarmSettingsChecklist } from "./ArableFarmSettingsChecklist-CJ_baKRl.js";
import { u as useFarmMeta, b as FarmSettingsWarning } from "./shared-D_EY8C0z.js";
...
import { C as ChevronDown } from "./trash-2-Bzcw0FjU.js";
...
import "./eye-NZ5NC3iz.js";
import "./pencil-NfcQLil2.js";
const __iconNode = [
  [
    "path",
    {
...
const SEASON_REPORTS_TAB_IDS = ["arable", "livestock", "ipm", "organic", "forage"];
const fmt2 = (n, dp = 2) => {
...
function SeasonReportsPage() {
  ...
  const [tab, setTab] = usePersistedTab({ page: "season-reports", farmId, validIds: SEASON_REPORTS_TAB_IDS, defaultTab: "arable" });
  const [year, setYear] = usePersistedNumberFilter({ page: "season-reports", filter: "year", farmId, defaultValue: (/* @__PURE__ */ new Date()).getFullYear(), isValid: (n) => n >= 2e3 && n <= 2100 });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { title: "Season Reports", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1200, margin: "0 auto", padding: "0 0 2rem" }, children: [
    ...
    !isLoading && !isError && (data || tab === "ipm" || tab === "organic" || tab === "forage") && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      tab === "livestock" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "1rem" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          FarmSettingsWarning,
          {
            missingFields: [
              ...
              ...(!srFarmRecord?.herdMark || String(srFarmRecord.herdMark).trim() === "") && (!srFarmRecord?.flockMark || String(srFarmRecord.flockMark).trim() === "") && (!srFarmRecord?.pigHerdMark || String(srFarmRecord.pigHerdMark).trim() === "") ? ["Herd / Flock Mark"] : []
            ],
        ...
        livestockHerds.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "3rem 1rem", color: "#9ca3af" }, children: [
