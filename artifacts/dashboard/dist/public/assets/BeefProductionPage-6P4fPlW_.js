import { r as reactExports, m as useQuery, j as jsxRuntimeExports, b as useAppStore, c as useQueryClient, a as useToast, S as useMutation, d as Button, T as Plus, e as LoaderCircle, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, J as DialogFooter, I as Input, N as DialogMutationError, C as Checkbox, L as Label } from "./index-DK42mN77.js";
...
import { f as Scale, T as TrendingUp, A as AppLayout, e as ChartColumn, c as ClipboardList } from "./AppLayout-UUn9I45b.js";
...
import { C as ComposedChart } from "./ComposedChart-DXFBQIhc.js";
...
import { S as ShieldAlert } from "./shield-alert-BiqHAIFC.js";
...
import "./triangle-alert-D3IuJ6Si.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-6xl mx-auto space-y-6", children: [
      ...
      beefAlert?.active && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-start gap-3 rounded-lg border px-4 py-3 text-sm ${beefAlert.level === "national" ? "bg-red-50 border-red-200 text-red-800" : beefAlert.level === "regional" ? "bg-orange-50 border-orange-200 text-orange-800" : "bg-amber-50 border-amber-200 text-amber-800"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          beefAlert.date && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 opacity-70 text-xs", children: [
            "Issued ",
            beefAlert.date
          ] })
        ] })
