const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-B4guDhlU.js","assets/index-DDOJnc-Q.js","assets/index-Dl9Ia5aD.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, d as Button, m as useQuery, R as Redirect, b5 as formatAlertIssuedAt, n as Card, o as CardContent, c as useQueryClient, a as useToast, S as useMutation, T as Plus, e as LoaderCircle, L as Label, I as Input, C as Checkbox, N as DialogMutationError, K as Map } from "./index-DDOJnc-Q.js";
import { u as usePersistedNumberFilter, a as usePersistedFilter } from "./use-persisted-filter-ThwGKYzu.js";
import { L as LabSelector } from "./LabSelector-D2VypyFR.js";
import { a as useRawFarmName, b as useFarmName } from "./use-farm-name-BYGkCvxi.js";
import { a as printElementReport } from "./print-report-ClU8-1P0.js";
import { P as Printer } from "./printer-DcL9iz19.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-Cl533gwh.js";
import { B as BarChart } from "./BarChart-wt182EZV.js";
import { C as CartesianGrid } from "./CartesianGrid-DlTrs_Dm.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-DQfIUd3n.js";
import { C as ChevronUp } from "./chevron-up-CQ_z4M-d.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-NOl2VtfS.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-Bsbkv4x9.js";
...
import { u as useFarmMembers } from "./use-farm-members-zSa3aBFI.js";
import { S as StaffSelect } from "./staff-select-Be1EMB8P.js";
import { a as apiUrl } from "./api-Dhdsf4oM.js";
import { S as ShieldAlert, D as Droplets } from "./shield-alert-C1gd25lh.js";
import { L as LayoutGrid } from "./layout-grid-D5nsRUtI.js";
import { P as Package } from "./use-safe-clerk-BpvxzUHZ.js";
import { T as Thermometer } from "./thermometer-Bp6D9K4V.js";
import { E as Eye } from "./eye-_NDzLwQ8.js";
import { P as Pencil } from "./pencil-ByxCKD-T.js";
import { A as Archive } from "./archive-CcLNm4PG.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-B4guDhlU.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
