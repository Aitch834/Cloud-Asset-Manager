const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-ESKIZrlB.js","assets/index-D332vjCk.js","assets/index-CNUbH-zj.css"])))=>i.map(i=>d[i]);
import { r as reactExports, b as useAppStore, _ as __vitePreload, j as jsxRuntimeExports, z as Dialog, E as DialogContent, F as DialogHeader, G as DialogTitle, H as DialogDescription, J as DialogFooter, c as Button, l as useQuery, R as Redirect, m as Card, n as CardContent, t as useQueryClient, a as useToast, O as useMutation, S as Plus, d as LoaderCircle, L as Label, I as Input, C as Checkbox, K as Map } from "./index-D332vjCk.js";
import { L as LabSelector } from "./LabSelector-BKSNiijX.js";
import { P as Printer } from "./printer-BraL-eZ_.js";
import { R as ResponsiveContainer, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar } from "./generateCategoricalChart-B9d4UPAz.js";
import { B as BarChart } from "./BarChart-B5zZ_IQm.js";
import { C as CartesianGrid } from "./CartesianGrid-B3wumf8m.js";
import { L as Leaf, T as TriangleAlert } from "./triangle-alert-C6Yl8AhV.js";
import { C as ChevronUp } from "./chevron-up-B-ZRQwgm.js";
import { C as ChevronDown, T as Trash2 } from "./trash-2-CXs84Xk5.js";
import { A as AppLayout, W as Warehouse, T as TrendingUp, R as RotateCcw } from "./AppLayout-Crfy39KU.js";
...
function BlockBoundaryMapDialog({ blockId, blockName, open, onClose, onSaved }) {
  ...
  reactExports.useEffect(() => {
    if (open) {
      __vitePreload(() => import("./leaflet-src-ESKIZrlB.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
