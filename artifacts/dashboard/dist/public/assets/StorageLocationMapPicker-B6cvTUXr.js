const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-9YgNsb2Z.js","assets/index-DBhADYfj.js","assets/index-CNUbH-zj.css"])))=>i.map(i=>d[i]);
import { q as createLucideIcon, r as reactExports, _ as __vitePreload, j as jsxRuntimeExports, M as MapPin, c as Button } from "./index-DBhADYfj.js";
...
function StorageLocationMapPicker({ value, onChange, mapHeight = 280 }) {
  ...
  reactExports.useEffect(() => {
    __vitePreload(() => import("./leaflet-src-9YgNsb2Z.js").then((n) => n.l), true ? __vite__mapDeps([0,1,2]) : void 0).then((L) => {
