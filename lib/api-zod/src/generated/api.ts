...
export const ListFarmsResponse = zod.object({
  farms: zod.array(
    zod.object({
      ...
      sectorSheep: zod.boolean().optional(),
      sectorEggs: zod.boolean().optional(),
      sectorGoats: zod.boolean().optional(),
      sectorEquine: zod.boolean().optional(),
      sectorViticulture: zod.boolean().optional(),
      sectorFreshProduce: zod.boolean().optional(),
      sectorDeer: zod.boolean().optional(),
      isActive: zod.boolean(),
