...
export const horticultureCropsTable = pgTable("horticulture_crops", {
  ...
  quantityPlanted: numeric("quantity_planted", { precision: 10, scale: 0 }),
  plantSupplier: text("plant_supplier"),
  nurseryBatchRef: text("nursery_batch_ref"),
  ...
  targetYieldKgHa: numeric("target_yield_kg_ha", { precision: 10, scale: 2 }),
...
export const organicFreshProduceInputLogTable = pgTable("organic_fresh_produce_input_log", {
  ...
  approvalStatus: text("approval_status").default("permitted"),
