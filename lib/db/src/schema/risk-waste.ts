...
export const accidentBookTable = pgTable("accident_book", {
  ...
  correctiveActionDate: text("corrective_action_date"),
  correctiveActionBy: text("corrective_action_by"),
...
// ─── Farm Incidents ───────────────────────────────────────────────────────────
export const farmIncidentsTable = pgTable("farm_incidents", {
  id: serial("id").primaryKey(),
  farmId: integer("farm_id").notNull().references(() => farmsTable.id),
  ...
  estimatedLossValue: text("estimated_loss_value"),
  areaQuantityAffected: text("area_quantity_affected"),
  policeAttended: boolean("police_attended").notNull().default(false),
  policeRefNumber: text("police_ref_number"),
  fireAttended: boolean("fire_attended").notNull().default(false),
  fireRefNumber: text("fire_ref_number"),
  eaAttended: boolean("ea_attended").notNull().default(false),
  eaRefNumber: text("ea_ref_number"),
  crimeReference: text("crime_reference"),
  status: text("status").notNull().default("reported"),
  insurancePolicyId: integer("insurance_policy_id").references(() => farmInsuranceTable.id),
  insuranceClaimRef: text("insurance_claim_ref"),
  insuranceClaimDate: text("insurance_claim_date"),
