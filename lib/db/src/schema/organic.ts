...
export const organicDairyCollectionTable = pgTable("organic_dairy_collection", {
  ...
  lactosePercentage: numeric("lactose_percentage", { precision: 5, scale: 2 }),
  ...
  buyerSccCount: integer("buyer_scc_count"),
  buyerTbcCount: integer("buyer_tbc_count"),
  buyerFatPercentage: numeric("buyer_fat_percentage", { precision: 5, scale: 2 }),
  buyerProteinPercentage: numeric("buyer_protein_percentage", { precision: 5, scale: 2 }),
  buyerLactosePercentage: numeric("buyer_lactose_percentage", { precision: 5, scale: 2 }),
  buyerBactoscanThousands: integer("buyer_bactoscan_thousands"),
  buyerTvcCfuMl: integer("buyer_tvc_cfu_ml"),
  buyerThermsCfuMl: integer("buyer_therms_cfu_ml"),
  buyerColiformsCfuMl: integer("buyer_coliforms_cfu_ml"),
  buyerCaseinPercent: numeric("buyer_casein_percent", { precision: 5, scale: 2 }),
  buyerUreaMillimolesPerLitre: numeric("buyer_urea_millimoles_per_litre", { precision: 6, scale: 2 }),
...
export const organicArableCertificationTable = pgTable("organic_arable_certification", {
  id: serial("id").primaryKey(),
  farmId: integer("farm_id").notNull().references(() => farmsTable.id),
  certifier: text("certifier").notNull(),
  certificateNumber: text("certificate_number"),
  ...
  certificationDate: date("certification_date"),
  renewalDate: date("renewal_date"),
  annualInspectionDate: date("annual_inspection_date"),
...
export const organicArableFieldConversionTable = pgTable("organic_arable_field_conversion", {
  id: serial("id").primaryKey(),
  farmId: integer("farm_id").notNull().references(() => farmsTable.id),
  fieldId: integer("field_id").references(() => fieldsTable.id),
  fieldName: text("field_name").notNull(),
  ...
  conversionStartDate: date("conversion_start_date").notNull(),
  expectedCertificationDate: date("expected_certification_date"),
  actualCertificationDate: date("actual_certification_date"),
  status: text("status").notNull().default("in-conversion"),
  certifierRef: text("certifier_ref"),
  parallelProduction: boolean("parallel_production").notNull().default(false),
  parallelProductionJustification: text("parallel_production_justification"),
...
export const organicArableSeedRecordsTable = pgTable("organic_arable_seed_records", {
  id: serial("id").primaryKey(),
  farmId: integer("farm_id").notNull().references(() => farmsTable.id),
  ...
  seedType: text("seed_type").notNull().default("organic"),
  derogationGranted: boolean("derogation_granted").notNull().default(false),
  derogationReference: text("derogation_reference"),
...
export const organicArableInputRecordsTable = pgTable("organic_arable_input_records", {
  ...
  activeIngredient: text("active_ingredient"),
  inputType: text("input_type").notNull(),
  permittedStatus: text("permitted_status").notNull().default("permitted"),
  regulatoryBasis: text("regulatory_basis"),
  supplierName: text("supplier_name"),
...
export const organicArableHarvestDeclarationsTable = pgTable("organic_arable_harvest_declarations", {
  id: serial("id").primaryKey(),
  farmId: integer("farm_id").notNull().references(() => farmsTable.id),
  fieldId: integer("field_id").references(() => fieldsTable.id),
  fieldName: text("field_name"),
  ...
  cropName: text("crop_name").notNull(),
  variety: text("variety"),
  yieldTonnes: numeric("yield_tonnes", { precision: 10, scale: 3 }),
  moisturePercent: numeric("moisture_percent", { precision: 5, scale: 2 }),
  storageLocation: text("storage_location"),
  organicStatus: text("organic_status").notNull().default("certified"),
  certifierRef: text("certifier_ref"),
  buyerName: text("buyer_name"),
  buyerOrganisation: text("buyer_organisation"),
  buyerAddress: text("buyer_address"),
  saleDate: date("sale_date"),
  quantitySoldTonnes: numeric("quantity_sold_tonnes", { precision: 10, scale: 3 }),
  pricePoundPerTonne: numeric("price_pound_per_tonne", { precision: 10, scale: 2 }),
  organicPremiumPercent: numeric("organic_premium_percent", { precision: 5, scale: 2 }),
